...
class Settings
{
     ...
     */
    public function publicApiV1VerifactuSettingsUpdate(?Components\UpdateVeriFactuSettingsV1Request $body = null, ?string $idempotencyKey = null, ?Options $options = null): Operations\PublicApiV1VerifactuSettingsUpdateResponse
    {
        $retryConfig = null;
        if ($options) {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Factuarea\Sdk\Models\Operations\PublicApiV1VerifactuSettingsUpdateResponseBody', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\PublicApiV1VerifactuSettingsUpdateResponse(
