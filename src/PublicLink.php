...
class PublicLink
{
    ...
    public function publicApiV1DeliveryNotesPublicLinkGet(string $deliveryNote, ?Options $options = null): Operations\PublicApiV1DeliveryNotesPublicLinkGetResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'public-api.v1.delivery_notes.public_link.get', null, $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Factuarea\Sdk\Models\Operations\PublicApiV1DeliveryNotesPublicLinkGetResponseBody', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\PublicApiV1DeliveryNotesPublicLinkGetResponse(
    ...
    public function publicApiV1DeliveryNotesPublicLinkUpdate(Components\UpdateDeliveryNotePublicLinkRequest $body, string $deliveryNote, ?string $idempotencyKey = null, ?Options $options = null): Operations\PublicApiV1DeliveryNotesPublicLinkUpdateResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Factuarea\Sdk\Models\Operations\PublicApiV1DeliveryNotesPublicLinkUpdateResponseBody', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\PublicApiV1DeliveryNotesPublicLinkUpdateResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
                    headers: $httpResponse->getHeaders(),
