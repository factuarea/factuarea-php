...
class PublicApiV1ProductsPresentationsCreateRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $product, Components\CreateProductPresentationRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null)
    {
