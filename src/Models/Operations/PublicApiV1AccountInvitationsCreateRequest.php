...
class PublicApiV1AccountInvitationsCreateRequest
{
    /**
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\InviteAccountMemberV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\InviteAccountMemberV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $account, string $idempotencyKey, Components\InviteAccountMemberV1Request $body, ?LocalDate $factuareaVersion = null)
    {
