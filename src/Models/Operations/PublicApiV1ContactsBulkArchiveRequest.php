...
class PublicApiV1ContactsBulkArchiveRequest
{
    /**
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\BulkArchiveBusinessContactsV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\BulkArchiveBusinessContactsV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\BulkArchiveBusinessContactsV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
