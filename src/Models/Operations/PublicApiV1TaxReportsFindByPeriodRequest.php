...
class PublicApiV1TaxReportsFindByPeriodRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\FindTaxReportByPeriodV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\FindTaxReportByPeriodV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\FindTaxReportByPeriodV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
