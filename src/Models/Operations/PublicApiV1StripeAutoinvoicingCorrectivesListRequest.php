...
class PublicApiV1StripeAutoinvoicingCorrectivesListRequest
{
    /**
     ...
     * @phpstan-pure
     */
    public function __construct(?string $startingAfter = null, ?string $endingBefore = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?int $limit = 25)
    {
