...
class PublicApiV1QuotesDeleteRequest
{
    /**
     *
     * @var string $quote
     ...
     * @phpstan-pure
     */
    public function __construct(string $quote, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->quote = $quote;
