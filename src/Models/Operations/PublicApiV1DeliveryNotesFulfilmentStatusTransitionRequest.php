...
class PublicApiV1DeliveryNotesFulfilmentStatusTransitionRequest
{
    /**
     *
     * @var string $company
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\TransitionFulfilmentStatusRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\TransitionFulfilmentStatusRequest $body;
     ...
     * @param  \Factuarea\Sdk\Models\Components\TransitionFulfilmentStatusRequest  $body
     * @param  ?LocalDate  $factuareaVersion
     * @param  ?string  $xActiveProfile
     * @phpstan-pure
     */
    public function __construct(string $company, string $deliveryNote, string $idempotencyKey, Components\TransitionFulfilmentStatusRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
