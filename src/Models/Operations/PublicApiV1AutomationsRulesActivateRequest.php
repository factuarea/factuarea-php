...
class PublicApiV1AutomationsRulesActivateRequest
{
    /**
     *
     * @var string $rule
     ...
     * @phpstan-pure
     */
    public function __construct(string $rule, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->rule = $rule;
