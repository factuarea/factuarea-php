...
class PublicApiV1VerifactuCertificatesRevokeRequest
{
    /**
     *
     * @var string $certificate
     */
    #[SpeakeasyMetadata('pathParam:style=simple,explode=false,name=certificate')]
     ...
     * @phpstan-pure
     */
    public function __construct(string $certificate, ?string $reason = null, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
