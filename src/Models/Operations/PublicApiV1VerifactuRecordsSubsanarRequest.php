...
class PublicApiV1VerifactuRecordsSubsanarRequest
{
    /**
     *
     * @var string $record
     ...
     * @phpstan-pure
     */
    public function __construct(string $record, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->record = $record;
