...
class PublicApiV1AutomationsRunsStepsListRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $run, ?string $startingAfter = null, ?string $endingBefore = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?int $limit = 25)
    {
        $this->run = $run;
