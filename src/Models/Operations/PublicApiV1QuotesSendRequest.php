...
class PublicApiV1QuotesSendRequest
{
    /**
     *
     * @var string $quote
    ...
    /**
     *
     * @var ?\Factuarea\Sdk\Models\Components\SendQuoteRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public ?Components\SendQuoteRequest $body = null;
     ...
     * @phpstan-pure
     */
    public function __construct(string $quote, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?Components\SendQuoteRequest $body = null)
    {
        $this->quote = $quote;
