...
class PublicApiV1QuotesSendRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $quote, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?Components\SendQuoteRequest $body = null)
    {
        $this->quote = $quote;
