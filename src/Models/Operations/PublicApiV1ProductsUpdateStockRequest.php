...
class PublicApiV1ProductsUpdateStockRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $product, Components\UpdateProductStockRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null)
    {
