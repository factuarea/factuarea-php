...
class PublicApiV1VerifactuEventsRetryRequest
{
    /**
     *
     * @var string $event
     ...
     * @phpstan-pure
     */
    public function __construct(string $event, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->event = $event;
