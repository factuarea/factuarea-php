...
class PublicApiV1CompaniesApiKeysShowRequest
{
    /**
     *
     * @var string $company
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $apiKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
