...
class PublicApiV1ContactsRemoveContactRoleRequest
{
    ...
    public Role $roleQueryParameter;
     ...
     * @param  string  $rolePathParameter
     * @param  \Factuarea\Sdk\Models\Operations\Role  $roleQueryParameter
     * @param  string  $idempotencyKey
     * @param  ?LocalDate  $factuareaVersion
     * @param  ?string  $xActiveProfile
     * @phpstan-pure
     */
    public function __construct(string $contact, string $rolePathParameter, Role $roleQueryParameter, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->contact = $contact;
        $this->rolePathParameter = $rolePathParameter;
