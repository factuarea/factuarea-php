...
class PublicApiV1QuotesDuplicateRequest
{
    /**
     *
     * @var string $quote
     ...
     * @phpstan-pure
     */
    public function __construct(string $quote, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->quote = $quote;
