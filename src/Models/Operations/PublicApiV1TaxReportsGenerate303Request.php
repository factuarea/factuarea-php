...
class PublicApiV1TaxReportsGenerate303Request
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\GenerateModelo303V1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\GenerateModelo303V1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\GenerateModelo303V1Request $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
