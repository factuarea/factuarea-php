...
class PublicApiV1TaxReportsGenerate303Request
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\GenerateModelo303V1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
