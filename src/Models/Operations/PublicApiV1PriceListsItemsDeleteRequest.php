...
class PublicApiV1PriceListsItemsDeleteRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(string $priceList, string $item, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
