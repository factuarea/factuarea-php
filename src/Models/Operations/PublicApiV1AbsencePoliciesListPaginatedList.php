...
class PublicApiV1AbsencePoliciesListPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\AbsencePolicy>  $data
     * @param  bool  $hasMore
