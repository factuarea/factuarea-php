...
class PublicApiV1AccountApiKeysRevokeRequest
{
    /**
     *
     * @var string $apiKey
    ...
    /**
     *
     * @var ?\Factuarea\Sdk\Models\Components\RevokeApiKeyV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public ?Components\RevokeApiKeyV1Request $body = null;
     ...
     * @param  ?\Factuarea\Sdk\Models\Components\RevokeApiKeyV1Request  $body
     * @phpstan-pure
     */
    public function __construct(string $apiKey, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?Components\RevokeApiKeyV1Request $body = null)
    {
        $this->apiKey = $apiKey;
