...
class PublicApiV1AccountApiKeysRevokeRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $account, string $apiKey, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?Components\RevokeApiKeyV1Request $body = null)
    {
