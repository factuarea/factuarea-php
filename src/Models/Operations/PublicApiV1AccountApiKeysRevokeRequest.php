...
class PublicApiV1AccountApiKeysRevokeRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $apiKey, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?Components\RevokeApiKeyV1Request $body = null)
    {
        $this->apiKey = $apiKey;
