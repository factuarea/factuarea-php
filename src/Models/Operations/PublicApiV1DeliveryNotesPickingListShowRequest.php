...
class PublicApiV1DeliveryNotesPickingListShowRequest
{
    /**
     *
     * @var string $company
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $deliveryNote, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
