...
class PublicApiV1VerifactuRecordsActivitiesPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\VeriFactuActivity>  $data
     * @param  bool  $hasMore
