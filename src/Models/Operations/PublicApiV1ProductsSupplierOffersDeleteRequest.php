...
class PublicApiV1ProductsSupplierOffersDeleteRequest
{
    /**
     *
     * @var string $product
     ...
     * @phpstan-pure
     */
    public function __construct(string $product, string $offer, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
