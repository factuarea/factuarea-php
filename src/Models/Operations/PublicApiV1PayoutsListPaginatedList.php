...
class PublicApiV1PayoutsListPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\StripePayout>  $data
     * @param  bool  $hasMore
