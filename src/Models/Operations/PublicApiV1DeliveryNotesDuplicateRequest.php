...
class PublicApiV1DeliveryNotesDuplicateRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(string $deliveryNote, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
