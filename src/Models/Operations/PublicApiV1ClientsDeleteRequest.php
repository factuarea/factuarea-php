...
class PublicApiV1ClientsDeleteRequest
{
    /**
     *
     * @var string $client
     ...
     * @phpstan-pure
     */
    public function __construct(string $client, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->client = $client;
