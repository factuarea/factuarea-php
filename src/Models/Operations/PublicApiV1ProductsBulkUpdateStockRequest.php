...
class PublicApiV1ProductsBulkUpdateStockRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\BulkUpdateProductStockRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\BulkUpdateProductStockRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\BulkUpdateProductStockRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
