...
class PublicApiV1ProductsBulkUpdateStockRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\BulkUpdateProductStockRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
