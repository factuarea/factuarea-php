...
/** PublicApiV1ContactsBulkChangeContactRoleStatusResponseBody - `BulkPartialSuccessV1Resource` */
class PublicApiV1ContactsBulkChangeContactRoleStatusResponseBody
{
    /**
