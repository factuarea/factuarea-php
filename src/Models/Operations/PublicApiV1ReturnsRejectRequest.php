...
class PublicApiV1ReturnsRejectRequest
{
    /**
     *
     * @var string $company
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\RejectReturnRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\RejectReturnRequest $body;
     ...
     * @param  \Factuarea\Sdk\Models\Components\RejectReturnRequest  $body
     * @param  ?LocalDate  $factuareaVersion
     * @param  ?string  $xActiveProfile
     * @phpstan-pure
     */
    public function __construct(string $company, string $return, string $idempotencyKey, Components\RejectReturnRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
