...
class PublicApiV1AbsenceRequestsListPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\AbsenceRequest>  $data
     * @param  bool  $hasMore
