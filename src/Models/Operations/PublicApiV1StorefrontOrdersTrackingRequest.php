...
class PublicApiV1StorefrontOrdersTrackingRequest
{
    /**
     *
     * @var string $company
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $order, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
