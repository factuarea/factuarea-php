...
class PublicApiV1EmployeesCreateRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\CreateEmployeeRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\CreateEmployeeRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\CreateEmployeeRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
