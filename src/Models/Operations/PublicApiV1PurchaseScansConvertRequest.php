...
class PublicApiV1PurchaseScansConvertRequest
{
    /**
     *
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\ConvertPurchaseScanRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\ConvertPurchaseScanRequest $body;
     ...
     * @param  \Factuarea\Sdk\Models\Components\ConvertPurchaseScanRequest  $body
     * @param  ?LocalDate  $factuareaVersion
     * @param  ?string  $xActiveProfile
     * @phpstan-pure
     */
    public function __construct(string $purchaseScan, string $idempotencyKey, Components\ConvertPurchaseScanRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
