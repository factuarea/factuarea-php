...
class PublicApiV1ContactsPreviewImportRequest
{
    /**
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\PreviewBusinessContactImportV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=multipart/form-data')]
    public Components\PreviewBusinessContactImportV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\PreviewBusinessContactImportV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
