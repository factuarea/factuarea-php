...
class PublicApiV1ContactsPreviewImportRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $idempotencyKey, Components\PreviewBusinessContactImportV1Request $body, ?LocalDate $factuareaVersion = null)
    {
