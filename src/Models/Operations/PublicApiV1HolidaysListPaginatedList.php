...
class PublicApiV1HolidaysListPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\Holiday>  $data
     * @param  bool  $hasMore
