...
class PublicApiV1ProformasCreateRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\CreateProformaRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\CreateProformaRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\CreateProformaRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
