...
class PublicApiV1PriceListsItemsPurgeRetiredRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $priceList, string $item, string $idempotencyKey, Components\PurgeRetiredPriceListItemRequest $body, ?LocalDate $factuareaVersion = null)
    {
