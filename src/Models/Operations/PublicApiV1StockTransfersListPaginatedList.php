...
class PublicApiV1StockTransfersListPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\StockTransfer>  $data
     * @param  bool  $hasMore
