...
class PublicApiV1AutomationsRunsListPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\AutomationRun>  $data
     * @param  bool  $hasMore
