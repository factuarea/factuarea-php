...
class PublicApiV1InvoicesSubstituteSimplifiedRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\SubstituteSimplifiedV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
