...
class PublicApiV1InvoicesSubstituteSimplifiedRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\SubstituteSimplifiedV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\SubstituteSimplifiedV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\SubstituteSimplifiedV1Request $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
