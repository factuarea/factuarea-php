...
class PublicApiV1StockTransfersLinesListRequest
{
    /**
     *
     * @var string $company
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $stockTransfer, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
