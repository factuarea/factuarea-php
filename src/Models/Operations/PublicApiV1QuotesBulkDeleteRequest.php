...
class PublicApiV1QuotesBulkDeleteRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\BulkDeleteQuotesV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
