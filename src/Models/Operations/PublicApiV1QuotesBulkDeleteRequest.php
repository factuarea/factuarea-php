...
class PublicApiV1QuotesBulkDeleteRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\BulkDeleteQuotesV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\BulkDeleteQuotesV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\BulkDeleteQuotesV1Request $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
