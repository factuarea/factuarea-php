...
class PublicApiV1GoodsReceiptsBulkStatusRequest
{
    /**
     *
     * @var string $company
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\BulkStatusGoodsReceiptsRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\BulkStatusGoodsReceiptsRequest $body;
     ...
     * @param  \Factuarea\Sdk\Models\Components\BulkStatusGoodsReceiptsRequest  $body
     * @param  ?LocalDate  $factuareaVersion
     * @param  ?string  $xActiveProfile
     * @phpstan-pure
     */
    public function __construct(string $company, string $idempotencyKey, Components\BulkStatusGoodsReceiptsRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
