...
class PublicApiV1ProformasFindByExternalIdRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\FindProformaByExternalIdRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\FindProformaByExternalIdRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\FindProformaByExternalIdRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
