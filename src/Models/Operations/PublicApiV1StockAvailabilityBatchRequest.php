...
class PublicApiV1StockAvailabilityBatchRequest
{
    /**
     *
     * @var string $company
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\BatchStockAvailabilityRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\BatchStockAvailabilityRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, Components\BatchStockAvailabilityRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
