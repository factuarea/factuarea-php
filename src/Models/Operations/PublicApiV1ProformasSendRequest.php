...
class PublicApiV1ProformasSendRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $proforma, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?Components\SendProformaRequest $body = null)
    {
