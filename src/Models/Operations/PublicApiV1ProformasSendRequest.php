...
class PublicApiV1ProformasSendRequest
{
    /**
     *
     * @var string $proforma
    ...
    /**
     *
     * @var ?\Factuarea\Sdk\Models\Components\SendProformaRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public ?Components\SendProformaRequest $body = null;
     ...
     * @phpstan-pure
     */
    public function __construct(string $proforma, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?Components\SendProformaRequest $body = null)
    {
