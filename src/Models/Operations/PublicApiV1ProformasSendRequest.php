...
class PublicApiV1ProformasSendRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $proforma, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?Components\SendProformaRequest $body = null)
    {
