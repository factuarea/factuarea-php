...
class PublicApiV1ContactsBulkCreateRequest
{
    /**
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\BulkCreateBusinessContactsV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\BulkCreateBusinessContactsV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\BulkCreateBusinessContactsV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
