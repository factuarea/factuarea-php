...
class PublicApiV1PriceListsResolveManyRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\ResolveManyCatalogPricesRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\ResolveManyCatalogPricesRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\ResolveManyCatalogPricesRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
