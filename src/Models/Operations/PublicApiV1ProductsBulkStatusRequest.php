...
class PublicApiV1ProductsBulkStatusRequest
{
    /**
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\BulkStatusProductsV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\BulkStatusProductsV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\BulkStatusProductsV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
