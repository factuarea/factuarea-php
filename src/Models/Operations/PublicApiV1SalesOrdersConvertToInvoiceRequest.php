...
class PublicApiV1SalesOrdersConvertToInvoiceRequest
{
    /**
     *
     * @var string $company
    ...
    /**
     *
     * @var ?\Factuarea\Sdk\Models\Components\ConvertSalesOrderToInvoiceRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public ?Components\ConvertSalesOrderToInvoiceRequest $body = null;
     ...
     * @param  ?\Factuarea\Sdk\Models\Components\ConvertSalesOrderToInvoiceRequest  $body
     * @phpstan-pure
     */
    public function __construct(string $company, string $salesOrder, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?Components\ConvertSalesOrderToInvoiceRequest $body = null)
    {
