...
class PublicApiV1PriceListsDeleteRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(string $priceList, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
