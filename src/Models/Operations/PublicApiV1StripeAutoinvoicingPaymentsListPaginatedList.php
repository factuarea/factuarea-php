...
class PublicApiV1StripeAutoinvoicingPaymentsListPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\StripeAutoinvoicedPayment>  $data
     * @param  bool  $hasMore
