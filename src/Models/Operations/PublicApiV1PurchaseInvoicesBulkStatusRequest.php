...
class PublicApiV1PurchaseInvoicesBulkStatusRequest
{
    /**
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\BulkStatusPurchaseInvoicesV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\BulkStatusPurchaseInvoicesV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\BulkStatusPurchaseInvoicesV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
