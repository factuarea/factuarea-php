...
class PublicApiV1AbsenceTypesUnarchiveRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(string $absenceType, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
