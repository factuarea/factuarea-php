...
class PublicApiV1ProformasBulkSendRequest
{
    /**
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\BulkSendProformasV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\BulkSendProformasV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\BulkSendProformasV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
