...
class PublicApiV1ContactsBulkDeleteRequest
{
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\BulkDeleteBusinessContactsV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\BulkDeleteBusinessContactsV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\BulkDeleteBusinessContactsV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
