...
class PublicApiV1StockReservationsShowRequest
{
    /**
     *
     * @var string $company
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $stockReservation, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
