...
class PublicApiV1StorefrontPricesBulkResolveRequest
{
    /**
     *
     * @var string $company
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\BulkResolveStorefrontPricesRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\BulkResolveStorefrontPricesRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, Components\BulkResolveStorefrontPricesRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
