...
class PublicApiV1InvoicesBulkStatusRequest
{
    /**
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\BulkStatusInvoicesV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\BulkStatusInvoicesV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\BulkStatusInvoicesV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
