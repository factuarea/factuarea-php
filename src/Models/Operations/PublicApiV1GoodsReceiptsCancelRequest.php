...
class PublicApiV1GoodsReceiptsCancelRequest
{
    /**
     *
     * @var string $company
    ...
    /**
     *
     * @var string $goodsReceipt
     */
    #[SpeakeasyMetadata('pathParam:style=simple,explode=false,name=goods_receipt')]
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $goodsReceipt, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
