...
class PublicApiV1CompaniesCreateRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\CreateCompanyV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\CreateCompanyV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\CreateCompanyV1Request $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
