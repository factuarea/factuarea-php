...
class PublicApiV1TaxesSetDefaultRequest
{
    /**
     *
     * @var string $tax
     ...
     * @phpstan-pure
     */
    public function __construct(string $tax, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->tax = $tax;
