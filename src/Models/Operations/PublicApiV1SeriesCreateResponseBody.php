...
/** PublicApiV1SeriesCreateResponseBody - Series created successfully. The `Location` header contains the canonical URL of the newly created resource. */
class PublicApiV1SeriesCreateResponseBody
{
    /**
