...
class PublicApiV1MonthlyTimeRecordClosesPayrollExportRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $monthlyTimeRecordClose, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?PublicApiV1MonthlyTimeRecordClosesPayrollExportFormat $format = null)
    {
