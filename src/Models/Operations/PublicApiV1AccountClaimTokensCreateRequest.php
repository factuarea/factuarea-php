...
class PublicApiV1AccountClaimTokensCreateRequest
{
    /**
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\CreateAccountClaimTokenV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\CreateAccountClaimTokenV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $account, string $idempotencyKey, Components\CreateAccountClaimTokenV1Request $body, ?LocalDate $factuareaVersion = null)
    {
