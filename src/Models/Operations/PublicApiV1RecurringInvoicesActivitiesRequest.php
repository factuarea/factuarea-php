...
class PublicApiV1RecurringInvoicesActivitiesRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(string $recurringInvoice, ?string $startingAfter = null, ?string $endingBefore = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?int $limit = 25)
    {
