...
class PublicApiV1RecurringInvoicesActivitiesRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $recurringInvoice, ?string $startingAfter = null, ?string $endingBefore = null, ?LocalDate $factuareaVersion = null, ?int $limit = 25)
    {
