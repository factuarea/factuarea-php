...
class PublicApiV1AccountMembersDeleteRequest
{
    /**
     ...
     * @phpstan-pure
     */
    public function __construct(string $account, string $member, string $idempotencyKey, ?LocalDate $factuareaVersion = null)
    {
