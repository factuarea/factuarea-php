...
class PublicApiV1DeliveryNotesBulkDeleteRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\BulkDeleteDeliveryNotesRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
