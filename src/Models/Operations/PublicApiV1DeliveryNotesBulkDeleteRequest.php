...
class PublicApiV1DeliveryNotesBulkDeleteRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\BulkDeleteDeliveryNotesRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\BulkDeleteDeliveryNotesRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\BulkDeleteDeliveryNotesRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
