...
class PublicApiV1SuppliersCreateRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\CreateSupplierRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\CreateSupplierRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\CreateSupplierRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
