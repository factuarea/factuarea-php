...
class PublicApiV1DeliveryNotesPickingListPdfRequest
{
    /**
     *
     * @var string $company
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $deliveryNote, ?string $download = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
