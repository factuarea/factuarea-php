...
class PublicApiV1AccountInvitationsListRequest
{
     ...
     *
     * @var ?\Factuarea\Sdk\Models\Operations\PublicApiV1AccountInvitationsListStatus $status
     */
    #[SpeakeasyMetadata('queryParam:style=form,explode=true,name=status')]
    public ?PublicApiV1AccountInvitationsListStatus $status = null;
     ...
     * @phpstan-pure
     */
    public function __construct(string $account, ?PublicApiV1AccountInvitationsListStatus $status = null, ?LocalDate $factuareaVersion = null)
    {
