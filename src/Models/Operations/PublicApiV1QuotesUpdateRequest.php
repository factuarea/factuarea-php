...
class PublicApiV1QuotesUpdateRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $quote, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?Components\UpdateQuoteRequest $body = null)
    {
