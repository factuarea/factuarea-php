...
class PublicApiV1SalesOrdersSendRequest
{
    /**
     *
     * @var string $company
    ...
    /**
     *
     * @var ?\Factuarea\Sdk\Models\Components\SendSalesOrderV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public ?Components\SendSalesOrderV1Request $body = null;
     ...
     * @param  ?\Factuarea\Sdk\Models\Components\SendSalesOrderV1Request  $body
     * @phpstan-pure
     */
    public function __construct(string $company, string $salesOrder, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?Components\SendSalesOrderV1Request $body = null)
    {
