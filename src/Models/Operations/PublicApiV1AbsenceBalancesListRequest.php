...
class PublicApiV1AbsenceBalancesListRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(?string $startingAfter = null, ?string $endingBefore = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?string $employeeId = null, ?string $absenceTypeId = null, ?int $year = null, ?int $limit = 25)
    {
