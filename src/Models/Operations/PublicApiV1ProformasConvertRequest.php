...
class PublicApiV1ProformasConvertRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $proforma, string $idempotencyKey, Components\ConvertProformaRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
