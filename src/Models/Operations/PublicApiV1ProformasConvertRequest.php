...
class PublicApiV1ProformasConvertRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $proforma, string $idempotencyKey, Components\ConvertProformaRequest $body, ?LocalDate $factuareaVersion = null)
    {
