...
class PublicApiV1ProformasConvertRequest
{
    /**
     *
     * @var string $proforma
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\ConvertProformaRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\ConvertProformaRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $proforma, Components\ConvertProformaRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
