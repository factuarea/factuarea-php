...
class PublicApiV1ReturnsReceiveRequest
{
    /**
     *
     * @var string $company
    ...
    /**
     *
     * @var ?\Factuarea\Sdk\Models\Components\ReceiveReturnRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public ?Components\ReceiveReturnRequest $body = null;
     ...
     * @param  ?\Factuarea\Sdk\Models\Components\ReceiveReturnRequest  $body
     * @phpstan-pure
     */
    public function __construct(string $company, string $return, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?Components\ReceiveReturnRequest $body = null)
    {
