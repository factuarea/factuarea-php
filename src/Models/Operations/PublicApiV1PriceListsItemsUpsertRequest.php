...
class PublicApiV1PriceListsItemsUpsertRequest
{
    /**
     *
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\UpsertPriceListItemRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\UpsertPriceListItemRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $priceList, Components\UpsertPriceListItemRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
