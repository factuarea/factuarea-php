...
class PublicApiV1PriceListsItemsUpsertRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $priceList, Components\UpsertPriceListItemRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null)
    {
