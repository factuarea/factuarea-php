...
class PublicApiV1TaxesCreateRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\CreateTaxRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\CreateTaxRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\CreateTaxRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
