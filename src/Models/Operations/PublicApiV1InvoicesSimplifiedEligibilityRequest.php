...
class PublicApiV1InvoicesSimplifiedEligibilityRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\SimplifiedInvoiceEligibilityV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\SimplifiedInvoiceEligibilityV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\SimplifiedInvoiceEligibilityV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
