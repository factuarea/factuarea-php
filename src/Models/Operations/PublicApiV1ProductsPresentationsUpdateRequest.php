...
class PublicApiV1ProductsPresentationsUpdateRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $product, string $presentation, Components\UpdateProductPresentationRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null)
    {
