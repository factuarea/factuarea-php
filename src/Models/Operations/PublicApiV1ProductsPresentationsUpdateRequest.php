...
class PublicApiV1ProductsPresentationsUpdateRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $product, string $presentation, Components\UpdateProductPresentationRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
