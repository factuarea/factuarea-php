...
class PublicApiV1ProductsSupplierOffersCreateRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $product, Components\CreateSupplierProductOfferRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
