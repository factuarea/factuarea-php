...
class PublicApiV1ProductsSupplierOffersCreateRequest
{
    /**
     *
     * @var string $product
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\CreateSupplierProductOfferRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\CreateSupplierProductOfferRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $product, Components\CreateSupplierProductOfferRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
