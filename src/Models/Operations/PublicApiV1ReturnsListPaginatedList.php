...
class PublicApiV1ReturnsListPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\ReturnT>  $data
     * @param  bool  $hasMore
