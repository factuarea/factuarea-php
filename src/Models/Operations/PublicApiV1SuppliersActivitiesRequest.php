...
class PublicApiV1SuppliersActivitiesRequest
{
    /**
     *
     * @var string $supplier
     ...
     * @phpstan-pure
     */
    public function __construct(string $supplier, ?string $startingAfter = null, ?string $endingBefore = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?int $limit = 25)
    {
