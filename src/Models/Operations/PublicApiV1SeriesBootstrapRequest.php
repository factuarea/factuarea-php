...
class PublicApiV1SeriesBootstrapRequest
{
    /**
     ...
     * @phpstan-pure
     */
    public function __construct(?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
