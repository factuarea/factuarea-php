...
class PublicApiV1AccountClaimTokensAcceptRequest
{
    /**
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\AcceptAccountClaimTokenV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\AcceptAccountClaimTokenV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $account, string $idempotencyKey, Components\AcceptAccountClaimTokenV1Request $body, ?LocalDate $factuareaVersion = null)
    {
