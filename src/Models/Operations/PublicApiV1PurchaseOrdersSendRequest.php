...
class PublicApiV1PurchaseOrdersSendRequest
{
    /**
     *
     * @var string $company
    ...
    /**
     *
     * @var ?\Factuarea\Sdk\Models\Components\SendPurchaseOrderV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public ?Components\SendPurchaseOrderV1Request $body = null;
     ...
     * @param  ?\Factuarea\Sdk\Models\Components\SendPurchaseOrderV1Request  $body
     * @phpstan-pure
     */
    public function __construct(string $company, string $purchaseOrder, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?Components\SendPurchaseOrderV1Request $body = null)
    {
