...
class PublicApiV1MonthlyTimeRecordClosesListPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\MonthlyTimeRecordClose>  $data
     * @param  bool  $hasMore
