...
class PublicApiV1ProductsFindBySkuRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\FindProductBySkuRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\FindProductBySkuRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\FindProductBySkuRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
