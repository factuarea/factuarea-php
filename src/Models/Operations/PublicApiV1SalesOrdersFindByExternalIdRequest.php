...
class PublicApiV1SalesOrdersFindByExternalIdRequest
{
    /**
     *
     * @var string $company
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\FindSalesOrderByExternalIdRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\FindSalesOrderByExternalIdRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, Components\FindSalesOrderByExternalIdRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
