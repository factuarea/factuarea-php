...
class PublicApiV1AbsenceBalancesListPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\AbsenceBalance>  $data
     * @param  bool  $hasMore
