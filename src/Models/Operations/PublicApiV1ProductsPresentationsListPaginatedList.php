...
class PublicApiV1ProductsPresentationsListPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\ProductPresentation>  $data
     * @param  bool  $hasMore
