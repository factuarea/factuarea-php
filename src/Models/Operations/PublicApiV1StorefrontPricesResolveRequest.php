...
class PublicApiV1StorefrontPricesResolveRequest
{
    /**
     *
     * @var string $company
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\ResolveStorefrontPriceRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\ResolveStorefrontPriceRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, Components\ResolveStorefrontPriceRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
