...
class PublicApiV1WebhookEndpointsDeliveriesReplayRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(string $webhookEndpoint, string $delivery, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
