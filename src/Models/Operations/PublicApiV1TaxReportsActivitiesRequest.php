...
class PublicApiV1TaxReportsActivitiesRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $taxReport, ?string $startingAfter = null, ?string $endingBefore = null, ?LocalDate $factuareaVersion = null, ?int $limit = 25)
    {
