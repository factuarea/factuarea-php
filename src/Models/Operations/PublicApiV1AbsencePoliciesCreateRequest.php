...
class PublicApiV1AbsencePoliciesCreateRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\CreateAbsencePolicyRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\CreateAbsencePolicyRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\CreateAbsencePolicyRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
