...
class PublicApiV1WarehousesLocationsListPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\WarehouseLocation>  $data
     * @param  bool  $hasMore
