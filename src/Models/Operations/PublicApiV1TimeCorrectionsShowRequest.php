...
class PublicApiV1TimeCorrectionsShowRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(string $timeCorrection, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
