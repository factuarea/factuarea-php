...
class PublicApiV1ReturnsRefundRequest
{
    /**
     *
     * @var string $company
    ...
    /**
     *
     * @var ?\Factuarea\Sdk\Models\Components\RefundReturnRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public ?Components\RefundReturnRequest $body = null;
     ...
     * @param  ?\Factuarea\Sdk\Models\Components\RefundReturnRequest  $body
     * @phpstan-pure
     */
    public function __construct(string $company, string $return, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?Components\RefundReturnRequest $body = null)
    {
