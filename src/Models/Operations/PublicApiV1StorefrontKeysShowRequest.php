...
class PublicApiV1StorefrontKeysShowRequest
{
    /**
     *
     * @var string $company
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $storefrontKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
