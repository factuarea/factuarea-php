...
class PublicApiV1InvoicesCreateRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\CreateInvoiceRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\CreateInvoiceRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\CreateInvoiceRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
