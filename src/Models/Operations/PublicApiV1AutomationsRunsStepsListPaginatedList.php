...
class PublicApiV1AutomationsRunsStepsListPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\AutomationStepRun>  $data
     * @param  bool  $hasMore
