...
class PublicApiV1InvoicesBulkDeleteRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\BulkDeleteInvoicesV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\BulkDeleteInvoicesV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\BulkDeleteInvoicesV1Request $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
