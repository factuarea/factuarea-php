...
class PublicApiV1VerifactuCertificatesUploadRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(Components\UploadCompanyCertificateV1Request $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
