...
class PublicApiV1VerifactuCertificatesUploadRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\UploadCompanyCertificateV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
