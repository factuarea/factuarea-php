...
class PublicApiV1CarriersFindByCodeRequest
{
    /**
     *
     * @var string $company
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\FindCarrierByCodeRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\FindCarrierByCodeRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, Components\FindCarrierByCodeRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
