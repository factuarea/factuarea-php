...
class PublicApiV1SeriesActivitiesRequest
{
    /**
     *
     * @var string $series
     ...
     * @phpstan-pure
     */
    public function __construct(string $series, ?string $startingAfter = null, ?string $endingBefore = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?int $limit = 25)
    {
        $this->series = $series;
