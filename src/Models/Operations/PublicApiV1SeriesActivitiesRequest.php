...
class PublicApiV1SeriesActivitiesRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $series, ?string $startingAfter = null, ?string $endingBefore = null, ?LocalDate $factuareaVersion = null, ?int $limit = 25)
    {
