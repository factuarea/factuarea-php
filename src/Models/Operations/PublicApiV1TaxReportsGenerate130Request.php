...
class PublicApiV1TaxReportsGenerate130Request
{
    /**
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\GenerateModelo130V1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\GenerateModelo130V1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\GenerateModelo130V1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
