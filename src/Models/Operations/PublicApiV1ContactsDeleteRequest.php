...
class PublicApiV1ContactsDeleteRequest
{
    /**
     *
     * @var string $contact
     ...
     * @phpstan-pure
     */
    public function __construct(string $contact, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
