...
class PublicApiV1PriceListsResolveRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\ResolveCatalogPriceRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\ResolveCatalogPriceRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\ResolveCatalogPriceRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
