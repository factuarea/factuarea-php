...
class PublicApiV1TimeBalancesTeamSummaryRequest
{
    /**
    ...
    /**
     * Summary month in YYYY-MM format; defaults to the current month.
     *
     * @var ?string $month
     */
     ...
     * @phpstan-pure
     */
    public function __construct(?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?string $month = null)
    {
