...
class PublicApiV1WarehousesLocationsShowRequest
{
    /**
     *
     * @var string $company
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $warehouse, string $location, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
