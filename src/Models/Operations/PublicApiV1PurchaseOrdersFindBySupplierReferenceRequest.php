...
class PublicApiV1PurchaseOrdersFindBySupplierReferenceRequest
{
    /**
     *
     * @var string $company
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\FindPurchaseOrderBySupplierReferenceRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\FindPurchaseOrderBySupplierReferenceRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, Components\FindPurchaseOrderBySupplierReferenceRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
