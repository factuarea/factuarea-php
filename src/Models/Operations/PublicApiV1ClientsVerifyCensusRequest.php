...
class PublicApiV1ClientsVerifyCensusRequest
{
    /**
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\VerifyClientCensusRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\VerifyClientCensusRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\VerifyClientCensusRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
