...
class PublicApiV1EmployeesFindByExternalIdRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\FindEmployeeByExternalIdRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\FindEmployeeByExternalIdRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\FindEmployeeByExternalIdRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
