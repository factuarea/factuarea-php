...
class PublicApiV1ClientsActivitiesPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\ClientActivity>  $data
     * @param  bool  $hasMore
