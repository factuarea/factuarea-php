...
class PublicApiV1WebhookEndpointsCreateRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\CreateWebhookEndpointRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\CreateWebhookEndpointRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\CreateWebhookEndpointRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
