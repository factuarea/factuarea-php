...
class PublicApiV1StockAvailabilityListPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\StockAvailability>  $data
     * @param  bool  $hasMore
