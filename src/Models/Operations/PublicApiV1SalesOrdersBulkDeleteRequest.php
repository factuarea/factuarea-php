...
class PublicApiV1SalesOrdersBulkDeleteRequest
{
    /**
     *
     * @var string $company
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\BulkDeleteSalesOrdersRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\BulkDeleteSalesOrdersRequest $body;
     ...
     * @param  \Factuarea\Sdk\Models\Components\BulkDeleteSalesOrdersRequest  $body
     * @param  ?LocalDate  $factuareaVersion
     * @param  ?string  $xActiveProfile
     * @phpstan-pure
     */
    public function __construct(string $company, string $idempotencyKey, Components\BulkDeleteSalesOrdersRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
