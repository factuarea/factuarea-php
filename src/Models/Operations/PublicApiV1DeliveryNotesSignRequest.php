...
class PublicApiV1DeliveryNotesSignRequest
{
    /**
     *
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\SignDeliveryNoteRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\SignDeliveryNoteRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $deliveryNote, Components\SignDeliveryNoteRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
