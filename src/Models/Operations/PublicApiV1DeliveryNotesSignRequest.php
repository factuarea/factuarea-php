...
class PublicApiV1DeliveryNotesSignRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $deliveryNote, string $idempotencyKey, Components\SignDeliveryNoteRequest $body, ?LocalDate $factuareaVersion = null)
    {
