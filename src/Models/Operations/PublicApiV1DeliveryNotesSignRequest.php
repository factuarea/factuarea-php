...
class PublicApiV1DeliveryNotesSignRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $deliveryNote, string $idempotencyKey, Components\SignDeliveryNoteRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
