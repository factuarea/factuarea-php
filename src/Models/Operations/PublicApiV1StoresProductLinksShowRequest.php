...
class PublicApiV1StoresProductLinksShowRequest
{
    /**
     *
     * @var string $company
     ...
     * @var string $link
     */
    #[SpeakeasyMetadata('pathParam:style=simple,explode=false,name=link')]
    public string $link;
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $store, string $link, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
