...
class PublicApiV1QuotesFindByExternalIdRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\FindQuoteByExternalIdRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\FindQuoteByExternalIdRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\FindQuoteByExternalIdRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
