...
class PublicApiV1StorefrontKeysRevokeRequest
{
    /**
     *
     * @var string $company
    ...
    /**
     *
     * @var ?\Factuarea\Sdk\Models\Components\RevokeStorefrontKeyRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public ?Components\RevokeStorefrontKeyRequest $body = null;
     ...
     * @param  ?\Factuarea\Sdk\Models\Components\RevokeStorefrontKeyRequest  $body
     * @phpstan-pure
     */
    public function __construct(string $company, string $storefrontKey, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?Components\RevokeStorefrontKeyRequest $body = null)
    {
