...
class PublicApiV1DeliveryNotesSendRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $deliveryNote, string $idempotencyKey, Components\SendDeliveryNoteRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
