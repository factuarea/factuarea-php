...
class PublicApiV1DeliveryNotesSendRequest
{
    /**
     *
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\SendDeliveryNoteRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\SendDeliveryNoteRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $deliveryNote, Components\SendDeliveryNoteRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
