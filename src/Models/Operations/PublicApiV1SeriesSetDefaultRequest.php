...
class PublicApiV1SeriesSetDefaultRequest
{
    /**
     *
     * @var string $series
     ...
     * @phpstan-pure
     */
    public function __construct(string $series, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->series = $series;
