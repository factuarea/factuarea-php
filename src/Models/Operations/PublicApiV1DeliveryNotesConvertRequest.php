...
class PublicApiV1DeliveryNotesConvertRequest
{
    /**
     *
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\ConvertDeliveryNoteRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\ConvertDeliveryNoteRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $deliveryNote, Components\ConvertDeliveryNoteRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
