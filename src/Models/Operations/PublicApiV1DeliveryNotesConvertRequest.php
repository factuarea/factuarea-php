...
class PublicApiV1DeliveryNotesConvertRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $deliveryNote, string $idempotencyKey, Components\ConvertDeliveryNoteRequest $body, ?LocalDate $factuareaVersion = null)
    {
