...
class PublicApiV1SuppliersBulkDeleteRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\BulkDeleteSuppliersRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\BulkDeleteSuppliersRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\BulkDeleteSuppliersRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
