...
class PublicApiV1SuppliersBulkDeleteRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\BulkDeleteSuppliersRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
