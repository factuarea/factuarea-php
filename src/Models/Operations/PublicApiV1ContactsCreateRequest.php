...
class PublicApiV1ContactsCreateRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\CreateBusinessContactV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\CreateBusinessContactV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\CreateBusinessContactV1Request $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
