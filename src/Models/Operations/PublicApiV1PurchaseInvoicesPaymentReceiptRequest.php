...
class PublicApiV1PurchaseInvoicesPaymentReceiptRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(string $purchaseInvoice, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
