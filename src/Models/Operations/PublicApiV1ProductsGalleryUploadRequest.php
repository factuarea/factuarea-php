...
class PublicApiV1ProductsGalleryUploadRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $product, string $idempotencyKey, Components\UploadProductGalleryImageRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
