...
class PublicApiV1ProductsGalleryUploadRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $product, Components\UploadProductGalleryImageRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
