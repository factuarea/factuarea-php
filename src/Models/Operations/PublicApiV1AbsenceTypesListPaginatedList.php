...
class PublicApiV1AbsenceTypesListPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\AbsenceType>  $data
     * @param  bool  $hasMore
