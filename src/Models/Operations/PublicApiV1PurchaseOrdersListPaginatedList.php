...
class PublicApiV1PurchaseOrdersListPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\PurchaseOrder>  $data
     * @param  bool  $hasMore
