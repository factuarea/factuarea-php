...
class PublicApiV1ContactsImportRequest
{
    /**
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\ImportBusinessContactsV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=multipart/form-data')]
    public Components\ImportBusinessContactsV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\ImportBusinessContactsV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
