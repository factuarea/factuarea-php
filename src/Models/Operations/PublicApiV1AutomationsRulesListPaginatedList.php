...
class PublicApiV1AutomationsRulesListPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\AutomationRule>  $data
     * @param  bool  $hasMore
