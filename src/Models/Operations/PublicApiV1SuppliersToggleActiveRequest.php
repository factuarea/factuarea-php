...
class PublicApiV1SuppliersToggleActiveRequest
{
    /**
     *
     * @var string $supplier
     ...
     * @phpstan-pure
     */
    public function __construct(string $supplier, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
