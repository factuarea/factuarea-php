...
class PublicApiV1TimeEntriesShowRequest
{
    /**
     *
     * @var string $timeEntry
     */
    #[SpeakeasyMetadata('pathParam:style=simple,explode=false,name=time_entry')]
     ...
     * @phpstan-pure
     */
    public function __construct(string $timeEntry, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
