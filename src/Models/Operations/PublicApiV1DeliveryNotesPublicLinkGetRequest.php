...
class PublicApiV1DeliveryNotesPublicLinkGetRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(string $deliveryNote, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
