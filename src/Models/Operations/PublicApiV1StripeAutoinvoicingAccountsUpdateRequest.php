...
class PublicApiV1StripeAutoinvoicingAccountsUpdateRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $account, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?Components\UpdateConnectedAccountRequest $body = null)
    {
