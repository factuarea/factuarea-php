...
class PublicApiV1ClientsFindByExternalIdRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\FindClientByExternalIdRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\FindClientByExternalIdRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\FindClientByExternalIdRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
