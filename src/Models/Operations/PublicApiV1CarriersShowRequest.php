...
class PublicApiV1CarriersShowRequest
{
    /**
     *
     * @var string $company
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $carrier, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
