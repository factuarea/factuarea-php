...
class PublicApiV1DeliveryNotesBulkPdfRequest
{
    /**
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\BulkPdfDeliveryNotesV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\BulkPdfDeliveryNotesV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\BulkPdfDeliveryNotesV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
