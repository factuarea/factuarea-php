...
class PublicApiV1WarehousesFindByCodeRequest
{
    /**
     *
     * @var string $company
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\FindWarehouseByCodeRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\FindWarehouseByCodeRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, Components\FindWarehouseByCodeRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
