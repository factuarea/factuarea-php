...
class PublicApiV1WorkSchedulesUnarchiveRequest
{
    /**
     *
     * @var string $schedule
     ...
     * @phpstan-pure
     */
    public function __construct(string $schedule, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
