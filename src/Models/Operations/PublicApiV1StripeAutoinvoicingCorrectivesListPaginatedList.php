...
class PublicApiV1StripeAutoinvoicingCorrectivesListPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\StripeAutoinvoicedCorrective>  $data
     * @param  bool  $hasMore
