...
class PublicApiV1StockReservationsReleaseByHolderRequest
{
    /**
     *
     * @var string $company
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\ReleaseStockReservationsByHolderRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\ReleaseStockReservationsByHolderRequest $body;
     ...
     * @param  \Factuarea\Sdk\Models\Components\ReleaseStockReservationsByHolderRequest  $body
     * @param  ?LocalDate  $factuareaVersion
     * @param  ?string  $xActiveProfile
     * @phpstan-pure
     */
    public function __construct(string $company, string $idempotencyKey, Components\ReleaseStockReservationsByHolderRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
