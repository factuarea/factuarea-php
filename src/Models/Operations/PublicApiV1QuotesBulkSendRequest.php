...
class PublicApiV1QuotesBulkSendRequest
{
    /**
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\BulkSendQuotesV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\BulkSendQuotesV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\BulkSendQuotesV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
