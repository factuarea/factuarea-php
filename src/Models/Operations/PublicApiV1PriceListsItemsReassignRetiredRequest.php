...
class PublicApiV1PriceListsItemsReassignRetiredRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $priceList, string $item, Components\ReassignRetiredPriceListItemRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
