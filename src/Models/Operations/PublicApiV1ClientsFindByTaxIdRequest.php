...
class PublicApiV1ClientsFindByTaxIdRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\FindClientByTaxIdRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\FindClientByTaxIdRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\FindClientByTaxIdRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
