...
class PublicApiV1DeliveryNotesCreateRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\CreateDeliveryNoteRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\CreateDeliveryNoteRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\CreateDeliveryNoteRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
