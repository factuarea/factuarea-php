...
class PublicApiV1AbsenceTypesCreateRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\CreateAbsenceTypeRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\CreateAbsenceTypeRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\CreateAbsenceTypeRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
