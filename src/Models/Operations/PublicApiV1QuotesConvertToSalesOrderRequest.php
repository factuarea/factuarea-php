...
class PublicApiV1QuotesConvertToSalesOrderRequest
{
    /**
     *
     * @var string $quote
    ...
    /**
     *
     * @var ?\Factuarea\Sdk\Models\Components\ConvertQuoteToSalesOrderV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public ?Components\ConvertQuoteToSalesOrderV1Request $body = null;
     ...
     * @param  ?\Factuarea\Sdk\Models\Components\ConvertQuoteToSalesOrderV1Request  $body
     * @phpstan-pure
     */
    public function __construct(string $quote, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?Components\ConvertQuoteToSalesOrderV1Request $body = null)
    {
        $this->quote = $quote;
