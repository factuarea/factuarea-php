...
class PublicApiV1TimeCorrectionsListRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, ?string $startingAfter = null, ?string $endingBefore = null, ?LocalDate $factuareaVersion = null, ?PublicApiV1TimeCorrectionsListStatus $status = null, ?string $employeeId = null, ?\DateTime $from = null, ?\DateTime $to = null, ?int $limit = 25)
    {
