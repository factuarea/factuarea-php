...
class PublicApiV1TimeCorrectionsListRequest
{
    /**
     ...
     *
     * @var ?\Factuarea\Sdk\Models\Operations\PublicApiV1TimeCorrectionsListStatus $status
     */
    #[SpeakeasyMetadata('queryParam:style=form,explode=true,name=status')]
    public ?PublicApiV1TimeCorrectionsListStatus $status = null;
    ...
    /**
     * Start date/time of the request range (ISO 8601).
     *
     * @var ?\DateTime $from
     */
    ...
    /**
     * End date/time of the request range (ISO 8601).
     *
     * @var ?\DateTime $to
     */
     ...
     * @param  ?\Factuarea\Sdk\Models\Operations\PublicApiV1TimeCorrectionsListStatus  $status
     * @param  ?string  $employeeId
     * @param  ?\DateTime  $from
     * @param  ?\DateTime  $to
     * @phpstan-pure
     */
    public function __construct(?string $startingAfter = null, ?string $endingBefore = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?PublicApiV1TimeCorrectionsListStatus $status = null, ?string $employeeId = null, ?\DateTime $from = null, ?\DateTime $to = null, ?int $limit = 25)
    {
