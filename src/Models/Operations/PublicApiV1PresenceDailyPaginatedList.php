...
class PublicApiV1PresenceDailyPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\DailyPresence>  $data
     * @param  bool  $hasMore
