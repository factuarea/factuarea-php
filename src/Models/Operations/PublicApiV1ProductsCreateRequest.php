...
class PublicApiV1ProductsCreateRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\CreateProductRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\CreateProductRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\CreateProductRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
