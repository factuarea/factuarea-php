...
class PublicApiV1WarehousesShowRequest
{
    /**
     *
     * @var string $company
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $warehouse, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
