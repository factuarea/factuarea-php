...
class PublicApiV1TaxReportsPreviewRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\PreviewTaxReportV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\PreviewTaxReportV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\PreviewTaxReportV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
