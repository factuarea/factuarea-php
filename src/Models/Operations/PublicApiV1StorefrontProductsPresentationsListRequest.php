...
class PublicApiV1StorefrontProductsPresentationsListRequest
{
    /**
     *
     * @var string $company
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $product, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
