...
class PublicApiV1VerifactuSettingsUpdateRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?Components\UpdateVeriFactuSettingsV1Request $body = null)
    {
