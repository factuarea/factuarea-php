...
class PublicApiV1VerifactuSettingsUpdateRequest
{
    /**
    ...
    /**
     *
     * @var ?\Factuarea\Sdk\Models\Components\UpdateVeriFactuSettingsV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public ?Components\UpdateVeriFactuSettingsV1Request $body = null;
     ...
     * @phpstan-pure
     */
    public function __construct(?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?Components\UpdateVeriFactuSettingsV1Request $body = null)
    {
