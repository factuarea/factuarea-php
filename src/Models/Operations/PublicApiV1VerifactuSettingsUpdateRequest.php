...
class PublicApiV1VerifactuSettingsUpdateRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?Components\UpdateVeriFactuSettingsV1Request $body = null)
    {
