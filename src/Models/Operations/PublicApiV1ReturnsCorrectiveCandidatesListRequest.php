...
class PublicApiV1ReturnsCorrectiveCandidatesListRequest
{
    /**
     *
     * @var string $company
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $return, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
