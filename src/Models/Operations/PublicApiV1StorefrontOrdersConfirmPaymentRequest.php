...
class PublicApiV1StorefrontOrdersConfirmPaymentRequest
{
    /**
     *
     * @var string $company
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\ConfirmStorefrontCheckoutRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\ConfirmStorefrontCheckoutRequest $body;
     ...
     * @param  \Factuarea\Sdk\Models\Components\ConfirmStorefrontCheckoutRequest  $body
     * @param  ?LocalDate  $factuareaVersion
     * @param  ?string  $xActiveProfile
     * @phpstan-pure
     */
    public function __construct(string $company, string $order, string $idempotencyKey, Components\ConfirmStorefrontCheckoutRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
