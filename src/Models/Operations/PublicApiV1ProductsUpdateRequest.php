...
class PublicApiV1ProductsUpdateRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $product, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?Components\UpdateProductRequest $body = null)
    {
