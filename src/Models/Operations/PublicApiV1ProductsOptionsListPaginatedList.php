...
class PublicApiV1ProductsOptionsListPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\ProductOptionGroup>  $data
     * @param  bool  $hasMore
