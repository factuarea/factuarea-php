...
/** PublicApiV1RecurringInvoicesListPaginatedList - Cursor-paginated list envelope shared by every v1 listing endpoint. `data` holds the page items; `has_more` signals whether another page exists; `next_cursor` is the opaque cursor (UUID v7) to pass as `?cursor=` for the following page. The cursor is opaque — clients MUST NOT interpret it. Concrete listings narrow `data` to their resource type via `allOf`. */
class PublicApiV1RecurringInvoicesListPaginatedList
{
    /**
     * $data
     *
     * @var array<\Factuarea\Sdk\Models\Components\RecurringInvoice> $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\Factuarea\Sdk\Models\Components\RecurringInvoice>')]
    public array $data;
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\RecurringInvoice>  $data
     * @param  bool  $hasMore
