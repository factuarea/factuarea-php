...
class PublicApiV1SuppliersFindByExternalIdRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\FindSupplierByExternalIdRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\FindSupplierByExternalIdRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\FindSupplierByExternalIdRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
