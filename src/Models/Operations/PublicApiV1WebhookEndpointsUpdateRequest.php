...
class PublicApiV1WebhookEndpointsUpdateRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $webhookEndpoint, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?Components\UpdateWebhookEndpointRequest $body = null)
    {
