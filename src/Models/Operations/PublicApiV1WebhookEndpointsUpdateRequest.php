...
class PublicApiV1WebhookEndpointsUpdateRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $webhookEndpoint, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?Components\UpdateWebhookEndpointRequest $body = null)
    {
