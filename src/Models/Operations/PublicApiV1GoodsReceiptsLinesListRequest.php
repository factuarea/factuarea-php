...
class PublicApiV1GoodsReceiptsLinesListRequest
{
    /**
     *
     * @var string $company
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $goodsReceipt, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
