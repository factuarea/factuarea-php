...
class PublicApiV1DeliveryNotesFindByExternalIdRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\FindDeliveryNoteByExternalIdRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\FindDeliveryNoteByExternalIdRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\FindDeliveryNoteByExternalIdRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
