...
class PublicApiV1AccountInvitationsCancelRequest
{
    /**
     ...
     * @phpstan-pure
     */
    public function __construct(string $account, string $invitation, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null)
    {
