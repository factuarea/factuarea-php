...
class PublicApiV1ProformasDuplicateRequest
{
    /**
     *
     * @var string $proforma
     ...
     * @phpstan-pure
     */
    public function __construct(string $proforma, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
