...
class PublicApiV1PurchaseScansStatsRequest
{
    /**
     *
     * @var ?\Factuarea\Sdk\Models\Operations\PublicApiV1PurchaseScansStatsScope $scope
     */
    #[SpeakeasyMetadata('queryParam:style=form,explode=true,name=scope')]
    public ?PublicApiV1PurchaseScansStatsScope $scope = null;
     ...
     * @phpstan-pure
     */
    public function __construct(?PublicApiV1PurchaseScansStatsScope $scope = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->scope = $scope;
