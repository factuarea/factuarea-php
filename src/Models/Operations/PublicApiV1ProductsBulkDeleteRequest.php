...
class PublicApiV1ProductsBulkDeleteRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\BulkDeleteProductsRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\BulkDeleteProductsRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\BulkDeleteProductsRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
