...
class PublicApiV1ProductsBulkDeleteRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\BulkDeleteProductsRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
