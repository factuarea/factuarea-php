...
class PublicApiV1ProductsConfigurationsListPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\ProductConfiguration>  $data
     * @param  bool  $hasMore
