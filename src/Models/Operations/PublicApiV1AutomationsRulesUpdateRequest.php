...
class PublicApiV1AutomationsRulesUpdateRequest
{
    /**
     *
     * @var string $rule
    ...
    /**
     *
     * @var ?\Factuarea\Sdk\Models\Components\UpdateAutomationRuleV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public ?Components\UpdateAutomationRuleV1Request $body = null;
     ...
     * @phpstan-pure
     */
    public function __construct(string $rule, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?Components\UpdateAutomationRuleV1Request $body = null)
    {
        $this->rule = $rule;
