...
class PublicApiV1QuotesConvertRequest
{
    /**
     *
     * @var string $quote
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\ConvertQuoteRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\ConvertQuoteRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $quote, Components\ConvertQuoteRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->quote = $quote;
        $this->body = $body;
