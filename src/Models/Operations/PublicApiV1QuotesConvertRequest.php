...
class PublicApiV1QuotesConvertRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $quote, string $idempotencyKey, Components\ConvertQuoteRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->quote = $quote;
