...
class PublicApiV1SuppliersBulkStatusRequest
{
    /**
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\BulkStatusSuppliersV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\BulkStatusSuppliersV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\BulkStatusSuppliersV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
