...
class PublicApiV1InvoicesVoidRequest
{
    /**
     *
     * @var string $invoice
    ...
    /**
     *
     * @var ?\Factuarea\Sdk\Models\Components\VoidInvoiceRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public ?Components\VoidInvoiceRequest $body = null;
     ...
     * @phpstan-pure
     */
    public function __construct(string $invoice, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?Components\VoidInvoiceRequest $body = null)
    {
