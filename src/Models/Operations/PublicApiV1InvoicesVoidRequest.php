...
class PublicApiV1InvoicesVoidRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $invoice, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?Components\VoidInvoiceRequest $body = null)
    {
