...
class PublicApiV1InvoicesVoidRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $invoice, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?Components\VoidInvoiceRequest $body = null)
    {
