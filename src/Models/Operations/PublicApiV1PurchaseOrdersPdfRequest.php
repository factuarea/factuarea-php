...
class PublicApiV1PurchaseOrdersPdfRequest
{
    /**
     *
     * @var string $company
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $purchaseOrder, ?string $download = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
