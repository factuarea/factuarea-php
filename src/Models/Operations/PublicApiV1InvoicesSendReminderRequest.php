...
class PublicApiV1InvoicesSendReminderRequest
{
    /**
     *
     * @var string $invoice
     ...
     * @phpstan-pure
     */
    public function __construct(string $invoice, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?Components\SendInvoiceReminderV1Request $body = null)
    {
