...
class PublicApiV1InvoicesSendReminderRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $invoice, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?Components\SendInvoiceReminderV1Request $body = null)
    {
