...
class PublicApiV1WebhookEndpointsRotateSecretRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(string $webhookEndpoint, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
