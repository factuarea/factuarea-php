...
class PublicApiV1FaceSubmissionsShowRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(string $faceSubmission, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
