...
class PublicApiV1FaceSubmissionsCancelRequest
{
    /**
     *
     * @var string $faceSubmission
     */
    #[SpeakeasyMetadata('pathParam:style=simple,explode=false,name=faceSubmission')]
    public string $faceSubmission;
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\CancelFaceSubmissionV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\CancelFaceSubmissionV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $faceSubmission, string $idempotencyKey, Components\CancelFaceSubmissionV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->faceSubmission = $faceSubmission;
