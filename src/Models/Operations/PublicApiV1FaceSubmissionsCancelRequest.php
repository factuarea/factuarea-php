...
class PublicApiV1FaceSubmissionsCancelRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $faceSubmission, Components\CancelFaceSubmissionV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
