...
class PublicApiV1FaceSubmissionsCancelRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $faceSubmission, string $idempotencyKey, Components\CancelFaceSubmissionV1Request $body, ?LocalDate $factuareaVersion = null)
    {
