...
class PublicApiV1ProformasConvertToSalesOrderRequest
{
    /**
     *
     * @var string $proforma
    ...
    /**
     *
     * @var ?\Factuarea\Sdk\Models\Components\ConvertProformaToSalesOrderV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public ?Components\ConvertProformaToSalesOrderV1Request $body = null;
     ...
     * @param  ?\Factuarea\Sdk\Models\Components\ConvertProformaToSalesOrderV1Request  $body
     * @phpstan-pure
     */
    public function __construct(string $proforma, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?Components\ConvertProformaToSalesOrderV1Request $body = null)
    {
