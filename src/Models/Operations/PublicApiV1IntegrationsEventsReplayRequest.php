...
class PublicApiV1IntegrationsEventsReplayRequest
{
    /**
     *
     * @var string $event
     ...
     * @phpstan-pure
     */
    public function __construct(string $event, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->event = $event;
