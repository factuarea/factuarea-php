...
class PublicApiV1DeliveryNotesFulfilmentStatusesRequest
{
    /**
     *
     * @var string $company
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
