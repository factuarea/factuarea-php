...
class PublicApiV1AutomationsRunsStepsReplayRequest
{
     ...
     */
    #[SpeakeasyMetadata('pathParam:style=simple,explode=false,name=step_index')]
     ...
     * @phpstan-pure
     */
    public function __construct(string $run, string $stepIndex, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->run = $run;
