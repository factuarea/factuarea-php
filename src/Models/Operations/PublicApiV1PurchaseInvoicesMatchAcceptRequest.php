...
class PublicApiV1PurchaseInvoicesMatchAcceptRequest
{
    /**
     *
     * @var string $company
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $purchaseInvoice, string $idempotencyKey, Components\ResolvePurchaseInvoiceMatchRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
