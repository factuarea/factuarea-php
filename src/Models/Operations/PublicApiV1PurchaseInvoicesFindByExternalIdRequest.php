...
class PublicApiV1PurchaseInvoicesFindByExternalIdRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\FindPurchaseInvoiceByExternalIdRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\FindPurchaseInvoiceByExternalIdRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\FindPurchaseInvoiceByExternalIdRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
