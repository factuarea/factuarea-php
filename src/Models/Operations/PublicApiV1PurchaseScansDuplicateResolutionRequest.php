...
class PublicApiV1PurchaseScansDuplicateResolutionRequest
{
    /**
     *
     * @var string $purchaseScan
     */
    #[SpeakeasyMetadata('pathParam:style=simple,explode=false,name=purchase_scan')]
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\ResolvePurchaseScanDuplicateV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\ResolvePurchaseScanDuplicateV1Request $body;
     ...
     * @param  \Factuarea\Sdk\Models\Components\ResolvePurchaseScanDuplicateV1Request  $body
     * @param  ?LocalDate  $factuareaVersion
     * @param  ?string  $xActiveProfile
     * @phpstan-pure
     */
    public function __construct(string $purchaseScan, string $idempotencyKey, Components\ResolvePurchaseScanDuplicateV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->purchaseScan = $purchaseScan;
