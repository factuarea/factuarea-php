...
class PublicApiV1StockTransfersPdfRequest
{
    /**
     *
     * @var string $company
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $stockTransfer, ?string $download = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
