...
class PublicApiV1RecurringInvoicesActivateRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(string $recurringInvoice, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
