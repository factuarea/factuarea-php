...
class PublicApiV1SalesOrdersPdfRequest
{
    /**
     *
     * @var string $company
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $salesOrder, ?string $download = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
