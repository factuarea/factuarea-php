...
class PublicApiV1ContactsActivitiesPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\BusinessContactActivity>  $data
     * @param  bool  $hasMore
