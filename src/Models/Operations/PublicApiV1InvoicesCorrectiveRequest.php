...
class PublicApiV1InvoicesCorrectiveRequest
{
    /**
     *
     * @var string $invoice
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\CreateCorrectiveInvoiceRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\CreateCorrectiveInvoiceRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $invoice, Components\CreateCorrectiveInvoiceRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
