...
class PublicApiV1InvoicesCorrectiveRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $invoice, string $idempotencyKey, Components\CreateCorrectiveInvoiceRequest $body, ?LocalDate $factuareaVersion = null)
    {
