...
class PublicApiV1InvoicesCorrectiveRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $invoice, string $idempotencyKey, Components\CreateCorrectiveInvoiceRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
