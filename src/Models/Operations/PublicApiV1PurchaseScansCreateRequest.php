...
class PublicApiV1PurchaseScansCreateRequest
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\UploadPurchaseScansRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=multipart/form-data')]
    public Components\UploadPurchaseScansRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\UploadPurchaseScansRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
