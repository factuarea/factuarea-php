...
class PublicApiV1StorefrontCatalogSelectionsResolveRequest
{
    /**
     *
     * @var string $company
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\ResolveStorefrontCatalogSelectionRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\ResolveStorefrontCatalogSelectionRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, Components\ResolveStorefrontCatalogSelectionRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
