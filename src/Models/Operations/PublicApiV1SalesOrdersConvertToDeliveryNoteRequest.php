...
class PublicApiV1SalesOrdersConvertToDeliveryNoteRequest
{
    /**
     *
     * @var string $company
    ...
    /**
     *
     * @var ?\Factuarea\Sdk\Models\Components\ConvertSalesOrderToDeliveryNoteRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public ?Components\ConvertSalesOrderToDeliveryNoteRequest $body = null;
     ...
     * @param  ?\Factuarea\Sdk\Models\Components\ConvertSalesOrderToDeliveryNoteRequest  $body
     * @phpstan-pure
     */
    public function __construct(string $company, string $salesOrder, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?Components\ConvertSalesOrderToDeliveryNoteRequest $body = null)
    {
