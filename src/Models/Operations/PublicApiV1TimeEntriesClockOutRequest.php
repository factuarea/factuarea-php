...
class PublicApiV1TimeEntriesClockOutRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\ClockActionRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\ClockActionRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\ClockActionRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
