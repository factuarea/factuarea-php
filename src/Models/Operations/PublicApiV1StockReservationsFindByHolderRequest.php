...
class PublicApiV1StockReservationsFindByHolderRequest
{
    /**
     *
     * @var string $company
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\FindStockReservationsByHolderRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\FindStockReservationsByHolderRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, Components\FindStockReservationsByHolderRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
