...
class PublicApiV1ProformasBulkPdfRequest
{
    /**
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\BulkPdfProformasV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\BulkPdfProformasV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\BulkPdfProformasV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
