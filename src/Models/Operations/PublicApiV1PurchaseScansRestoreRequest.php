...
class PublicApiV1PurchaseScansRestoreRequest
{
    /**
     *
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\VersionedPurchaseScanRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\VersionedPurchaseScanRequest $body;
     ...
     * @param  \Factuarea\Sdk\Models\Components\VersionedPurchaseScanRequest  $body
     * @param  ?LocalDate  $factuareaVersion
     * @param  ?string  $xActiveProfile
     * @phpstan-pure
     */
    public function __construct(string $purchaseScan, string $idempotencyKey, Components\VersionedPurchaseScanRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
