...
class PublicApiV1TimeEntriesListPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\TimeEntry>  $data
     * @param  bool  $hasMore
