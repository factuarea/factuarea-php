...
class PublicApiV1WorkSchedulesListPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\WeeklySchedule>  $data
     * @param  bool  $hasMore
