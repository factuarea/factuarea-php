...
class PublicApiV1ProductsSupplierOffersUpdateRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $product, string $offer, Components\UpdateSupplierProductOfferRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
