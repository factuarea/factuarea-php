...
class PublicApiV1InvoicesSendRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $invoice, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?Components\SendInvoiceRequest $body = null)
    {
