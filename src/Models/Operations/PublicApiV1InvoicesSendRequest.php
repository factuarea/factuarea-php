...
class PublicApiV1InvoicesSendRequest
{
    /**
     *
     * @var string $invoice
    ...
    /**
     *
     * @var ?\Factuarea\Sdk\Models\Components\SendInvoiceRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public ?Components\SendInvoiceRequest $body = null;
     ...
     * @phpstan-pure
     */
    public function __construct(string $invoice, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?Components\SendInvoiceRequest $body = null)
    {
