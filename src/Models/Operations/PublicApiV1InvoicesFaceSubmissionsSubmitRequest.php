...
class PublicApiV1InvoicesFaceSubmissionsSubmitRequest
{
    /**
     *
     * @var string $invoice
     ...
     * @phpstan-pure
     */
    public function __construct(string $invoice, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
