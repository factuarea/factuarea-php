...
class PublicApiV1ProformasBulkDeleteRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\BulkDeleteProformasV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
