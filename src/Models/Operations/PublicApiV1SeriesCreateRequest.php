...
class PublicApiV1SeriesCreateRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\CreateSeriesRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\CreateSeriesRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\CreateSeriesRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
