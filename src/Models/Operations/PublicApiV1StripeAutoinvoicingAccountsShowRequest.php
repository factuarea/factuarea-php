...
class PublicApiV1StripeAutoinvoicingAccountsShowRequest
{
    /**
     *
     * @var string $account
     ...
     * @phpstan-pure
     */
    public function __construct(string $account, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
