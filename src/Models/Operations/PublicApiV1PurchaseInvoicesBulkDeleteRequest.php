...
class PublicApiV1PurchaseInvoicesBulkDeleteRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(Components\BulkDeletePurchaseInvoicesRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
