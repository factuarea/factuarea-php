...
class PublicApiV1PurchaseInvoicesBulkDeleteRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\BulkDeletePurchaseInvoicesRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
