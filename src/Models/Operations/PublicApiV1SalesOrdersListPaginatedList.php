...
class PublicApiV1SalesOrdersListPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\SalesOrder>  $data
     * @param  bool  $hasMore
