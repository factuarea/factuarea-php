...
class PublicApiV1AutomationsRulesDryRunRequest
{
    /**
     *
     * @var string $rule
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\DryRunAutomationRuleV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\DryRunAutomationRuleV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $rule, Components\DryRunAutomationRuleV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->rule = $rule;
        $this->body = $body;
