...
class PublicApiV1InvoicesQuarterlyDownloadZipRequest
{
    /**
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\QuarterlyDownloadV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
