...
class PublicApiV1AccountOwnerTransferRequest
{
    /**
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\TransferAccountOwnershipV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\TransferAccountOwnershipV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $account, string $idempotencyKey, Components\TransferAccountOwnershipV1Request $body, ?LocalDate $factuareaVersion = null)
    {
