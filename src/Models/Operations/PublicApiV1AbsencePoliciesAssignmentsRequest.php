...
class PublicApiV1AbsencePoliciesAssignmentsRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(string $absencePolicy, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
