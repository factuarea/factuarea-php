...
class PublicApiV1InvoicesQuarterlySendEmailRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\QuarterlyDownloadV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\QuarterlyDownloadV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\QuarterlyDownloadV1Request $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
