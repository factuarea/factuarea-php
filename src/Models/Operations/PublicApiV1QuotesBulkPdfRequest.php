...
class PublicApiV1QuotesBulkPdfRequest
{
    ...
    public Components\BulkPdfQuotesV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $idempotencyKey, Components\BulkPdfQuotesV1Request $body, ?LocalDate $factuareaVersion = null)
    {
