...
class PublicApiV1WorkSchedulesAssignmentsRequest
{
    /**
     *
     * @var string $schedule
     ...
     * @phpstan-pure
     */
    public function __construct(string $schedule, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
