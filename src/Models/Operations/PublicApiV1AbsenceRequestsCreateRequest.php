...
class PublicApiV1AbsenceRequestsCreateRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\CreateAbsenceRequestRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\CreateAbsenceRequestRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\CreateAbsenceRequestRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
