...
class PublicApiV1InvoicesFindByNumberRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\FindInvoiceByNumberRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\FindInvoiceByNumberRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\FindInvoiceByNumberRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
