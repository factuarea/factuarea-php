...
class PublicApiV1PayoutsShowRequest
{
    /**
     *
     * @var string $payout
     */
    #[SpeakeasyMetadata('pathParam:style=simple,explode=false,name=payout')]
     ...
     * @phpstan-pure
     */
    public function __construct(string $payout, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->payout = $payout;
