...
class PublicApiV1DeliveryNotesPickingQueueListPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\PickingQueueItem>  $data
     * @param  bool  $hasMore
