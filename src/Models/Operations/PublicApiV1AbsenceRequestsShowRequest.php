...
class PublicApiV1AbsenceRequestsShowRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(string $absenceRequest, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
