...
class PublicApiV1ProductsSupplierOffersListPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\SupplierProductOffer>  $data
     * @param  bool  $hasMore
