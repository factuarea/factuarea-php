...
class PublicApiV1TimeEntriesManualRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\RecordManualTimeEntryRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\RecordManualTimeEntryRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\RecordManualTimeEntryRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
