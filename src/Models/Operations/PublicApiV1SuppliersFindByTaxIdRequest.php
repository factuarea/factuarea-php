...
class PublicApiV1SuppliersFindByTaxIdRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\FindSupplierByTaxIdRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\FindSupplierByTaxIdRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\FindSupplierByTaxIdRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
