...
class PublicApiV1InvoicesBulkPdfRequest
{
    /**
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\BulkPdfInvoicesV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\BulkPdfInvoicesV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\BulkPdfInvoicesV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
