...
class PublicApiV1DeliveryNotesBulkStatusRequest
{
    /**
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\BulkStatusDeliveryNotesV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\BulkStatusDeliveryNotesV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\BulkStatusDeliveryNotesV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
