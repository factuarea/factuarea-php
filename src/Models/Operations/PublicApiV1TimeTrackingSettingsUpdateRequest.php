...
class PublicApiV1TimeTrackingSettingsUpdateRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, Components\UpdateTimeTrackingSettingsRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null)
    {
