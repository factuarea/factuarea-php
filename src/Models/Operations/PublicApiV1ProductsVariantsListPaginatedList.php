...
class PublicApiV1ProductsVariantsListPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\ProductVariant>  $data
     * @param  bool  $hasMore
