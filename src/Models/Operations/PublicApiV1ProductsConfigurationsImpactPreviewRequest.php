...
class PublicApiV1ProductsConfigurationsImpactPreviewRequest
{
    /**
     *
     * @var string $product
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\PreviewCatalogConfigurationImpactRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\PreviewCatalogConfigurationImpactRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $product, Components\PreviewCatalogConfigurationImpactRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
