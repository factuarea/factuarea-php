...
class PublicApiV1StorefrontSessionsShowRequest
{
    /**
     *
     * @var string $company
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $session, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
