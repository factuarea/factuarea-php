...
class PublicApiV1AbsencePoliciesUnarchiveRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(string $absencePolicy, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
