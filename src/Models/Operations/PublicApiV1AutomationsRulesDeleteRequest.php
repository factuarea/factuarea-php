...
class PublicApiV1AutomationsRulesDeleteRequest
{
    /**
     *
     * @var string $rule
     ...
     * @phpstan-pure
     */
    public function __construct(string $rule, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->rule = $rule;
