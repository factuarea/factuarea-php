...
class PublicApiV1PurchaseInvoicesDeleteFileRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(string $purchaseInvoice, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
