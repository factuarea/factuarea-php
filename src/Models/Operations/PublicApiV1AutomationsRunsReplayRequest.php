...
class PublicApiV1AutomationsRunsReplayRequest
{
    /**
     *
     * @var string $run
     ...
     * @phpstan-pure
     */
    public function __construct(string $run, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->run = $run;
