...
class PublicApiV1ClientsBulkCreateRequest
{
    /**
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\BulkCreateClientsV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\BulkCreateClientsV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\BulkCreateClientsV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
