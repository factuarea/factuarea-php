...
class PublicApiV1EmployeeInvitationsSendRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\SendEmployeeInvitationRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
