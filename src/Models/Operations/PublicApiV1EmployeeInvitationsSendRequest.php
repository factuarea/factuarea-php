...
class PublicApiV1EmployeeInvitationsSendRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\SendEmployeeInvitationRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\SendEmployeeInvitationRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\SendEmployeeInvitationRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
