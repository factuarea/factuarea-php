...
class PublicApiV1ProductsSupplierOffersPreferredRequest
{
    /**
     *
     * @var string $product
     ...
     * @phpstan-pure
     */
    public function __construct(string $product, string $offer, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
