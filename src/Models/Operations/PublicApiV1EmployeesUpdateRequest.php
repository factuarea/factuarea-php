...
class PublicApiV1EmployeesUpdateRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $employee, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?Components\UpdateEmployeeRequest $body = null)
    {
