...
class PublicApiV1MonthlyTimeRecordClosesExportRequest
{
    /**
     *
     ...
     *
     * @var ?\Factuarea\Sdk\Models\Operations\PublicApiV1MonthlyTimeRecordClosesExportFormat $format
     */
    #[SpeakeasyMetadata('queryParam:style=form,explode=true,name=format')]
    public ?PublicApiV1MonthlyTimeRecordClosesExportFormat $format = null;
     ...
     * @phpstan-pure
     */
    public function __construct(string $monthlyTimeRecordClose, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?PublicApiV1MonthlyTimeRecordClosesExportFormat $format = null)
    {
