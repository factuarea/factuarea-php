...
class PublicApiV1MonthlyTimeRecordClosesExportRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $monthlyTimeRecordClose, ?LocalDate $factuareaVersion = null, ?PublicApiV1MonthlyTimeRecordClosesExportFormat $format = null)
    {
