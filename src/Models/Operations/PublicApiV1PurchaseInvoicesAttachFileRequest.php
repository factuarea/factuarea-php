...
class PublicApiV1PurchaseInvoicesAttachFileRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $purchaseInvoice, Components\AttachPurchaseInvoiceFileRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
