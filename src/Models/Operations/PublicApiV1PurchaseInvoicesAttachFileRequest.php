...
class PublicApiV1PurchaseInvoicesAttachFileRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $purchaseInvoice, string $idempotencyKey, Components\AttachPurchaseInvoiceFileRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
