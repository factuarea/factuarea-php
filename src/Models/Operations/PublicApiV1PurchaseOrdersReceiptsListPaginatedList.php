...
class PublicApiV1PurchaseOrdersReceiptsListPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\GoodsReceipt>  $data
     * @param  bool  $hasMore
