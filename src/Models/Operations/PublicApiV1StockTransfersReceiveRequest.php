...
class PublicApiV1StockTransfersReceiveRequest
{
    /**
     *
     * @var string $company
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\ReceiveStockTransferRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\ReceiveStockTransferRequest $body;
     ...
     * @param  \Factuarea\Sdk\Models\Components\ReceiveStockTransferRequest  $body
     * @param  ?LocalDate  $factuareaVersion
     * @param  ?string  $xActiveProfile
     * @phpstan-pure
     */
    public function __construct(string $company, string $stockTransfer, string $idempotencyKey, Components\ReceiveStockTransferRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
