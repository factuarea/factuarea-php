...
class PublicApiV1StoresProductLinksListPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\StoreProductLink>  $data
     * @param  bool  $hasMore
