...
class PublicApiV1StockTransfersSendRequest
{
    /**
     *
     * @var string $company
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\SendStockTransferV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\SendStockTransferV1Request $body;
     ...
     * @param  \Factuarea\Sdk\Models\Components\SendStockTransferV1Request  $body
     * @param  ?LocalDate  $factuareaVersion
     * @param  ?string  $xActiveProfile
     * @phpstan-pure
     */
    public function __construct(string $company, string $stockTransfer, string $idempotencyKey, Components\SendStockTransferV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
