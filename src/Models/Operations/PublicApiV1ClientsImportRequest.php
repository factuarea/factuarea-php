...
class PublicApiV1ClientsImportRequest
{
    /**
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\ImportClientsV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=multipart/form-data')]
    public Components\ImportClientsV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\ImportClientsV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
