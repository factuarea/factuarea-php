...
class PublicApiV1PurchaseScansReviewRequest
{
    /**
     *
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\SavePurchaseScanReviewV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\SavePurchaseScanReviewV1Request $body;
     ...
     * @param  \Factuarea\Sdk\Models\Components\SavePurchaseScanReviewV1Request  $body
     * @param  ?string  $idempotencyKey
     * @param  ?LocalDate  $factuareaVersion
     * @param  ?string  $xActiveProfile
     * @phpstan-pure
     */
    public function __construct(string $purchaseScan, Components\SavePurchaseScanReviewV1Request $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
