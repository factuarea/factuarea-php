...
class PublicApiV1ContactsArchiveRequest
{
    /**
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $contact, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null)
    {
