...
class PublicApiV1StockReservationsReleaseRequest
{
    /**
     *
     * @var string $company
    ...
    /**
     *
     * @var string $stockReservation
     */
    #[SpeakeasyMetadata('pathParam:style=simple,explode=false,name=stock_reservation')]
    public string $stockReservation;
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $stockReservation, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
