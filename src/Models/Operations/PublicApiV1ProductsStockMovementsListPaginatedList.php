...
class PublicApiV1ProductsStockMovementsListPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\StockMovement>  $data
     * @param  bool  $hasMore
