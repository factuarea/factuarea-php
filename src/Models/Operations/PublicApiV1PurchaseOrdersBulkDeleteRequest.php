...
class PublicApiV1PurchaseOrdersBulkDeleteRequest
{
    /**
     *
     * @var string $company
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\BulkDeletePurchaseOrdersRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\BulkDeletePurchaseOrdersRequest $body;
     ...
     * @param  \Factuarea\Sdk\Models\Components\BulkDeletePurchaseOrdersRequest  $body
     * @param  ?LocalDate  $factuareaVersion
     * @param  ?string  $xActiveProfile
     * @phpstan-pure
     */
    public function __construct(string $company, string $idempotencyKey, Components\BulkDeletePurchaseOrdersRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
