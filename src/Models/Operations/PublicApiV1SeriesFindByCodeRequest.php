...
class PublicApiV1SeriesFindByCodeRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\FindSeriesByCodeRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\FindSeriesByCodeRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\FindSeriesByCodeRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
