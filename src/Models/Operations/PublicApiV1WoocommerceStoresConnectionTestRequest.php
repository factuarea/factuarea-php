...
class PublicApiV1WoocommerceStoresConnectionTestRequest
{
    /**
     *
     * @var string $store
     ...
     * @phpstan-pure
     */
    public function __construct(string $store, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->store = $store;
