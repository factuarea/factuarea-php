...
class PublicApiV1DeliveryNotesChangeStatusRequest
{
    /**
     *
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\ChangeDeliveryNoteStatusRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\ChangeDeliveryNoteStatusRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $deliveryNote, Components\ChangeDeliveryNoteStatusRequest $body, ?string $idempotencyKey = null)
    {
