...
class PublicApiV1MonthlyTimeRecordClosesSealShowRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(string $monthlyTimeRecordClose, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
