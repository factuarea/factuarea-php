...
class PublicApiV1SalesOrdersLinesListRequest
{
    /**
     *
     * @var string $company
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $salesOrder, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
