...
class PublicApiV1ProductsVideoUploadRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $product, string $idempotencyKey, Components\UploadProductVideoRequest $body, ?LocalDate $factuareaVersion = null)
    {
