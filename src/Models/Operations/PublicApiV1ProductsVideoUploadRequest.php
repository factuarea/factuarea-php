...
class PublicApiV1ProductsVideoUploadRequest
{
    /**
     *
     * @var string $product
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\UploadProductVideoRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=multipart/form-data')]
    public Components\UploadProductVideoRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $product, Components\UploadProductVideoRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
