...
class PublicApiV1PurchaseReorderSuggestionsAcceptRequest
{
    /**
     *
     * @var string $company
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\AcceptPurchaseReorderSuggestionRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\AcceptPurchaseReorderSuggestionRequest $body;
     ...
     * @param  \Factuarea\Sdk\Models\Components\AcceptPurchaseReorderSuggestionRequest  $body
     * @param  ?LocalDate  $factuareaVersion
     * @param  ?string  $xActiveProfile
     * @phpstan-pure
     */
    public function __construct(string $company, string $idempotencyKey, Components\AcceptPurchaseReorderSuggestionRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
