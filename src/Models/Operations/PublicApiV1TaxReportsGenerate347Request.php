...
class PublicApiV1TaxReportsGenerate347Request
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\GenerateModelo347V1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
