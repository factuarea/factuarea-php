...
class PublicApiV1TaxReportsGenerate347Request
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\GenerateModelo347V1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\GenerateModelo347V1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\GenerateModelo347V1Request $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
