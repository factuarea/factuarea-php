...
class PublicApiV1EmployeeInvitationsListPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\EmployeeInvitation>  $data
     * @param  bool  $hasMore
