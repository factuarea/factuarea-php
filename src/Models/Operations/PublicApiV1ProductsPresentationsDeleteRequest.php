...
class PublicApiV1ProductsPresentationsDeleteRequest
{
    /**
     *
     * @var string $product
     ...
     * @phpstan-pure
     */
    public function __construct(string $product, string $presentation, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
