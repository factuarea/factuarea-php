...
class PublicApiV1EmployeesListPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\Employee>  $data
     * @param  bool  $hasMore
