...
class PublicApiV1EmployeesDeactivateRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $employee, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?Components\DeactivateEmployeeRequest $body = null)
    {
