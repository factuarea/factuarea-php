...
class PublicApiV1TimeBalancesMonthlySheetRequest
{
    /**
     * Employee ID (UUID v7) whose monthly sheet to retrieve.
     *
    ...
    /**
     * Sheet month in YYYY-MM format; defaults to the current month.
     *
     * @var ?string $month
     */
     ...
     * @phpstan-pure
     */
    public function __construct(string $employeeId, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?string $month = null)
    {
