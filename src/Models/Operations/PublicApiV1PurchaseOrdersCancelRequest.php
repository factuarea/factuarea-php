...
class PublicApiV1PurchaseOrdersCancelRequest
{
    /**
     *
     * @var string $company
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $purchaseOrder, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
