...
class PublicApiV1PurchaseOrdersBulkCreateRequest
{
    /**
     *
     * @var string $company
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\BulkCreatePurchaseOrdersRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\BulkCreatePurchaseOrdersRequest $body;
     ...
     * @param  \Factuarea\Sdk\Models\Components\BulkCreatePurchaseOrdersRequest  $body
     * @param  ?LocalDate  $factuareaVersion
     * @param  ?string  $xActiveProfile
     * @phpstan-pure
     */
    public function __construct(string $company, string $idempotencyKey, Components\BulkCreatePurchaseOrdersRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
