...
class PublicApiV1QuotesPublicLinkUpdateRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $quote, Components\UpdateQuotePublicLinkRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null)
    {
