...
class PublicApiV1CarriersListPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\Carrier>  $data
     * @param  bool  $hasMore
