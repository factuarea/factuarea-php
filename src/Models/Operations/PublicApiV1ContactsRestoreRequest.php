...
class PublicApiV1ContactsRestoreRequest
{
    /**
     *
     * @var string $contact
     ...
     * @phpstan-pure
     */
    public function __construct(string $contact, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
