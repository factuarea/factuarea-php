...
class PublicApiV1InvoicesBulkSendRequest
{
    /**
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\BulkSendInvoicesV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\BulkSendInvoicesV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\BulkSendInvoicesV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
