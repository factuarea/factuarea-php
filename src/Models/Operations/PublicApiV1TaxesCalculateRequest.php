...
class PublicApiV1TaxesCalculateRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\CalculateTaxRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\CalculateTaxRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\CalculateTaxRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
