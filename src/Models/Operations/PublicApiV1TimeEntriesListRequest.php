...
class PublicApiV1TimeEntriesListRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(?string $startingAfter = null, ?string $endingBefore = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?string $employeeId = null, ?\DateTime $from = null, ?\DateTime $to = null, ?EntryType $entryType = null, ?int $limit = 25)
    {
