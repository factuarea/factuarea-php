...
class PublicApiV1PriceListsUpdateRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $priceList, Components\UpdatePriceListRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null)
    {
