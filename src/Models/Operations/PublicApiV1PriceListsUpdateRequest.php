...
class PublicApiV1PriceListsUpdateRequest
{
    /**
     *
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\UpdatePriceListRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\UpdatePriceListRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $priceList, Components\UpdatePriceListRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
