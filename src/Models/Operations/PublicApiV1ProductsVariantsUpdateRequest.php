...
class PublicApiV1ProductsVariantsUpdateRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $product, string $variant, Components\UpdateProductVariantRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
