...
class PublicApiV1StoresCreateRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\ConnectStoreV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\ConnectStoreV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\ConnectStoreV1Request $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
