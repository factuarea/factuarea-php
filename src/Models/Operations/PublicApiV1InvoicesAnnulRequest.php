...
class PublicApiV1InvoicesAnnulRequest
{
    /**
     *
     * @var string $invoice
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\AnnulInvoiceV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\AnnulInvoiceV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $invoice, Components\AnnulInvoiceV1Request $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
