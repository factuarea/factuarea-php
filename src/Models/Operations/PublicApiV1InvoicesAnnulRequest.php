...
class PublicApiV1InvoicesAnnulRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $invoice, string $idempotencyKey, Components\AnnulInvoiceV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
