...
class PublicApiV1PurchaseInvoicesRegisterPaymentRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $purchaseInvoice, Components\RegisterPurchaseInvoicePaymentRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
