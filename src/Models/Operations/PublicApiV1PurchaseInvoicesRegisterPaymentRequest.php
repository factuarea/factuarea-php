...
class PublicApiV1PurchaseInvoicesRegisterPaymentRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $purchaseInvoice, Components\RegisterPurchaseInvoicePaymentRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null)
    {
