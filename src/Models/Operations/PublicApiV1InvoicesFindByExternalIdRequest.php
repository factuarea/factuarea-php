...
class PublicApiV1InvoicesFindByExternalIdRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\FindInvoiceByExternalIdRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\FindInvoiceByExternalIdRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\FindInvoiceByExternalIdRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
