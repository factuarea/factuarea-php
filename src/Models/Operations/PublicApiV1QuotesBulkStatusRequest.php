...
class PublicApiV1QuotesBulkStatusRequest
{
    /**
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\BulkStatusQuotesV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\BulkStatusQuotesV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\BulkStatusQuotesV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
