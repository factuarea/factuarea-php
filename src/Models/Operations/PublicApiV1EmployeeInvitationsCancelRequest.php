...
class PublicApiV1EmployeeInvitationsCancelRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(string $invitation, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
