...
class PublicApiV1AutomationsRulesVersionsListPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\AutomationRuleVersion>  $data
     * @param  bool  $hasMore
