...
class PublicApiV1InvoicesPaymentsRevertRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $invoice, string $payment, string $idempotencyKey, Components\RevertInvoicePaymentRequest $body, ?LocalDate $factuareaVersion = null)
    {
