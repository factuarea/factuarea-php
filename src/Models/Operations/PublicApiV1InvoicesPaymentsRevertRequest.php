...
class PublicApiV1InvoicesPaymentsRevertRequest
{
    /**
     *
     * @var string $invoice
     ...
     * @var string $payment
     */
    #[SpeakeasyMetadata('pathParam:style=simple,explode=false,name=payment')]
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\RevertInvoicePaymentRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\RevertInvoicePaymentRequest $body;
     ...
     * @param  \Factuarea\Sdk\Models\Components\RevertInvoicePaymentRequest  $body
     * @param  ?LocalDate  $factuareaVersion
     * @param  ?string  $xActiveProfile
     * @phpstan-pure
     */
    public function __construct(string $invoice, string $payment, string $idempotencyKey, Components\RevertInvoicePaymentRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
