...
class PublicApiV1InvoicesExportExcelRequest
{
    /**
    ...
    /**
     *
     * @var ?\Factuarea\Sdk\Models\Components\ExportInvoicesExcelV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public ?Components\ExportInvoicesExcelV1Request $body = null;
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?Components\ExportInvoicesExcelV1Request $body = null)
    {
