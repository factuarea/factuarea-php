...
class PublicApiV1ProductsVariantsCreateRequest
{
    /**
     *
     * @var string $product
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\CreateProductVariantRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\CreateProductVariantRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $product, Components\CreateProductVariantRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
