...
class PublicApiV1ProductsVariantsCreateRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $product, Components\CreateProductVariantRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null)
    {
