...
class PublicApiV1CompaniesActivateBatchRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\ActivateCompaniesBatchV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\ActivateCompaniesBatchV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\ActivateCompaniesBatchV1Request $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
