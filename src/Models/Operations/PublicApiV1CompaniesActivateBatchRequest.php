...
class PublicApiV1CompaniesActivateBatchRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\ActivateCompaniesBatchV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
