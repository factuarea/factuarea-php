...
class PublicApiV1QuotesCreateRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\CreateQuoteRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\CreateQuoteRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\CreateQuoteRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
