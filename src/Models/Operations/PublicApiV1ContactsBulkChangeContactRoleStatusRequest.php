...
class PublicApiV1ContactsBulkChangeContactRoleStatusRequest
{
    /**
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\BulkChangeContactRoleStatusV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\BulkChangeContactRoleStatusV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\BulkChangeContactRoleStatusV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
