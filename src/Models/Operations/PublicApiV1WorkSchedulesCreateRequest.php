...
class PublicApiV1WorkSchedulesCreateRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\CreateWeeklyScheduleRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\CreateWeeklyScheduleRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\CreateWeeklyScheduleRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
