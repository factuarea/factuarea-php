...
class PublicApiV1SalesOrdersBulkStatusRequest
{
    /**
     *
     * @var string $company
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\BulkStatusSalesOrdersRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\BulkStatusSalesOrdersRequest $body;
     ...
     * @param  \Factuarea\Sdk\Models\Components\BulkStatusSalesOrdersRequest  $body
     * @param  ?LocalDate  $factuareaVersion
     * @param  ?string  $xActiveProfile
     * @phpstan-pure
     */
    public function __construct(string $company, string $idempotencyKey, Components\BulkStatusSalesOrdersRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
