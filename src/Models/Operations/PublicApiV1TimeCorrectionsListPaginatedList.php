...
class PublicApiV1TimeCorrectionsListPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\TimeCorrection>  $data
     * @param  bool  $hasMore
