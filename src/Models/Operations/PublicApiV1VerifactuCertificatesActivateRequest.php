...
class PublicApiV1VerifactuCertificatesActivateRequest
{
    /**
     *
     ...
     * @phpstan-pure
     */
    public function __construct(string $certificate, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
