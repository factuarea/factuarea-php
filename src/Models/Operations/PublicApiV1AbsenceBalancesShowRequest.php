...
class PublicApiV1AbsenceBalancesShowRequest
{
    /**
     *
     * @var string $absenceBalance
     */
    #[SpeakeasyMetadata('pathParam:style=simple,explode=false,name=absence_balance')]
    public string $absenceBalance;
     ...
     * @phpstan-pure
     */
    public function __construct(string $absenceBalance, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
