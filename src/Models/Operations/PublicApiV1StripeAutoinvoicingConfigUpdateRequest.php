...
class PublicApiV1StripeAutoinvoicingConfigUpdateRequest
{
    /**
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\UpdateStripeAutoinvoicingConfigRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\UpdateStripeAutoinvoicingConfigRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\UpdateStripeAutoinvoicingConfigRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
