...
class PublicApiV1PurchaseInvoicesCreateRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\CreatePurchaseInvoiceRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\CreatePurchaseInvoiceRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\CreatePurchaseInvoiceRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
