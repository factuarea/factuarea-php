...
class PublicApiV1InvoicesCreateRecurringRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $invoice, Components\CreateRecurringFromInvoiceRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
