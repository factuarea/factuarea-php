...
class PublicApiV1ContactsVerifyCensusRequest
{
    /**
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\VerifyBusinessContactCensusV1Request $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\VerifyBusinessContactCensusV1Request $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $idempotencyKey, Components\VerifyBusinessContactCensusV1Request $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
