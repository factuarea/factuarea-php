...
class PublicApiV1StorefrontAvailabilityBulkResolveRequest
{
    /**
     *
     * @var string $company
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\BulkResolveStorefrontAvailabilityRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\BulkResolveStorefrontAvailabilityRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, Components\BulkResolveStorefrontAvailabilityRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
