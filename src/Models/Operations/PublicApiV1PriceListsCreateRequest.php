...
class PublicApiV1PriceListsCreateRequest
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\CreatePriceListRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\CreatePriceListRequest $body;
     ...
     * @phpstan-pure
     */
    public function __construct(Components\CreatePriceListRequest $body, ?string $idempotencyKey = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
        $this->body = $body;
