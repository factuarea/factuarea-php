...
class PublicApiV1PurchaseOrdersBulkStatusRequest
{
    /**
     *
     * @var string $company
    ...
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\BulkStatusPurchaseOrdersRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public Components\BulkStatusPurchaseOrdersRequest $body;
     ...
     * @param  \Factuarea\Sdk\Models\Components\BulkStatusPurchaseOrdersRequest  $body
     * @param  ?LocalDate  $factuareaVersion
     * @param  ?string  $xActiveProfile
     * @phpstan-pure
     */
    public function __construct(string $company, string $idempotencyKey, Components\BulkStatusPurchaseOrdersRequest $body, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
