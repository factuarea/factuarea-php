...
class PublicApiV1WebhookEndpointsTestEventRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $company, string $webhookEndpoint, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?Components\SendTestEventRequest $body = null)
    {
