...
class PublicApiV1WebhookEndpointsTestEventRequest
{
    /**
     *
    ...
    /**
     *
     * @var ?\Factuarea\Sdk\Models\Components\SendTestEventRequest $body
     */
    #[SpeakeasyMetadata('request:mediaType=application/json')]
    public ?Components\SendTestEventRequest $body = null;
     ...
     * @phpstan-pure
     */
    public function __construct(string $webhookEndpoint, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?Components\SendTestEventRequest $body = null)
    {
