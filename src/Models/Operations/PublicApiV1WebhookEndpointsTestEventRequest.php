...
class PublicApiV1WebhookEndpointsTestEventRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $webhookEndpoint, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?Components\SendTestEventRequest $body = null)
    {
