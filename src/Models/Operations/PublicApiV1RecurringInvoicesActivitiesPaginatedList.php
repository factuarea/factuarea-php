...
class PublicApiV1RecurringInvoicesActivitiesPaginatedList
{
    ...
    /**
     * @param  array<\Factuarea\Sdk\Models\Components\RecurringInvoiceActivity>  $data
     * @param  bool  $hasMore
