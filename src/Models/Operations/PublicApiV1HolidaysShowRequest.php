...
class PublicApiV1HolidaysShowRequest
{
    /**
     *
     * @var string $holiday
     */
    #[SpeakeasyMetadata('pathParam:style=simple,explode=false,name=holiday')]
     ...
     * @phpstan-pure
     */
    public function __construct(string $holiday, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
