...
class PublicApiV1DeliveryNotesUpdateRequest
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $deliveryNote, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?Components\UpdateDeliveryNoteRequest $body = null)
    {
