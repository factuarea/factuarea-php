...
class PublicApiV1ProformasDeleteRequest
{
    /**
     *
     * @var string $proforma
     ...
     * @phpstan-pure
     */
    public function __construct(string $proforma, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null)
    {
