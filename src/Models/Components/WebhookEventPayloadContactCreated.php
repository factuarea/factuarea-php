...
/** WebhookEventPayloadContactCreated - Webhook delivery body for the `contact.created` event. */
class WebhookEventPayloadContactCreated
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataContactCreated $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataContactCreated')]
    public EventDataContactCreated $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataContactCreated  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataContactCreated $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'contact.created')
    {
        $this->id = $id;
