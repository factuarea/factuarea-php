...
/** WebhookEventPayloadSalesOrderConfirmed - Webhook delivery body for the `sales_order.confirmed` event. */
class WebhookEventPayloadSalesOrderConfirmed
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `sales_order.confirmed` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataSalesOrderConfirmed $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataSalesOrderConfirmed')]
    public EventDataSalesOrderConfirmed $data;
    ...
    /**
     * Event type. Always `sales_order.confirmed`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataSalesOrderConfirmed  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataSalesOrderConfirmed $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'sales_order.confirmed')
    {
        $this->id = $id;
