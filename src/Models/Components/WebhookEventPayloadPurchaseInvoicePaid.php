...
/** WebhookEventPayloadPurchaseInvoicePaid - Webhook delivery body for the `purchase_invoice.paid` event. */
class WebhookEventPayloadPurchaseInvoicePaid
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataPurchaseInvoicePaid $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataPurchaseInvoicePaid')]
    public EventDataPurchaseInvoicePaid $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataPurchaseInvoicePaid  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataPurchaseInvoicePaid $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'purchase_invoice.paid')
    {
        $this->id = $id;
