...
/** WebhookEventPayloadEmployeeDeactivated - Webhook delivery body for the `employee.deactivated` event. */
class WebhookEventPayloadEmployeeDeactivated
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataEmployeeDeactivated $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataEmployeeDeactivated')]
    public EventDataEmployeeDeactivated $data;
    ...
    /**
     * Event type. Always `employee.deactivated`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataEmployeeDeactivated  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataEmployeeDeactivated $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'employee.deactivated')
    {
        $this->id = $id;
