...
/** WebhookEventPayloadContactRestored - Webhook delivery body for the `contact.restored` event. */
class WebhookEventPayloadContactRestored
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataContactRestored $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataContactRestored')]
    public EventDataContactRestored $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataContactRestored  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataContactRestored $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'contact.restored')
    {
        $this->id = $id;
