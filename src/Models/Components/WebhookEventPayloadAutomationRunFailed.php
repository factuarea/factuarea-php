...
/** WebhookEventPayloadAutomationRunFailed - Webhook delivery body for the `automation_run.failed` event. */
class WebhookEventPayloadAutomationRunFailed
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataAutomationRunFailed $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataAutomationRunFailed')]
    public EventDataAutomationRunFailed $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataAutomationRunFailed  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataAutomationRunFailed $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'automation_run.failed')
    {
        $this->id = $id;
