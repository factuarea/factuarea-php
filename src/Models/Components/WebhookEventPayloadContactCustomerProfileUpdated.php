...
/** WebhookEventPayloadContactCustomerProfileUpdated - Webhook delivery body for the `contact.customer_profile.updated` event. */
class WebhookEventPayloadContactCustomerProfileUpdated
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataContactCustomerProfileUpdated $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataContactCustomerProfileUpdated')]
    public EventDataContactCustomerProfileUpdated $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataContactCustomerProfileUpdated  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataContactCustomerProfileUpdated $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'contact.customer_profile.updated')
    {
        $this->id = $id;
