...
/** WebhookEventPayloadTimeEntryRecorded - Webhook delivery body for the `time_entry.recorded` event. */
class WebhookEventPayloadTimeEntryRecorded
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `time_entry.recorded` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataTimeEntryRecorded $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataTimeEntryRecorded')]
    public EventDataTimeEntryRecorded $data;
    ...
    /**
     * Event type. Always `time_entry.recorded`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataTimeEntryRecorded  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataTimeEntryRecorded $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'time_entry.recorded')
    {
        $this->id = $id;
