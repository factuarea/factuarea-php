...
/** WebhookEventPayloadSeriesYearReset - Webhook delivery body for the `series.year_reset` event. */
class WebhookEventPayloadSeriesYearReset
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataSeriesYearReset $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataSeriesYearReset')]
    public EventDataSeriesYearReset $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataSeriesYearReset  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataSeriesYearReset $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'series.year_reset')
    {
        $this->id = $id;
