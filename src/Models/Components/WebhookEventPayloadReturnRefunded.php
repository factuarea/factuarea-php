...
/** WebhookEventPayloadReturnRefunded - Webhook delivery body for the `return.refunded` event. */
class WebhookEventPayloadReturnRefunded
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `return.refunded` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataReturnRefunded $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataReturnRefunded')]
    public EventDataReturnRefunded $data;
    ...
    /**
     * Event type. Always `return.refunded`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataReturnRefunded  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataReturnRefunded $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'return.refunded')
    {
        $this->id = $id;
