...
/** WebhookEventPayloadPurchaseOrderBilled - Webhook delivery body for the `purchase_order.billed` event. */
class WebhookEventPayloadPurchaseOrderBilled
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `purchase_order.billed` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataPurchaseOrderBilled $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataPurchaseOrderBilled')]
    public EventDataPurchaseOrderBilled $data;
    ...
    /**
     * Event type. Always `purchase_order.billed`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataPurchaseOrderBilled  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataPurchaseOrderBilled $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'purchase_order.billed')
    {
        $this->id = $id;
