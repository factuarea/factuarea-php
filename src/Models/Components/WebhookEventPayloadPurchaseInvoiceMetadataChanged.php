...
class WebhookEventPayloadPurchaseInvoiceMetadataChanged
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataPurchaseInvoiceMetadataChanged $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'purchase_invoice.metadata_changed')
    {
        $this->id = $id;
