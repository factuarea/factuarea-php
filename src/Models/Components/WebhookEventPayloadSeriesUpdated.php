...
/** WebhookEventPayloadSeriesUpdated - Webhook delivery body for the `series.updated` event. */
class WebhookEventPayloadSeriesUpdated
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataSeriesUpdated $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataSeriesUpdated')]
    public EventDataSeriesUpdated $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataSeriesUpdated  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataSeriesUpdated $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'series.updated')
    {
        $this->id = $id;
