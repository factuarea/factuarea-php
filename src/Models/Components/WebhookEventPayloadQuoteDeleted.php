...
class WebhookEventPayloadQuoteDeleted
{
    ...
    /**
     * Payload (`data`) emitted with the `quote.deleted` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataQuoteDeleted $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'quote.deleted')
    {
        $this->id = $id;
