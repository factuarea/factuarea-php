...
/** WebhookEventPayloadContactRoleDeactivated - Webhook delivery body for the `contact.role.deactivated` event. */
class WebhookEventPayloadContactRoleDeactivated
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataContactRoleDeactivated $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataContactRoleDeactivated')]
    public EventDataContactRoleDeactivated $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataContactRoleDeactivated  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataContactRoleDeactivated $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'contact.role.deactivated')
    {
        $this->id = $id;
