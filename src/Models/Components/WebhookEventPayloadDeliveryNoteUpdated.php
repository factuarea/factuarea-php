...
/** WebhookEventPayloadDeliveryNoteUpdated - Webhook delivery body for the `delivery_note.updated` event. */
class WebhookEventPayloadDeliveryNoteUpdated
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataDeliveryNoteUpdated $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataDeliveryNoteUpdated')]
    public EventDataDeliveryNoteUpdated $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataDeliveryNoteUpdated  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataDeliveryNoteUpdated $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'delivery_note.updated')
    {
        $this->id = $id;
