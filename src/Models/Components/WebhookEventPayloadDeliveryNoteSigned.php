...
/** WebhookEventPayloadDeliveryNoteSigned - Webhook delivery body for the `delivery_note.signed` event. */
class WebhookEventPayloadDeliveryNoteSigned
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataDeliveryNoteSigned $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataDeliveryNoteSigned')]
    public EventDataDeliveryNoteSigned $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataDeliveryNoteSigned  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataDeliveryNoteSigned $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'delivery_note.signed')
    {
        $this->id = $id;
