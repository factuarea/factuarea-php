...
/** WebhookEventPayloadSeriesMarkedAsDefault - Webhook delivery body for the `series.marked_as_default` event. */
class WebhookEventPayloadSeriesMarkedAsDefault
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataSeriesMarkedAsDefault $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataSeriesMarkedAsDefault')]
    public EventDataSeriesMarkedAsDefault $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataSeriesMarkedAsDefault  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataSeriesMarkedAsDefault $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'series.marked_as_default')
    {
        $this->id = $id;
