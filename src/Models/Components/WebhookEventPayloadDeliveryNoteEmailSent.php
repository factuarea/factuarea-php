...
/** WebhookEventPayloadDeliveryNoteEmailSent - Webhook delivery body for the `delivery_note.email_sent` event. */
class WebhookEventPayloadDeliveryNoteEmailSent
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataDeliveryNoteEmailSent $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataDeliveryNoteEmailSent')]
    public EventDataDeliveryNoteEmailSent $data;
    ...
    /**
     * Event type. Always `delivery_note.email_sent`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataDeliveryNoteEmailSent  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataDeliveryNoteEmailSent $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'delivery_note.email_sent')
    {
        $this->id = $id;
