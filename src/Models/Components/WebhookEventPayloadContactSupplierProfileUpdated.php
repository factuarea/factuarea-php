...
/** WebhookEventPayloadContactSupplierProfileUpdated - Webhook delivery body for the `contact.supplier_profile.updated` event. */
class WebhookEventPayloadContactSupplierProfileUpdated
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataContactSupplierProfileUpdated $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataContactSupplierProfileUpdated')]
    public EventDataContactSupplierProfileUpdated $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataContactSupplierProfileUpdated  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataContactSupplierProfileUpdated $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'contact.supplier_profile.updated')
    {
        $this->id = $id;
