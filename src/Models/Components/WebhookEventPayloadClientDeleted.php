...
class WebhookEventPayloadClientDeleted
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataClientDeleted $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'client.deleted')
    {
        $this->id = $id;
