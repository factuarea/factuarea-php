...
/** WebhookEventPayloadPurchaseOrderReceived - Webhook delivery body for the `purchase_order.received` event. */
class WebhookEventPayloadPurchaseOrderReceived
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `purchase_order.received` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataPurchaseOrderReceived $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataPurchaseOrderReceived')]
    public EventDataPurchaseOrderReceived $data;
    ...
    /**
     * Event type. Always `purchase_order.received`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataPurchaseOrderReceived  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataPurchaseOrderReceived $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'purchase_order.received')
    {
        $this->id = $id;
