...
/** WebhookEventPayloadProformaDeleted - Webhook delivery body for the `proforma.deleted` event. */
class WebhookEventPayloadProformaDeleted
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `proforma.deleted` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataProformaDeleted $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataProformaDeleted')]
    public EventDataProformaDeleted $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataProformaDeleted  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataProformaDeleted $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'proforma.deleted')
    {
        $this->id = $id;
