...
/** WebhookEventPayloadProformaAccepted - Webhook delivery body for the `proforma.accepted` event. */
class WebhookEventPayloadProformaAccepted
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataProformaAccepted $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataProformaAccepted')]
    public EventDataProformaAccepted $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataProformaAccepted  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataProformaAccepted $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'proforma.accepted')
    {
        $this->id = $id;
