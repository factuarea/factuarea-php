...
/** WebhookEventPayloadQuoteConverted - Webhook delivery body for the `quote.converted` event. */
class WebhookEventPayloadQuoteConverted
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `quote.converted` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataQuoteConverted $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataQuoteConverted')]
    public EventDataQuoteConverted $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataQuoteConverted  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataQuoteConverted $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'quote.converted')
    {
        $this->id = $id;
