...
/** WebhookEventPayloadSalesOrderCreated - Webhook delivery body for the `sales_order.created` event. */
class WebhookEventPayloadSalesOrderCreated
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `sales_order.created` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataSalesOrderCreated $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataSalesOrderCreated')]
    public EventDataSalesOrderCreated $data;
    ...
    /**
     * Event type. Always `sales_order.created`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataSalesOrderCreated  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataSalesOrderCreated $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'sales_order.created')
    {
        $this->id = $id;
