...
/** WebhookEventPayloadOrderReceived - Webhook delivery body for the `order.received` event. */
class WebhookEventPayloadOrderReceived
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `order.received` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataOrderReceived $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataOrderReceived')]
    public EventDataOrderReceived $data;
    ...
    /**
     * Event type. Always `order.received`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataOrderReceived  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataOrderReceived $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'order.received')
    {
        $this->id = $id;
