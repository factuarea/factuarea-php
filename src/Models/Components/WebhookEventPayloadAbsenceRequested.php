...
/** WebhookEventPayloadAbsenceRequested - Webhook delivery body for the `absence.requested` event. */
class WebhookEventPayloadAbsenceRequested
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataAbsenceRequested $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataAbsenceRequested')]
    public EventDataAbsenceRequested $data;
    ...
    /**
     * Event type. Always `absence.requested`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataAbsenceRequested  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataAbsenceRequested $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'absence.requested')
    {
        $this->id = $id;
