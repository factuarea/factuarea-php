...
class WebhookEventPayloadSeriesDemotedFromDefault
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataSeriesDemotedFromDefault $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'series.demoted_from_default')
    {
        $this->id = $id;
