...
/** WebhookEventPayloadInvoicePaid - Webhook delivery body for the `invoice.paid` event. */
class WebhookEventPayloadInvoicePaid
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `invoice.paid` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataInvoicePaid $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataInvoicePaid')]
    public EventDataInvoicePaid $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataInvoicePaid  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataInvoicePaid $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'invoice.paid')
    {
        $this->id = $id;
