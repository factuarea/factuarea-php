...
/** WebhookEventPayloadContactDeleted - Webhook delivery body for the `contact.deleted` event. */
class WebhookEventPayloadContactDeleted
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataContactDeleted $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataContactDeleted')]
    public EventDataContactDeleted $data;
    ...
    /**
     * Event type. Always `contact.deleted`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataContactDeleted  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataContactDeleted $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'contact.deleted')
    {
        $this->id = $id;
