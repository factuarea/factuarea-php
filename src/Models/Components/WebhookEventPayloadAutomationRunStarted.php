...
/** WebhookEventPayloadAutomationRunStarted - Webhook delivery body for the `automation_run.started` event. */
class WebhookEventPayloadAutomationRunStarted
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataAutomationRunStarted $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataAutomationRunStarted')]
    public EventDataAutomationRunStarted $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataAutomationRunStarted  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataAutomationRunStarted $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'automation_run.started')
    {
        $this->id = $id;
