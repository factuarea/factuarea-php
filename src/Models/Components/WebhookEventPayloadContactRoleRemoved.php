...
/** WebhookEventPayloadContactRoleRemoved - Webhook delivery body for the `contact.role.removed` event. */
class WebhookEventPayloadContactRoleRemoved
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataContactRoleRemoved $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataContactRoleRemoved')]
    public EventDataContactRoleRemoved $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataContactRoleRemoved  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataContactRoleRemoved $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'contact.role.removed')
    {
        $this->id = $id;
