...
/** WebhookEventPayloadSeriesCreated - Webhook delivery body for the `series.created` event. */
class WebhookEventPayloadSeriesCreated
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataSeriesCreated $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataSeriesCreated')]
    public EventDataSeriesCreated $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataSeriesCreated  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataSeriesCreated $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'series.created')
    {
        $this->id = $id;
