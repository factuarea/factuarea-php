...
/** WebhookEventPayloadReturnApproved - Webhook delivery body for the `return.approved` event. */
class WebhookEventPayloadReturnApproved
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `return.approved` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataReturnApproved $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataReturnApproved')]
    public EventDataReturnApproved $data;
    ...
    /**
     * Event type. Always `return.approved`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataReturnApproved  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataReturnApproved $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'return.approved')
    {
        $this->id = $id;
