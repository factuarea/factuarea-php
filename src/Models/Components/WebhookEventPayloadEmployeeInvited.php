...
/** WebhookEventPayloadEmployeeInvited - Webhook delivery body for the `employee.invited` event. */
class WebhookEventPayloadEmployeeInvited
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `employee.invited` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataEmployeeInvited $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataEmployeeInvited')]
    public EventDataEmployeeInvited $data;
    ...
    /**
     * Event type. Always `employee.invited`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataEmployeeInvited  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataEmployeeInvited $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'employee.invited')
    {
        $this->id = $id;
