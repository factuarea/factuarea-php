...
/** WebhookEventPayloadAutomationRuleAutoPaused - Webhook delivery body for the `automation_rule.auto_paused` event. */
class WebhookEventPayloadAutomationRuleAutoPaused
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataAutomationRuleAutoPaused $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataAutomationRuleAutoPaused')]
    public EventDataAutomationRuleAutoPaused $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataAutomationRuleAutoPaused  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataAutomationRuleAutoPaused $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'automation_rule.auto_paused')
    {
        $this->id = $id;
