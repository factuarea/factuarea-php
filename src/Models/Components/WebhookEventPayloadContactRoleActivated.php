...
/** WebhookEventPayloadContactRoleActivated - Webhook delivery body for the `contact.role.activated` event. */
class WebhookEventPayloadContactRoleActivated
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataContactRoleActivated $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataContactRoleActivated')]
    public EventDataContactRoleActivated $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataContactRoleActivated  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataContactRoleActivated $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'contact.role.activated')
    {
        $this->id = $id;
