...
/** WebhookEventPayloadContactUpdated - Webhook delivery body for the `contact.updated` event. */
class WebhookEventPayloadContactUpdated
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataContactUpdated $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataContactUpdated')]
    public EventDataContactUpdated $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataContactUpdated  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataContactUpdated $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'contact.updated')
    {
        $this->id = $id;
