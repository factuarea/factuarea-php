...
/** WebhookEventPayloadProformaMetadataChanged - Webhook delivery body for the `proforma.metadata_changed` event. */
class WebhookEventPayloadProformaMetadataChanged
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataProformaMetadataChanged $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataProformaMetadataChanged')]
    public EventDataProformaMetadataChanged $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataProformaMetadataChanged  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataProformaMetadataChanged $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'proforma.metadata_changed')
    {
        $this->id = $id;
