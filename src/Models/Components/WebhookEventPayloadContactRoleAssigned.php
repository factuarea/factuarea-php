...
/** WebhookEventPayloadContactRoleAssigned - Webhook delivery body for the `contact.role.assigned` event. */
class WebhookEventPayloadContactRoleAssigned
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataContactRoleAssigned $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataContactRoleAssigned')]
    public EventDataContactRoleAssigned $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataContactRoleAssigned  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataContactRoleAssigned $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'contact.role.assigned')
    {
        $this->id = $id;
