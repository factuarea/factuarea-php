...
/** WebhookEventPayloadAutomationRulePaused - Webhook delivery body for the `automation_rule.paused` event. */
class WebhookEventPayloadAutomationRulePaused
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataAutomationRulePaused $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataAutomationRulePaused')]
    public EventDataAutomationRulePaused $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataAutomationRulePaused  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataAutomationRulePaused $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'automation_rule.paused')
    {
        $this->id = $id;
