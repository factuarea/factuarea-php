...
/**
 * CreateReturnRequest - Request the return of one or more lines of a delivery note, an invoice or a
 *
 * sales order.
 *
...
class CreateReturnRequest
{
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\CreateReturnRequestOriginType $originType
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('origin_type')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\CreateReturnRequestOriginType')]
    public CreateReturnRequestOriginType $originType;

    /**
     * Public ID of the origin document of that kind, of the company in the path. A document of another company is rejected exactly like one that does not exist.
     *
     * @var string $originId
     */
    ...
    /**
     * Lines that come back: at least one. Each entry names the origin line, how much of it comes back and why. Neither the unit price nor the tax rate travels here: both are inherited from the origin document, so a return can never restate the amount of what it gives back.
     *
     * @var array<\Factuarea\Sdk\Models\Components\CreateReturnRequestLine> $lines
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('lines')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\Factuarea\Sdk\Models\Components\CreateReturnRequestLine>')]
    public array $lines;

    /**
     * Header reason of the return; left out, it is derived from the lines
     *
     * @var ?\Factuarea\Sdk\Models\Components\CreateReturnRequestReason $reason
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('reason')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\CreateReturnRequestReason|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?CreateReturnRequestReason $reason = null;

    /**
     * Public ID of the warehouse that takes the goods back in: an ACTIVE warehouse of the company in the path. Omitting it leaves the destination to be decided when the goods are received. An archived one is rejected, because goods cannot come back into a site that is out of service.
     *
    ...
    /**
     * Free text of the return, up to 1000 characters.
     *
     * @var ?string $notes
     */
    ...
    /**
     * @param  \Factuarea\Sdk\Models\Components\CreateReturnRequestOriginType  $originType
     * @param  string  $originId
     * @param  array<\Factuarea\Sdk\Models\Components\CreateReturnRequestLine>  $lines
     * @param  ?\Factuarea\Sdk\Models\Components\CreateReturnRequestReason  $reason
     * @param  ?string  $warehouseId
     * @param  ?string  $notes
     * @phpstan-pure
     */
    public function __construct(CreateReturnRequestOriginType $originType, string $originId, array $lines, ?CreateReturnRequestReason $reason = null, ?string $warehouseId = null, ?string $notes = null)
    {
