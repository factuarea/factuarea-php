...
/** WebhookEventPayloadAbsenceRejected - Webhook delivery body for the `absence.rejected` event. */
class WebhookEventPayloadAbsenceRejected
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `absence.rejected` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataAbsenceRejected $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataAbsenceRejected')]
    public EventDataAbsenceRejected $data;
    ...
    /**
     * Event type. Always `absence.rejected`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataAbsenceRejected  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataAbsenceRejected $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'absence.rejected')
    {
        $this->id = $id;
