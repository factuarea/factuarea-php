...
/** WebhookEventPayloadReturnRequested - Webhook delivery body for the `return.requested` event. */
class WebhookEventPayloadReturnRequested
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `return.requested` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataReturnRequested $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataReturnRequested')]
    public EventDataReturnRequested $data;
    ...
    /**
     * Event type. Always `return.requested`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataReturnRequested  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataReturnRequested $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'return.requested')
    {
        $this->id = $id;
