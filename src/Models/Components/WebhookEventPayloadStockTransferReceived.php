...
/** WebhookEventPayloadStockTransferReceived - Webhook delivery body for the `stock_transfer.received` event. */
class WebhookEventPayloadStockTransferReceived
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `stock_transfer.received` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataStockTransferReceived $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataStockTransferReceived')]
    public EventDataStockTransferReceived $data;
    ...
    /**
     * Event type. Always `stock_transfer.received`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataStockTransferReceived  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataStockTransferReceived $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'stock_transfer.received')
    {
        $this->id = $id;
