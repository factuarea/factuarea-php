...
/** WebhookEventPayloadOrderInvoiced - Webhook delivery body for the `order.invoiced` event. */
class WebhookEventPayloadOrderInvoiced
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataOrderInvoiced $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataOrderInvoiced')]
    public EventDataOrderInvoiced $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataOrderInvoiced  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataOrderInvoiced $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'order.invoiced')
    {
        $this->id = $id;
