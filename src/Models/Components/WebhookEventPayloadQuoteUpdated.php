...
/** WebhookEventPayloadQuoteUpdated - Webhook delivery body for the `quote.updated` event. */
class WebhookEventPayloadQuoteUpdated
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataQuoteUpdated $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataQuoteUpdated')]
    public EventDataQuoteUpdated $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataQuoteUpdated  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataQuoteUpdated $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'quote.updated')
    {
        $this->id = $id;
