...
/** WebhookEventPayloadProformaEmailFailed - Webhook delivery body for the `proforma.email_failed` event. */
class WebhookEventPayloadProformaEmailFailed
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataProformaEmailFailed $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataProformaEmailFailed')]
    public EventDataProformaEmailFailed $data;
    ...
    /**
     * Event type. Always `proforma.email_failed`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataProformaEmailFailed  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataProformaEmailFailed $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'proforma.email_failed')
    {
        $this->id = $id;
