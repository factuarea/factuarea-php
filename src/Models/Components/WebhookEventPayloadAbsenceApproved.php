...
/** WebhookEventPayloadAbsenceApproved - Webhook delivery body for the `absence.approved` event. */
class WebhookEventPayloadAbsenceApproved
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `absence.approved` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataAbsenceApproved $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataAbsenceApproved')]
    public EventDataAbsenceApproved $data;
    ...
    /**
     * Event type. Always `absence.approved`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataAbsenceApproved  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataAbsenceApproved $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'absence.approved')
    {
        $this->id = $id;
