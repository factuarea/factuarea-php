...
/** WebhookEventPayloadInvoiceAutoCreated - Webhook delivery body for the `invoice.auto_created` event. */
class WebhookEventPayloadInvoiceAutoCreated
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `invoice.auto_created` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataInvoiceAutoCreated $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataInvoiceAutoCreated')]
    public EventDataInvoiceAutoCreated $data;
    ...
    /**
     * Event type. Always `invoice.auto_created`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataInvoiceAutoCreated  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataInvoiceAutoCreated $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'invoice.auto_created')
    {
        $this->id = $id;
