...
/** WebhookEventPayloadFulfilmentDelivered - Webhook delivery body for the `fulfilment.delivered` event. */
class WebhookEventPayloadFulfilmentDelivered
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `fulfilment.delivered` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataFulfilmentDelivered $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataFulfilmentDelivered')]
    public EventDataFulfilmentDelivered $data;
    ...
    /**
     * Event type. Always `fulfilment.delivered`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataFulfilmentDelivered  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataFulfilmentDelivered $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'fulfilment.delivered')
    {
        $this->id = $id;
