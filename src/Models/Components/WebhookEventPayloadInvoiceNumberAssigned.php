...
/** WebhookEventPayloadInvoiceNumberAssigned - Webhook delivery body for the `invoice.number_assigned` event. */
class WebhookEventPayloadInvoiceNumberAssigned
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `invoice.number_assigned` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataInvoiceNumberAssigned $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataInvoiceNumberAssigned')]
    public EventDataInvoiceNumberAssigned $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataInvoiceNumberAssigned  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataInvoiceNumberAssigned $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'invoice.number_assigned')
    {
        $this->id = $id;
