...
/** WebhookEventPayloadDeliveryNoteCreated - Webhook delivery body for the `delivery_note.created` event. */
class WebhookEventPayloadDeliveryNoteCreated
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataDeliveryNoteCreated $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataDeliveryNoteCreated')]
    public EventDataDeliveryNoteCreated $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataDeliveryNoteCreated  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataDeliveryNoteCreated $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'delivery_note.created')
    {
        $this->id = $id;
