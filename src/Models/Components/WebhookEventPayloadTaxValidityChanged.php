...
/** WebhookEventPayloadTaxValidityChanged - Webhook delivery body for the `tax.validity_changed` event. */
class WebhookEventPayloadTaxValidityChanged
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataTaxValidityChanged $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataTaxValidityChanged')]
    public EventDataTaxValidityChanged $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataTaxValidityChanged  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataTaxValidityChanged $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'tax.validity_changed')
    {
        $this->id = $id;
