...
class AutomationRunStep
{
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\AutomationRunObjectAutomationStepRun $object
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('object')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\AutomationRunObjectAutomationStepRun')]
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\AutomationRunActionType $actionType
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('action_type')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\AutomationRunActionType')]
    public AutomationRunActionType $actionType;
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\AutomationRunStatusAutomationStepRun $status
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('status')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\AutomationRunStatusAutomationStepRun')]
    public AutomationRunStatusAutomationStepRun $status;
    ...
    /**
     * @param  string  $id
     * @param  \Factuarea\Sdk\Models\Components\AutomationRunObjectAutomationStepRun  $object
     * @param  int  $stepIndex
     * @param  \Factuarea\Sdk\Models\Components\AutomationRunActionType  $actionType
     * @param  \Factuarea\Sdk\Models\Components\AutomationRunStatusAutomationStepRun  $status
     * @param  int  $attempts
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, AutomationRunObjectAutomationStepRun $object, int $stepIndex, AutomationRunActionType $actionType, AutomationRunStatusAutomationStepRun $status, int $attempts, array $parameters, array $result, bool $replayable, ?string $discardReason = null, ?string $discardReasonLabel = null, ?string $lastError = null, ?\DateTime $nextRetryAt = null, ?\DateTime $claimedAt = null, ?\DateTime $finishedAt = null)
    {
        $this->id = $id;
        $this->object = $object;
