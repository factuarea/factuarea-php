...
/** WebhookEventPayloadInvoiceOverdue - Webhook delivery body for the `invoice.overdue` event. */
class WebhookEventPayloadInvoiceOverdue
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `invoice.overdue` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataInvoiceOverdue $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataInvoiceOverdue')]
    public EventDataInvoiceOverdue $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataInvoiceOverdue  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataInvoiceOverdue $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'invoice.overdue')
    {
        $this->id = $id;
