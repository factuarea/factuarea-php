...
/** WebhookEventPayloadTimeEntryCorrected - Webhook delivery body for the `time_entry.corrected` event. */
class WebhookEventPayloadTimeEntryCorrected
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataTimeEntryCorrected $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataTimeEntryCorrected')]
    public EventDataTimeEntryCorrected $data;
    ...
    /**
     * Event type. Always `time_entry.corrected`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataTimeEntryCorrected  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataTimeEntryCorrected $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'time_entry.corrected')
    {
        $this->id = $id;
