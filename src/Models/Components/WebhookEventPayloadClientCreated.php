...
/** WebhookEventPayloadClientCreated - Webhook delivery body for the `client.created` event. */
class WebhookEventPayloadClientCreated
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataClientCreated $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataClientCreated')]
    public EventDataClientCreated $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataClientCreated  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataClientCreated $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'client.created')
    {
        $this->id = $id;
