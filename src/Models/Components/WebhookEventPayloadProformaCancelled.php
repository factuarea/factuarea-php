...
/** WebhookEventPayloadProformaCancelled - Webhook delivery body for the `proforma.cancelled` event. */
class WebhookEventPayloadProformaCancelled
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataProformaCancelled $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataProformaCancelled')]
    public EventDataProformaCancelled $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataProformaCancelled  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataProformaCancelled $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'proforma.cancelled')
    {
        $this->id = $id;
