...
/** WebhookEventPayloadSalesOrderEmailFailed - Webhook delivery body for the `sales_order.email_failed` event. */
class WebhookEventPayloadSalesOrderEmailFailed
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `sales_order.email_failed` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataSalesOrderEmailFailed $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataSalesOrderEmailFailed')]
    public EventDataSalesOrderEmailFailed $data;
    ...
    /**
     * Event type. Always `sales_order.email_failed`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataSalesOrderEmailFailed  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataSalesOrderEmailFailed $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'sales_order.email_failed')
    {
        $this->id = $id;
