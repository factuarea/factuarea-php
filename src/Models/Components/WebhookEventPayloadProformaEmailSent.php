...
/** WebhookEventPayloadProformaEmailSent - Webhook delivery body for the `proforma.email_sent` event. */
class WebhookEventPayloadProformaEmailSent
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataProformaEmailSent $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataProformaEmailSent')]
    public EventDataProformaEmailSent $data;
    ...
    /**
     * Event type. Always `proforma.email_sent`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataProformaEmailSent  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataProformaEmailSent $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'proforma.email_sent')
    {
        $this->id = $id;
