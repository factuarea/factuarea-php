...
/** WebhookEventPayloadQuoteExpired - Webhook delivery body for the `quote.expired` event. */
class WebhookEventPayloadQuoteExpired
{
    /**
    ...
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataQuoteExpired')]
