...
class ProformaLine
{
     ...
     * @phpstan-pure
     */
    public function __construct(ProformaLineObject $object, float $quantity, float $unitPrice, float $taxRate, float $retentionRate, float $surchargeRate, float $discountPercent, float $subtotal, float $taxes, float $total, ?string $description = null, ?ProductRef $product = null, ?ProformaLineIndirectTaxRegime $indirectTaxRegime = null)
    {
        $this->object = $object;
