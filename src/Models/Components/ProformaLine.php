...
/** ProformaLine - A line item on a proforma. */
class ProformaLine
{
    /**
     *
     * @var \Factuarea\Sdk\Models\Components\ProformaLineObject $object
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('object')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\ProformaLineObject')]
    public ProformaLineObject $object;
     ...
     *
     * @var array<\Factuarea\Sdk\Models\Components\ProformaLineOption> $options
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('options')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\Factuarea\Sdk\Models\Components\ProformaLineOption>')]
    ...
    /**
     *
     * @var ?\Factuarea\Sdk\Models\Components\ProformaLineVariant $variant
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('variant')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\ProformaLineVariant|null')]
    public ?ProformaLineVariant $variant;

    /**
     *
     * @var ?\Factuarea\Sdk\Models\Components\ProformaLinePresentation $presentation
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('presentation')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\ProformaLinePresentation|null')]
    public ?ProformaLinePresentation $presentation;
     ...
     *
     * @var ?\Factuarea\Sdk\Models\Components\ProformaLineConfiguration $configuration
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('configuration')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\ProformaLineConfiguration|null')]
    public ?ProformaLineConfiguration $configuration;
     ...
     *
     * @var ?\Factuarea\Sdk\Models\Components\ProformaLinePriceSemantics $priceSemantics
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('price_semantics')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\ProformaLinePriceSemantics|null')]
    public ?ProformaLinePriceSemantics $priceSemantics;
     ...
     *
     * @var ?\Factuarea\Sdk\Models\Components\ProformaLineIndirectTaxRegime $indirectTaxRegime
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('indirect_tax_regime')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\ProformaLineIndirectTaxRegime|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?ProformaLineIndirectTaxRegime $indirectTaxRegime = null;

    /**
     * @param  \Factuarea\Sdk\Models\Components\ProformaLineObject  $object
     ...
     * @param  float  $taxes
     * @param  float  $total
     * @param  array<\Factuarea\Sdk\Models\Components\ProformaLineOption>  $options
     * @param  ?string  $description
     * @param  ?string  $additionalDescription
     * @param  ?\Factuarea\Sdk\Models\Components\ProductRef  $product
     * @param  ?\Factuarea\Sdk\Models\Components\ProformaLineVariant  $variant
     * @param  ?\Factuarea\Sdk\Models\Components\ProformaLinePresentation  $presentation
     ...
     * @param  ?\Factuarea\Sdk\Models\Components\ProformaLineConfiguration  $configuration
     * @param  ?\Factuarea\Sdk\Models\Components\ProformaLinePriceSemantics  $priceSemantics
     * @param  ?string  $priceAdjustmentTotal
     * @param  ?bool  $optionAdjustmentsAbsorbed
     * @param  ?\Factuarea\Sdk\Models\Components\ProformaLineIndirectTaxRegime  $indirectTaxRegime
     * @phpstan-pure
     */
    public function __construct(ProformaLineObject $object, float $quantity, float $unitPrice, float $taxRate, float $retentionRate, float $surchargeRate, float $discountPercent, float $subtotal, float $taxes, float $total, array $options, ?string $description = null, ?string $additionalDescription = null, ?ProductRef $product = null, ?ProformaLineVariant $variant = null, ?ProformaLinePresentation $presentation = null, ?string $itemKind = null, ?string $commercialUnitCode = null, ?string $baseUnitCode = null, ?string $conversionFactor = null, ?string $baseQuantity = null, ?string $priceListId = null, ?string $priceListName = null, ?string $priceSource = null, ?string $priceUnitCode = null, ?ProformaLineConfiguration $configuration = null, ?ProformaLinePriceSemantics $priceSemantics = null, ?string $priceAdjustmentTotal = null, ?bool $optionAdjustmentsAbsorbed = null, ?ProformaLineIndirectTaxRegime $indirectTaxRegime = null)
    {
        $this->object = $object;
