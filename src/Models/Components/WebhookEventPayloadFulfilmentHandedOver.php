...
/** WebhookEventPayloadFulfilmentHandedOver - Webhook delivery body for the `fulfilment.handed_over` event. */
class WebhookEventPayloadFulfilmentHandedOver
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `fulfilment.handed_over` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataFulfilmentHandedOver $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataFulfilmentHandedOver')]
    public EventDataFulfilmentHandedOver $data;
    ...
    /**
     * Event type. Always `fulfilment.handed_over`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataFulfilmentHandedOver  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataFulfilmentHandedOver $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'fulfilment.handed_over')
    {
        $this->id = $id;
