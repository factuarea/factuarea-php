...
/** WebhookEventPayloadFulfilmentFailed - Webhook delivery body for the `fulfilment.failed` event. */
class WebhookEventPayloadFulfilmentFailed
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `fulfilment.failed` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataFulfilmentFailed $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataFulfilmentFailed')]
    public EventDataFulfilmentFailed $data;
    ...
    /**
     * Event type. Always `fulfilment.failed`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataFulfilmentFailed  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataFulfilmentFailed $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'fulfilment.failed')
    {
        $this->id = $id;
