...
/** WebhookEventPayloadInvoiceCreated - Webhook delivery body for the `invoice.created` event. */
class WebhookEventPayloadInvoiceCreated
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `invoice.created` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataInvoiceCreated $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataInvoiceCreated')]
    public EventDataInvoiceCreated $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataInvoiceCreated  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataInvoiceCreated $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'invoice.created')
    {
        $this->id = $id;
