...
/** WebhookEventPayloadSalesOrderClosed - Webhook delivery body for the `sales_order.closed` event. */
class WebhookEventPayloadSalesOrderClosed
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `sales_order.closed` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataSalesOrderClosed $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataSalesOrderClosed')]
    public EventDataSalesOrderClosed $data;
    ...
    /**
     * Event type. Always `sales_order.closed`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataSalesOrderClosed  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataSalesOrderClosed $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'sales_order.closed')
    {
        $this->id = $id;
