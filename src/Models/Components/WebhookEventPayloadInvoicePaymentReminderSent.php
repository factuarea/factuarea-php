...
/** WebhookEventPayloadInvoicePaymentReminderSent - Webhook delivery body for the `invoice.payment_reminder_sent` event. */
class WebhookEventPayloadInvoicePaymentReminderSent
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `invoice.payment_reminder_sent` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataInvoicePaymentReminderSent $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataInvoicePaymentReminderSent')]
    public EventDataInvoicePaymentReminderSent $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataInvoicePaymentReminderSent  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataInvoicePaymentReminderSent $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'invoice.payment_reminder_sent')
    {
        $this->id = $id;
