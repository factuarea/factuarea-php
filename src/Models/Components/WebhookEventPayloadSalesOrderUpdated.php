...
/** WebhookEventPayloadSalesOrderUpdated - Webhook delivery body for the `sales_order.updated` event. */
class WebhookEventPayloadSalesOrderUpdated
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `sales_order.updated` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataSalesOrderUpdated $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataSalesOrderUpdated')]
    public EventDataSalesOrderUpdated $data;
    ...
    /**
     * Event type. Always `sales_order.updated`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataSalesOrderUpdated  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataSalesOrderUpdated $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'sales_order.updated')
    {
        $this->id = $id;
