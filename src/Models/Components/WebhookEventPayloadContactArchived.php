...
/** WebhookEventPayloadContactArchived - Webhook delivery body for the `contact.archived` event. */
class WebhookEventPayloadContactArchived
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataContactArchived $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataContactArchived')]
    public EventDataContactArchived $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataContactArchived  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataContactArchived $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'contact.archived')
    {
        $this->id = $id;
