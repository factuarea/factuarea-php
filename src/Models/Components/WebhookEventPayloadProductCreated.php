...
/** WebhookEventPayloadProductCreated - Webhook delivery body for the `product.created` event. */
class WebhookEventPayloadProductCreated
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataProductCreated $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataProductCreated')]
    public EventDataProductCreated $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataProductCreated  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataProductCreated $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'product.created')
    {
        $this->id = $id;
