...
/** WebhookEventPayloadQuoteCreated - Webhook delivery body for the `quote.created` event. */
class WebhookEventPayloadQuoteCreated
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataQuoteCreated $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataQuoteCreated')]
    public EventDataQuoteCreated $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataQuoteCreated  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataQuoteCreated $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'quote.created')
    {
        $this->id = $id;
