...
/** WebhookEventPayloadQuoteApproved - Webhook delivery body for the `quote.approved` event. */
class WebhookEventPayloadQuoteApproved
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataQuoteApproved $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataQuoteApproved')]
    public EventDataQuoteApproved $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataQuoteApproved  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataQuoteApproved $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'quote.approved')
    {
        $this->id = $id;
