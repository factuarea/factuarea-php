...
/** WebhookEventPayloadSeriesMonthReset - Webhook delivery body for the `series.month_reset` event. */
class WebhookEventPayloadSeriesMonthReset
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataSeriesMonthReset $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataSeriesMonthReset')]
    public EventDataSeriesMonthReset $data;
    ...
    /**
     * Event type. Always `series.month_reset`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataSeriesMonthReset  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataSeriesMonthReset $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'series.month_reset')
    {
        $this->id = $id;
