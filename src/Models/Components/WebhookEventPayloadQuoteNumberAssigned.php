...
/** WebhookEventPayloadQuoteNumberAssigned - Webhook delivery body for the `quote.number_assigned` event. */
class WebhookEventPayloadQuoteNumberAssigned
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataQuoteNumberAssigned $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataQuoteNumberAssigned')]
    public EventDataQuoteNumberAssigned $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataQuoteNumberAssigned  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataQuoteNumberAssigned $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'quote.number_assigned')
    {
        $this->id = $id;
