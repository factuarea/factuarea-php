...
/** WebhookEventPayloadMonthlyRegisterClosed - Webhook delivery body for the `monthly_register.closed` event. */
class WebhookEventPayloadMonthlyRegisterClosed
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataMonthlyRegisterClosed $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataMonthlyRegisterClosed')]
    public EventDataMonthlyRegisterClosed $data;
    ...
    /**
     * Event type. Always `monthly_register.closed`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataMonthlyRegisterClosed  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataMonthlyRegisterClosed $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'monthly_register.closed')
    {
        $this->id = $id;
