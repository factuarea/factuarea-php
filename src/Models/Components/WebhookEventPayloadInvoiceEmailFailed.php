...
/** WebhookEventPayloadInvoiceEmailFailed - Webhook delivery body for the `invoice.email_failed` event. */
class WebhookEventPayloadInvoiceEmailFailed
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `invoice.email_failed` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataInvoiceEmailFailed $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataInvoiceEmailFailed')]
    public EventDataInvoiceEmailFailed $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataInvoiceEmailFailed  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataInvoiceEmailFailed $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'invoice.email_failed')
    {
        $this->id = $id;
