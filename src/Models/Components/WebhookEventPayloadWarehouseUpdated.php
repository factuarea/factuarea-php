...
/** WebhookEventPayloadWarehouseUpdated - Webhook delivery body for the `warehouse.updated` event. */
class WebhookEventPayloadWarehouseUpdated
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataWarehouseUpdated $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataWarehouseUpdated')]
    public EventDataWarehouseUpdated $data;
    ...
    /**
     * Event type. Always `warehouse.updated`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataWarehouseUpdated  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataWarehouseUpdated $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'warehouse.updated')
    {
        $this->id = $id;
