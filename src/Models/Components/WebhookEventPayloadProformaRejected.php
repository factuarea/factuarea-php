...
/** WebhookEventPayloadProformaRejected - Webhook delivery body for the `proforma.rejected` event. */
class WebhookEventPayloadProformaRejected
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataProformaRejected $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataProformaRejected')]
    public EventDataProformaRejected $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataProformaRejected  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataProformaRejected $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'proforma.rejected')
    {
        $this->id = $id;
