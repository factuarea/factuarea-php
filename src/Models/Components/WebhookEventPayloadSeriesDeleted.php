...
/** WebhookEventPayloadSeriesDeleted - Webhook delivery body for the `series.deleted` event. */
class WebhookEventPayloadSeriesDeleted
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `series.deleted` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataSeriesDeleted $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataSeriesDeleted')]
    public EventDataSeriesDeleted $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataSeriesDeleted  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataSeriesDeleted $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'series.deleted')
    {
        $this->id = $id;
