...
class WebhookEventPayloadRecurringInvoiceActivated
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataRecurringInvoiceActivated $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'recurring_invoice.activated')
    {
        $this->id = $id;
