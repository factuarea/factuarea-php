...
class WebhookEventPayloadDeliveryNoteConverted
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataDeliveryNoteConverted $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'delivery_note.converted')
    {
        $this->id = $id;
