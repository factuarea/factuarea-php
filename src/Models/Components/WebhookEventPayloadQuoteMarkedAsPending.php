...
class WebhookEventPayloadQuoteMarkedAsPending
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataQuoteMarkedAsPending $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'quote.marked_as_pending')
    {
        $this->id = $id;
