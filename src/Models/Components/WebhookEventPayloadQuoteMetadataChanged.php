...
/** WebhookEventPayloadQuoteMetadataChanged - Webhook delivery body for the `quote.metadata_changed` event. */
class WebhookEventPayloadQuoteMetadataChanged
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataQuoteMetadataChanged $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataQuoteMetadataChanged')]
    public EventDataQuoteMetadataChanged $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataQuoteMetadataChanged  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataQuoteMetadataChanged $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'quote.metadata_changed')
    {
        $this->id = $id;
