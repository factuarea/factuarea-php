...
/** WebhookEventPayloadQuoteRejected - Webhook delivery body for the `quote.rejected` event. */
class WebhookEventPayloadQuoteRejected
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataQuoteRejected $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataQuoteRejected')]
    public EventDataQuoteRejected $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataQuoteRejected  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataQuoteRejected $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'quote.rejected')
    {
        $this->id = $id;
