...
class DeliveryNoteLine
{
     ...
     * @phpstan-pure
     */
    public function __construct(DeliveryNoteLineObject $object, float $quantity, float $unitPrice, float $taxRate, float $discountPercent, float $subtotal, float $taxes, float $total, ?string $description = null, ?ProductRef $product = null)
    {
        $this->object = $object;
