...
/** WebhookEventPayloadClientUpdated - Webhook delivery body for the `client.updated` event. */
class WebhookEventPayloadClientUpdated
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataClientUpdated $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataClientUpdated')]
    public EventDataClientUpdated $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataClientUpdated  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataClientUpdated $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'client.updated')
    {
        $this->id = $id;
