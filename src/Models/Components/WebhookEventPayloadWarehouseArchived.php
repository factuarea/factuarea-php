...
/** WebhookEventPayloadWarehouseArchived - Webhook delivery body for the `warehouse.archived` event. */
class WebhookEventPayloadWarehouseArchived
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `warehouse.archived` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataWarehouseArchived $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataWarehouseArchived')]
    public EventDataWarehouseArchived $data;
    ...
    /**
     * Event type. Always `warehouse.archived`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataWarehouseArchived  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataWarehouseArchived $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'warehouse.archived')
    {
        $this->id = $id;
