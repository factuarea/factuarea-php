...
class WebhookEventPayloadTaxMetadataChanged
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataTaxMetadataChanged $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'tax.metadata_changed')
    {
        $this->id = $id;
