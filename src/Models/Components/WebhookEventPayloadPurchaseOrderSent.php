...
/** WebhookEventPayloadPurchaseOrderSent - Webhook delivery body for the `purchase_order.sent` event. */
class WebhookEventPayloadPurchaseOrderSent
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `purchase_order.sent` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataPurchaseOrderSent $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataPurchaseOrderSent')]
    public EventDataPurchaseOrderSent $data;
    ...
    /**
     * Event type. Always `purchase_order.sent`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataPurchaseOrderSent  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataPurchaseOrderSent $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'purchase_order.sent')
    {
        $this->id = $id;
