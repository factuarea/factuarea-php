...
/** WebhookEventPayloadQuoteEmailFailed - Webhook delivery body for the `quote.email_failed` event. */
class WebhookEventPayloadQuoteEmailFailed
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataQuoteEmailFailed $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataQuoteEmailFailed')]
    public EventDataQuoteEmailFailed $data;
    ...
    /**
     * Event type. Always `quote.email_failed`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataQuoteEmailFailed  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataQuoteEmailFailed $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'quote.email_failed')
    {
        $this->id = $id;
