...
/** WebhookEventPayloadSalesOrderServed - Webhook delivery body for the `sales_order.served` event. */
class WebhookEventPayloadSalesOrderServed
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `sales_order.served` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataSalesOrderServed $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataSalesOrderServed')]
    public EventDataSalesOrderServed $data;
    ...
    /**
     * Event type. Always `sales_order.served`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataSalesOrderServed  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataSalesOrderServed $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'sales_order.served')
    {
        $this->id = $id;
