...
class WebhookEventPayloadInvoiceSent
{
    ...
    public EventDataInvoiceSent $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataInvoiceSent  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataInvoiceSent $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'invoice.sent')
    {
        $this->id = $id;
