...
class WebhookEventPayloadRecurringInvoiceExecuted
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataRecurringInvoiceExecuted $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'recurring_invoice.executed')
    {
        $this->id = $id;
