...
/** WebhookEventPayloadOrderRefunded - Webhook delivery body for the `order.refunded` event. */
class WebhookEventPayloadOrderRefunded
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataOrderRefunded $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataOrderRefunded')]
    public EventDataOrderRefunded $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataOrderRefunded  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataOrderRefunded $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'order.refunded')
    {
        $this->id = $id;
