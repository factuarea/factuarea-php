...
/** WebhookEventPayloadInvoiceUpdated - Webhook delivery body for the `invoice.updated` event. */
class WebhookEventPayloadInvoiceUpdated
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `invoice.updated` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataInvoiceUpdated $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataInvoiceUpdated')]
    public EventDataInvoiceUpdated $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataInvoiceUpdated  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataInvoiceUpdated $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'invoice.updated')
    {
        $this->id = $id;
