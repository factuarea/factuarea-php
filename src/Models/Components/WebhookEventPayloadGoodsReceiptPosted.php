...
/** WebhookEventPayloadGoodsReceiptPosted - Webhook delivery body for the `goods_receipt.posted` event. */
class WebhookEventPayloadGoodsReceiptPosted
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataGoodsReceiptPosted $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataGoodsReceiptPosted')]
    public EventDataGoodsReceiptPosted $data;
    ...
    /**
     * Event type. Always `goods_receipt.posted`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataGoodsReceiptPosted  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataGoodsReceiptPosted $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'goods_receipt.posted')
    {
        $this->id = $id;
