...
/** WebhookEventPayloadGoodsReceiptCreated - Webhook delivery body for the `goods_receipt.created` event. */
class WebhookEventPayloadGoodsReceiptCreated
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `goods_receipt.created` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataGoodsReceiptCreated $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataGoodsReceiptCreated')]
    public EventDataGoodsReceiptCreated $data;
    ...
    /**
     * Event type. Always `goods_receipt.created`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataGoodsReceiptCreated  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataGoodsReceiptCreated $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'goods_receipt.created')
    {
        $this->id = $id;
