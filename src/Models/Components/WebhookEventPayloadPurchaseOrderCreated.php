...
/** WebhookEventPayloadPurchaseOrderCreated - Webhook delivery body for the `purchase_order.created` event. */
class WebhookEventPayloadPurchaseOrderCreated
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `purchase_order.created` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataPurchaseOrderCreated $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataPurchaseOrderCreated')]
    public EventDataPurchaseOrderCreated $data;
    ...
    /**
     * Event type. Always `purchase_order.created`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataPurchaseOrderCreated  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataPurchaseOrderCreated $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'purchase_order.created')
    {
        $this->id = $id;
