...
/** WebhookEventPayloadEmployeeUpdated - Webhook delivery body for the `employee.updated` event. */
class WebhookEventPayloadEmployeeUpdated
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `employee.updated` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataEmployeeUpdated $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataEmployeeUpdated')]
    public EventDataEmployeeUpdated $data;
    ...
    /**
     * Event type. Always `employee.updated`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataEmployeeUpdated  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataEmployeeUpdated $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'employee.updated')
    {
        $this->id = $id;
