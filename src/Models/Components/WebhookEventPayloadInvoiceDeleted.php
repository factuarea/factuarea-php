...
/** WebhookEventPayloadInvoiceDeleted - Webhook delivery body for the `invoice.deleted` event. */
class WebhookEventPayloadInvoiceDeleted
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `invoice.deleted` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataInvoiceDeleted $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataInvoiceDeleted')]
    public EventDataInvoiceDeleted $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataInvoiceDeleted  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataInvoiceDeleted $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'invoice.deleted')
    {
        $this->id = $id;
