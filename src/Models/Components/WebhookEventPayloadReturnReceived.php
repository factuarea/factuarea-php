...
/** WebhookEventPayloadReturnReceived - Webhook delivery body for the `return.received` event. */
class WebhookEventPayloadReturnReceived
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `return.received` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataReturnReceived $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataReturnReceived')]
    public EventDataReturnReceived $data;
    ...
    /**
     * Event type. Always `return.received`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataReturnReceived  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataReturnReceived $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'return.received')
    {
        $this->id = $id;
