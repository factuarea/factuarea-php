...
/** WebhookEventPayloadAutomationRunCompleted - Webhook delivery body for the `automation_run.completed` event. */
class WebhookEventPayloadAutomationRunCompleted
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataAutomationRunCompleted $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataAutomationRunCompleted')]
    public EventDataAutomationRunCompleted $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataAutomationRunCompleted  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataAutomationRunCompleted $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'automation_run.completed')
    {
        $this->id = $id;
