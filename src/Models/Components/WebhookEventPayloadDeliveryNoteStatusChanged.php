...
class WebhookEventPayloadDeliveryNoteStatusChanged
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataDeliveryNoteStatusChanged $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'delivery_note.status_changed')
    {
        $this->id = $id;
