...
/** WebhookEventPayloadEmployeeCreated - Webhook delivery body for the `employee.created` event. */
class WebhookEventPayloadEmployeeCreated
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `employee.created` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataEmployeeCreated $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataEmployeeCreated')]
    public EventDataEmployeeCreated $data;
    ...
    /**
     * Event type. Always `employee.created`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataEmployeeCreated  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataEmployeeCreated $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'employee.created')
    {
        $this->id = $id;
