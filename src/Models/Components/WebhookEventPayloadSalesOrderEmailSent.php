...
/** WebhookEventPayloadSalesOrderEmailSent - Webhook delivery body for the `sales_order.email_sent` event. */
class WebhookEventPayloadSalesOrderEmailSent
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `sales_order.email_sent` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataSalesOrderEmailSent $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataSalesOrderEmailSent')]
    public EventDataSalesOrderEmailSent $data;
    ...
    /**
     * Event type. Always `sales_order.email_sent`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataSalesOrderEmailSent  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataSalesOrderEmailSent $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'sales_order.email_sent')
    {
        $this->id = $id;
