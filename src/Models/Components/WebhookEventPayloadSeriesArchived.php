...
/** WebhookEventPayloadSeriesArchived - Webhook delivery body for the `series.archived` event. */
class WebhookEventPayloadSeriesArchived
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataSeriesArchived $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataSeriesArchived')]
    public EventDataSeriesArchived $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataSeriesArchived  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataSeriesArchived $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'series.archived')
    {
        $this->id = $id;
