...
class WebhookEventPayloadInvoiceMetadataChanged
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataInvoiceMetadataChanged $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'invoice.metadata_changed')
    {
        $this->id = $id;
