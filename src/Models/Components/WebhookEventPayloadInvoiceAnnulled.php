...
class WebhookEventPayloadInvoiceAnnulled
{
    ...
    /**
     * Payload (`data`) emitted with the `invoice.annulled` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataInvoiceAnnulled $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'invoice.annulled')
    {
        $this->id = $id;
