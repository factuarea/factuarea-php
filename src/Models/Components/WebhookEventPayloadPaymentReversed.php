...
/** WebhookEventPayloadPaymentReversed - Webhook delivery body for the `payment.reversed` event. */
class WebhookEventPayloadPaymentReversed
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataPaymentReversed $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataPaymentReversed')]
    public EventDataPaymentReversed $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataPaymentReversed  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataPaymentReversed $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'payment.reversed')
    {
        $this->id = $id;
