...
/** WebhookEventPayloadReturnRejected - Webhook delivery body for the `return.rejected` event. */
class WebhookEventPayloadReturnRejected
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `return.rejected` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataReturnRejected $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataReturnRejected')]
    public EventDataReturnRejected $data;
    ...
    /**
     * Event type. Always `return.rejected`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataReturnRejected  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataReturnRejected $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'return.rejected')
    {
        $this->id = $id;
