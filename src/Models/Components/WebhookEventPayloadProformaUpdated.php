...
/** WebhookEventPayloadProformaUpdated - Webhook delivery body for the `proforma.updated` event. */
class WebhookEventPayloadProformaUpdated
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataProformaUpdated $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataProformaUpdated')]
    public EventDataProformaUpdated $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataProformaUpdated  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataProformaUpdated $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'proforma.updated')
    {
        $this->id = $id;
