...
/** WebhookEventPayloadSalesOrderCancelled - Webhook delivery body for the `sales_order.cancelled` event. */
class WebhookEventPayloadSalesOrderCancelled
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `sales_order.cancelled` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataSalesOrderCancelled $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataSalesOrderCancelled')]
    public EventDataSalesOrderCancelled $data;
    ...
    /**
     * Event type. Always `sales_order.cancelled`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataSalesOrderCancelled  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataSalesOrderCancelled $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'sales_order.cancelled')
    {
        $this->id = $id;
