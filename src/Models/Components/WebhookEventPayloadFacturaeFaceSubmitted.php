...
/** WebhookEventPayloadFacturaeFaceSubmitted - Webhook delivery body for the `facturae.face_submitted` event. */
class WebhookEventPayloadFacturaeFaceSubmitted
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `facturae.face_submitted` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataFacturaeFaceSubmitted $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataFacturaeFaceSubmitted')]
    public EventDataFacturaeFaceSubmitted $data;
    ...
    /**
     * Event type. Always `facturae.face_submitted`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataFacturaeFaceSubmitted  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataFacturaeFaceSubmitted $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'facturae.face_submitted')
    {
        $this->id = $id;
