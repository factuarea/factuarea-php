...
/** ClientImportPreviewRow - Validation outcome of a single data row, identified by its 1-based file `row` number (the header is row 1). */
class ClientImportPreviewRow
{
    /**
