...
class WebhookEventPayloadRecurringInvoiceMetadataChanged
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataRecurringInvoiceMetadataChanged $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'recurring_invoice.metadata_changed')
    {
        $this->id = $id;
