...
/** WebhookEventPayloadQuoteCancelled - Webhook delivery body for the `quote.cancelled` event. */
class WebhookEventPayloadQuoteCancelled
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataQuoteCancelled $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataQuoteCancelled')]
    public EventDataQuoteCancelled $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataQuoteCancelled  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataQuoteCancelled $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'quote.cancelled')
    {
        $this->id = $id;
