...
class WebhookEventPayloadInvoiceEmailSent
{
    ...
    /**
     * Payload (`data`) emitted with the `invoice.email_sent` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataInvoiceEmailSent $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'invoice.email_sent')
    {
        $this->id = $id;
