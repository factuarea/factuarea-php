...
/** WebhookEventPayloadAutomationRuleActivated - Webhook delivery body for the `automation_rule.activated` event. */
class WebhookEventPayloadAutomationRuleActivated
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataAutomationRuleActivated $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataAutomationRuleActivated')]
    public EventDataAutomationRuleActivated $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataAutomationRuleActivated  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataAutomationRuleActivated $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'automation_rule.activated')
    {
        $this->id = $id;
