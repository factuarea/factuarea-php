...
/** WebhookEventPayloadDeliveryNoteEmailFailed - Webhook delivery body for the `delivery_note.email_failed` event. */
class WebhookEventPayloadDeliveryNoteEmailFailed
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataDeliveryNoteEmailFailed $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataDeliveryNoteEmailFailed')]
    public EventDataDeliveryNoteEmailFailed $data;
    ...
    /**
     * Event type. Always `delivery_note.email_failed`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataDeliveryNoteEmailFailed  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataDeliveryNoteEmailFailed $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'delivery_note.email_failed')
    {
        $this->id = $id;
