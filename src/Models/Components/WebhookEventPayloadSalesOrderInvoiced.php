...
/** WebhookEventPayloadSalesOrderInvoiced - Webhook delivery body for the `sales_order.invoiced` event. */
class WebhookEventPayloadSalesOrderInvoiced
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataSalesOrderInvoiced $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataSalesOrderInvoiced')]
    public EventDataSalesOrderInvoiced $data;
    ...
    /**
     * Event type. Always `sales_order.invoiced`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataSalesOrderInvoiced  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataSalesOrderInvoiced $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'sales_order.invoiced')
    {
        $this->id = $id;
