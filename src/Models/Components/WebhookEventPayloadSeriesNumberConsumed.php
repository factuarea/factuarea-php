...
/** WebhookEventPayloadSeriesNumberConsumed - Webhook delivery body for the `series.number_consumed` event. */
class WebhookEventPayloadSeriesNumberConsumed
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataSeriesNumberConsumed $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataSeriesNumberConsumed')]
    public EventDataSeriesNumberConsumed $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataSeriesNumberConsumed  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataSeriesNumberConsumed $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'series.number_consumed')
    {
        $this->id = $id;
