...
/** WebhookEventPayloadWarehouseCreated - Webhook delivery body for the `warehouse.created` event. */
class WebhookEventPayloadWarehouseCreated
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `warehouse.created` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataWarehouseCreated $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataWarehouseCreated')]
    public EventDataWarehouseCreated $data;
    ...
    /**
     * Event type. Always `warehouse.created`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataWarehouseCreated  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataWarehouseCreated $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'warehouse.created')
    {
        $this->id = $id;
