...
/** WebhookEventPayloadPayoutReconciled - Webhook delivery body for the `payout.reconciled` event. */
class WebhookEventPayloadPayoutReconciled
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataPayoutReconciled $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataPayoutReconciled')]
    public EventDataPayoutReconciled $data;
    ...
    /**
     * Event type. Always `payout.reconciled`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataPayoutReconciled  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataPayoutReconciled $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'payout.reconciled')
    {
        $this->id = $id;
