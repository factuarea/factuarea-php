...
/** WebhookEventPayloadQuoteEmailSent - Webhook delivery body for the `quote.email_sent` event. */
class WebhookEventPayloadQuoteEmailSent
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataQuoteEmailSent $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataQuoteEmailSent')]
    public EventDataQuoteEmailSent $data;
    ...
    /**
     * Event type. Always `quote.email_sent`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataQuoteEmailSent  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataQuoteEmailSent $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'quote.email_sent')
    {
        $this->id = $id;
