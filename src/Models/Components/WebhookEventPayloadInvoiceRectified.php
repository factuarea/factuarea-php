...
/** WebhookEventPayloadInvoiceRectified - Webhook delivery body for the `invoice.rectified` event. */
class WebhookEventPayloadInvoiceRectified
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `invoice.rectified` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataInvoiceRectified $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataInvoiceRectified')]
    public EventDataInvoiceRectified $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataInvoiceRectified  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataInvoiceRectified $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'invoice.rectified')
    {
        $this->id = $id;
