...
/** WebhookEventPayloadInvoiceCancelled - Webhook delivery body for the `invoice.cancelled` event. */
class WebhookEventPayloadInvoiceCancelled
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `invoice.cancelled` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataInvoiceCancelled $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataInvoiceCancelled')]
    public EventDataInvoiceCancelled $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataInvoiceCancelled  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataInvoiceCancelled $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'invoice.cancelled')
    {
        $this->id = $id;
