...
class WebhookEventPayloadClientMetadataChanged
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataClientMetadataChanged $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'client.metadata_changed')
    {
        $this->id = $id;
