...
/** WebhookEventPayloadAutomationRunStepDeadLettered - Webhook delivery body for the `automation_run.step_dead_lettered` event. */
class WebhookEventPayloadAutomationRunStepDeadLettered
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataAutomationRunStepDeadLettered $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataAutomationRunStepDeadLettered')]
    public EventDataAutomationRunStepDeadLettered $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataAutomationRunStepDeadLettered  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataAutomationRunStepDeadLettered $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'automation_run.step_dead_lettered')
    {
        $this->id = $id;
