...
/** WebhookEventPayloadPaymentReceived - Webhook delivery body for the `payment.received` event. */
class WebhookEventPayloadPaymentReceived
{
    /**
     ...
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataPaymentReceived $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataPaymentReceived')]
    public EventDataPaymentReceived $data;
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataPaymentReceived  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataPaymentReceived $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'payment.received')
    {
        $this->id = $id;
