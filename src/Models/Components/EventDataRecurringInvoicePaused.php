...
/** EventDataRecurringInvoicePaused - Payload (`data`) emitted with the `recurring_invoice.paused` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys. */
class EventDataRecurringInvoicePaused
{
     ...
     * @phpstan-pure
     */
    public function __construct(RecurringInvoice $object, string $type = 'recurring_invoice.paused')
    {
        $this->object = $object;
        $this->type = $type;
    }
