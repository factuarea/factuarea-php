...
/** WebhookEventPayloadFulfilmentPrepared - Webhook delivery body for the `fulfilment.prepared` event. */
class WebhookEventPayloadFulfilmentPrepared
{
    /**
    ...
    /**
     * Payload (`data`) emitted with the `fulfilment.prepared` event: the full resource snapshot captured at emission time under `object`, plus event-specific keys.
     *
     * @var \Factuarea\Sdk\Models\Components\EventDataFulfilmentPrepared $data
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('data')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\EventDataFulfilmentPrepared')]
    public EventDataFulfilmentPrepared $data;
    ...
    /**
     * Event type. Always `fulfilment.prepared`.
     *
     * @var string $type
     */
     ...
     * @param  bool  $livemode
     * @param  bool  $test
     * @param  \Factuarea\Sdk\Models\Components\EventDataFulfilmentPrepared  $data
     * @param  ?string  $apiVersion
     * @param  ?string  $correlationId
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataFulfilmentPrepared $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'fulfilment.prepared')
    {
        $this->id = $id;
