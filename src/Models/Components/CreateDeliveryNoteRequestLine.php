...
class CreateDeliveryNoteRequestLine
{
     ...
     * $options
     *
     * @var ?array<\Factuarea\Sdk\Models\Components\CreateDeliveryNoteRequestOption> $options
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('options')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\Factuarea\Sdk\Models\Components\CreateDeliveryNoteRequestOption>|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    ...
    /**
     *
     * @var ?\Factuarea\Sdk\Models\Components\CreateDeliveryNoteRequestPriceSource $priceSource
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('price_source')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\CreateDeliveryNoteRequestPriceSource|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?CreateDeliveryNoteRequestPriceSource $priceSource = null;

    /**
     *
     * @var ?\Factuarea\Sdk\Models\Components\CreateDeliveryNoteRequestPriceSemantics $priceSemantics
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('price_semantics')]
    #[\Speakeasy\Serializer\Annotation\Type('\Factuarea\Sdk\Models\Components\CreateDeliveryNoteRequestPriceSemantics|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?CreateDeliveryNoteRequestPriceSemantics $priceSemantics = null;
     ...
     * @param  ?array<\Factuarea\Sdk\Models\Components\CreateDeliveryNoteRequestOption>  $options
     * @param  ?string  $configurationSignature
     * @param  ?string  $configurationName
     * @param  ?\Factuarea\Sdk\Models\Components\CreateDeliveryNoteRequestPriceSource  $priceSource
     * @param  ?\Factuarea\Sdk\Models\Components\CreateDeliveryNoteRequestPriceSemantics  $priceSemantics
     * @param  ?float  $priceAdjustmentTotal
     * @param  ?bool  $optionAdjustmentsAbsorbed
     * @phpstan-pure
     */
    public function __construct(float $quantity, ?string $description = null, ?float $unitPrice = null, ?string $taxRateId = null, ?float $taxRate = null, ?float $retentionRate = null, ?float $surchargeRate = null, ?string $retentionRateId = null, ?string $surchargeRateId = null, ?string $productId = null, ?string $variantId = null, ?string $presentationId = null, ?float $confirmedBaseQuantity = null, ?float $baseQuantity = null, ?float $discountPercent = null, ?CreateDeliveryNoteRequestIndirectTaxRegime $indirectTaxRegime = null, ?string $configurationUuid = null, ?array $options = null, ?string $configurationSignature = null, ?string $configurationName = null, ?CreateDeliveryNoteRequestPriceSource $priceSource = null, ?CreateDeliveryNoteRequestPriceSemantics $priceSemantics = null, ?float $priceAdjustmentTotal = null, ?bool $optionAdjustmentsAbsorbed = null)
    {
