...
class WebhookEventPayloadProductUpdated
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $id, int $created, bool $livemode, bool $test, EventDataProductUpdated $data, ?string $apiVersion = null, ?string $correlationId = null, string $type = 'product.updated')
    {
        $this->id = $id;
