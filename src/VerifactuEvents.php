...
class VerifactuEvents
{
     ...
     */
    public function publicApiV1VerifactuEventsList(?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?Options $options = null): Operations\PublicApiV1VerifactuEventsListResponse
    {
        $retryConfig = null;
        if ($options) {
