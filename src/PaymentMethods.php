...
class PaymentMethods
{
    ...
    public function publicApiV1PaymentMethodsList(?LocalDate $factuareaVersion = null, ?Options $options = null): Operations\PublicApiV1PaymentMethodsListResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'public-api.v1.payment_methods.list', null, $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Factuarea\Sdk\Models\Operations\PublicApiV1PaymentMethodsListResponseBody', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\PublicApiV1PaymentMethodsListResponse(
