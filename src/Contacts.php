...
class Contacts
{
     ...
     * @throws \Factuarea\Sdk\Models\Errors\APIException
     */
    public function publicApiV1ContactsBulkDelete(Components\BulkArchiveBusinessContactsV1Request $body, string $idempotencyKey, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?Options $options = null): Operations\PublicApiV1ContactsBulkDeleteResponse
    {
        $retryConfig = null;
        if ($options) {
            $retryConfig = $options->retryConfig;
