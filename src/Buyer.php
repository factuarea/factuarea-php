...
class Buyer
{
     ...
     *
     * @param  \Factuarea\Sdk\Models\Operations\PublicApiV1SalesOrdersBuyerUpdateRequest  $request
     * @return \Factuarea\Sdk\Models\Operations\PublicApiV1SalesOrdersBuyerUpdateResponse
     * @throws \Factuarea\Sdk\Models\Errors\APIException
     */
    public function publicApiV1SalesOrdersBuyerUpdate(Operations\PublicApiV1SalesOrdersBuyerUpdateRequest $request, ?Options $options = null): Operations\PublicApiV1SalesOrdersBuyerUpdateResponse
    {
        $retryConfig = null;
        if ($options) {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/companies/{company}/sales-orders/{sales_order}/buyer', Operations\PublicApiV1SalesOrdersBuyerUpdateRequest::class, $request);
        $urlOverride = null;
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'public-api.v1.sales_orders.buyer.update', null, $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Factuarea\Sdk\Models\Operations\PublicApiV1SalesOrdersBuyerUpdateResponseBody', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\PublicApiV1SalesOrdersBuyerUpdateResponse(
