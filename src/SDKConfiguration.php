...
use Factuarea\Sdk\Utils\Retry\RetryConfig;
...
class SDKConfiguration
{
    ...
    public string $userAgent = 'speakeasy-sdk/php 0.3.1 2.937.18 1.0.0 factuarea/factuarea-php';
    ...
    public function getServerUrl(): string
    {
        ...
        if (isset(Factuarea::SERVERS[$this->serverIndex])) {
            return Factuarea::SERVERS[$this->serverIndex];
        } else {
    ...
    public function getServerDetails(): Utils\ServerDetails
    {
        ...
        return new Utils\ServerDetails(Factuarea::SERVERS[$this->serverIndex], []);
