...
class AbsenceCalendar
{
     ...
     *
     * @param  \Factuarea\Sdk\Models\Operations\PublicApiV1AbsenceCalendarShowRequest  $request
     * @return \Factuarea\Sdk\Models\Operations\PublicApiV1AbsenceCalendarShowResponse
     * @throws \Factuarea\Sdk\Models\Errors\APIException
     */
    public function publicApiV1AbsenceCalendarShow(Operations\PublicApiV1AbsenceCalendarShowRequest $request, ?Options $options = null): Operations\PublicApiV1AbsenceCalendarShowResponse
    {
        $retryConfig = null;
        if ($options) {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/companies/{company}/absence-calendar', Operations\PublicApiV1AbsenceCalendarShowRequest::class, $request);
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];

        $qp = Utils\Utils::getQueryParams(Operations\PublicApiV1AbsenceCalendarShowRequest::class, $request, $urlOverride);
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'public-api.v1.absence-calendar.show', null, $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Factuarea\Sdk\Models\Operations\PublicApiV1AbsenceCalendarShowResponseBody', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\PublicApiV1AbsenceCalendarShowResponse(
