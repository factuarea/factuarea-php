...
class Payments
{
    ...
    public function publicApiV1StripeAutoinvoicingPaymentsList(?Operations\Origin $origin = null, ?LocalDate $factuareaVersion = null, ?string $xActiveProfile = null, ?Options $options = null): Operations\PublicApiV1StripeAutoinvoicingPaymentsListResponse
    {
        ...
        $qp = Utils\Utils::getQueryParams(Operations\PublicApiV1StripeAutoinvoicingPaymentsListRequest::class, $request, $urlOverride);
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'public-api.v1.stripe_autoinvoicing.payments.list', null, $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Factuarea\Sdk\Models\Operations\PublicApiV1StripeAutoinvoicingPaymentsListPaginatedList', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\PublicApiV1StripeAutoinvoicingPaymentsListResponse(
