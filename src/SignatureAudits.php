...
class SignatureAudits
{
    ...
    public function publicApiV1DeliveryNotesSignatureAuditsForget(string $auditId, ?Options $options = null): Operations\PublicApiV1DeliveryNotesSignatureAuditsForgetResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'public-api.v1.delivery_notes.signature_audits.forget', null, $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Factuarea\Sdk\Models\Operations\PublicApiV1DeliveryNotesSignatureAuditsForgetResponseBody', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $response = new Operations\PublicApiV1DeliveryNotesSignatureAuditsForgetResponse(
