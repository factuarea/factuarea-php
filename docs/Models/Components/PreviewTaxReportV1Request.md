...
Public REST API v1 — POST /v1/companies/{company}/tax-reports/preview.
...
`POST /v1/companies/{company}/tax-reports/303` and `POST /v1/companies/{company}/tax-reports/347`. The handler
