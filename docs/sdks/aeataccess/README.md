...
<!-- UsageSnippet language="php" operationID="public-api.v1.verifactu.aeat_access.list" method="get" path="/verifactu/aeat-access/records" example="success" -->
```php
...
<!-- UsageSnippet language="php" operationID="public-api.v1.verifactu.aeat_access.show" method="get" path="/verifactu/aeat-access/records/{record}" example="success" -->
```php
declare(strict_types=1);
