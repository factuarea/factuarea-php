...
<!-- UsageSnippet language="php" operationID="public-api.v1.quotes.accept" method="post" path="/companies/{company}/quotes/{quote}/accept" example="success" -->
```php
...
$request = new Operations\PublicApiV1QuotesAcceptRequest(
    company: 'Reichel, Braun and Sauer',
    quote: '<value>',
...
<!-- UsageSnippet language="php" operationID="public-api.v1.quotes.bulk_delete" method="post" path="/companies/{company}/quotes/bulk-delete" example="missing_api_key" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.quotes.bulk_delete" method="post" path="/companies/{company}/quotes/bulk-delete" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.quotes.bulk_pdf" method="post" path="/companies/{company}/quotes/bulk-pdf" example="missing_api_key" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.quotes.bulk_send" method="post" path="/companies/{company}/quotes/bulk-send" example="missing_api_key" -->
```php
declare(strict_types=1);
...
$response = $sdk->quotes->publicApiV1QuotesBulkSend(
    company: 'Jaskolski, Braun and Becker',
    idempotencyKey: '01928f10-7c0e-7c4a-9b7d-2f8a6e3c1d4b',
    body: $body,
    factuareaVersion: LocalDate::parse('2026-06-01')
...
<!-- UsageSnippet language="php" operationID="public-api.v1.quotes.bulk_send" method="post" path="/companies/{company}/quotes/bulk-send" example="success" -->
```php
declare(strict_types=1);
...
$response = $sdk->quotes->publicApiV1QuotesBulkSend(
    company: 'Schamberger, Marquardt and Osinski',
    idempotencyKey: '01928f10-7c0e-7c4a-9b7d-2f8a6e3c1d4b',
    body: $body,
    factuareaVersion: LocalDate::parse('2026-06-01')
...
<!-- UsageSnippet language="php" operationID="public-api.v1.quotes.bulk_status" method="post" path="/companies/{company}/quotes/bulk-status" example="missing_api_key" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.quotes.bulk_status" method="post" path="/companies/{company}/quotes/bulk-status" example="success" -->
```php
declare(strict_types=1);
...
$response = $sdk->quotes->publicApiV1QuotesBulkStatus(
    company: 'Turner, Hirthe and Ryan',
    idempotencyKey: '01928f10-7c0e-7c4a-9b7d-2f8a6e3c1d4b',
    body: $body,
    factuareaVersion: LocalDate::parse('2026-06-01')
...
<!-- UsageSnippet language="php" operationID="public-api.v1.quotes.convert" method="post" path="/companies/{company}/quotes/{quote}/convert" example="missing_api_key" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.quotes.convert" method="post" path="/companies/{company}/quotes/{quote}/convert" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.quotes.create" method="post" path="/companies/{company}/quotes" example="missing_api_key" -->
```php
declare(strict_types=1);
...
$body = new Components\CreateQuoteRequest(
    clientId: 'ca96451e-67cd-46a3-96a9-85fcb29d4f41',
    issuedOn: LocalDate::parse('2025-08-24'),
    validUntil: LocalDate::parse('2026-08-18'),
    metadata: [
        'erp_code' => 'IVA-GEN',
...
<!-- UsageSnippet language="php" operationID="public-api.v1.quotes.create" method="post" path="/companies/{company}/quotes" example="quote_b2b_es" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.quotes.create" method="post" path="/companies/{company}/quotes" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.quotes.list" method="get" path="/companies/{company}/quotes" example="success" -->
```php
declare(strict_types=1);
...
$request = new Operations\PublicApiV1QuotesListRequest(
    company: 'Kshlerin, Reichert and Nicolas',
...
<!-- UsageSnippet language="php" operationID="public-api.v1.quotes.delete" method="delete" path="/companies/{company}/quotes/{quote}" -->
```php
declare(strict_types=1);
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `company`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | *string*                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | :heavy_check_mark:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Public identifier (UUID) of the company the request acts on. It must be in your credential's scope; read it from `GET /v1/me` (`data.scope[].id`). Never the tax ID.                                                                                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `quote`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | *string*                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | :heavy_check_mark:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Public identifier (UUID v7) of the quote, as returned in `id` by its list and detail responses.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `idempotencyKey`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | *string*                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | :heavy_check_mark:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Client-generated opaque key (up to 255 characters; UUID v7 recommended) that makes retries safe: the first response is cached and replayed for repeats without re-executing the mutation. Reusing a key with a different body returns `422 idempotency_key_reused`. See the [Idempotency guide](/guides/idempotency). **Required on this operation**: repeating it delivers an effect that cannot be taken back (an email sent, a file generated, a third-party call, a charge), so a request without this header is rejected with `422 idempotency_key_required` before any business logic runs. | 01928f10-7c0e-7c4a-9b7d-2f8a6e3c1d4b                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `factuareaVersion`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | [\DateTime](https://www.php.net/manual/en/class.datetime.php)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | :heavy_minus_sign:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Pin the API version (`YYYY-MM-DD`, Stripe-style date versioning) for this request; omit to use the key's pinned version, or the latest if none. Unsupported version → `400 unsupported_api_version`; malformed → `400 parameter_invalid_format`. The effective version is echoed in the `Factuarea-Version` response header. See the [Versioning guide](/guides/versioning).                                                                                                                                                                                                                      | 2026-06-01                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
<!-- UsageSnippet language="php" operationID="public-api.v1.quotes.show" method="get" path="/companies/{company}/quotes/{quote}" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.quotes.update" method="patch" path="/companies/{company}/quotes/{quote}" example="missing_api_key" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.quotes.update" method="patch" path="/companies/{company}/quotes/{quote}" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.quotes.pdf" method="get" path="/companies/{company}/quotes/{quote}/pdf" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.quotes.duplicate" method="post" path="/companies/{company}/quotes/{quote}/duplicate" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.quotes.find_by_external_id" method="post" path="/companies/{company}/quotes/find-by-external-id" example="missing_api_key" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.quotes.find_by_external_id" method="post" path="/companies/{company}/quotes/find-by-external-id" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.quotes.public_link_get" method="get" path="/companies/{company}/quotes/{quote}/public-link" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.quotes.public_link_update" method="patch" path="/companies/{company}/quotes/{quote}/public-link" example="missing_api_key" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.quotes.public_link_update" method="patch" path="/companies/{company}/quotes/{quote}/public-link" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.quotes.stats" method="get" path="/companies/{company}/quotes/stats" example="success" -->
```php
declare(strict_types=1);
...
$response = $sdk->quotes->publicApiV1QuotesStats(
    company: 'Koch, Jacobs and Hilpert',
    factuareaVersion: LocalDate::parse('2026-06-01')
...
<!-- UsageSnippet language="php" operationID="public-api.v1.quotes.statuses" method="get" path="/companies/{company}/quotes/statuses" example="success" -->
```php
declare(strict_types=1);
...
$response = $sdk->quotes->publicApiV1QuotesStatuses(
    company: 'Armstrong, Bauch and Bradtke',
    factuareaVersion: LocalDate::parse('2026-06-01')
...
<!-- UsageSnippet language="php" operationID="public-api.v1.quotes.reject" method="post" path="/companies/{company}/quotes/{quote}/reject" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.quotes.send" method="post" path="/companies/{company}/quotes/{quote}/send" example="success" -->
```php
declare(strict_types=1);
