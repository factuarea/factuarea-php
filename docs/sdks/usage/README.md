...
* [publicApiV1AutomationsUsageShow](#publicapiv1automationsusageshow) - Retrieve automation usage

## publicApiV1AutomationsUsageShow
...
<!-- UsageSnippet language="php" operationID="public-api.v1.automations.usage.show" method="get" path="/companies/{company}/automations/usage" -->
```php
...
$response = $sdk->automations->usage->publicApiV1AutomationsUsageShow(
    company: 'Turcotte, Emmerich and Little',
...
**[?Operations\PublicApiV1AutomationsUsageShowResponse](../../Models/Operations/PublicApiV1AutomationsUsageShowResponse.md)**
