...
<!-- UsageSnippet language="php" operationID="public-api.v1.stripe_autoinvoicing.config.show" method="get" path="/companies/{company}/stripe-autoinvoicing/config" example="success" -->
```php
...
$response = $sdk->stripeAutoinvoicing->config->publicApiV1StripeAutoinvoicingConfigShow(
    company: 'Dietrich, Lang and Ziemann',
...
<!-- UsageSnippet language="php" operationID="public-api.v1.stripe_autoinvoicing.config.update" method="patch" path="/companies/{company}/stripe-autoinvoicing/config" example="missing_api_key" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.stripe_autoinvoicing.config.update" method="patch" path="/companies/{company}/stripe-autoinvoicing/config" example="success" -->
```php
declare(strict_types=1);
