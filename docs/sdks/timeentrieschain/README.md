...
* [publicApiV1TimeEntriesChainValidate](#publicapiv1timeentrieschainvalidate) - Validate the time record hash chain

## publicApiV1TimeEntriesChainValidate
...
<!-- UsageSnippet language="php" operationID="public-api.v1.time_entries.chain.validate" method="get" path="/companies/{company}/time-entries/chain/validate" example="success" -->
```php
...
$response = $sdk->timeEntries->chain->publicApiV1TimeEntriesChainValidate(
...
**[?Operations\PublicApiV1TimeEntriesChainValidateResponse](../../Models/Operations/PublicApiV1TimeEntriesChainValidateResponse.md)**
