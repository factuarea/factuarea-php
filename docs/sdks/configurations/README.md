...
<!-- UsageSnippet language="php" operationID="public-api.v1.products.configurations.list" method="get" path="/products/{product}/configurations" example="success" -->
```php
...
$request = new Operations\PublicApiV1ProductsConfigurationsListRequest(
    product: 'Electronic Fresh Chips',
...
### Example Usage: insufficient_scope

<!-- UsageSnippet language="php" operationID="public-api.v1.products.configurations.impact_preview" method="post" path="/products/{product}/configurations/impact-preview" example="insufficient_scope" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.products.configurations.impact_preview" method="post" path="/products/{product}/configurations/impact-preview" example="success" -->
```php
declare(strict_types=1);
