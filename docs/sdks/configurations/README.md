...
<!-- UsageSnippet language="php" operationID="public-api.v1.products.configurations.list" method="get" path="/products/{product}/configurations" -->
```php
...
<!-- UsageSnippet language="php" operationID="public-api.v1.products.configurations.impact_preview" method="post" path="/products/{product}/configurations/impact-preview" example="api_key_revoked" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.products.configurations.impact_preview" method="post" path="/products/{product}/configurations/impact-preview" example="invalid_api_key" -->
```php
declare(strict_types=1);
