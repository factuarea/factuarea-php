...
<!-- UsageSnippet language="php" operationID="public-api.v1.recurring_invoices.bulk_status" method="post" path="/recurring_invoices/bulk-status" example="missing_api_key" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.recurring_invoices.bulk_status" method="post" path="/recurring_invoices/bulk-status" example="success" -->
```php
declare(strict_types=1);
