...
<!-- UsageSnippet language="php" operationID="public-api.v1.recurring_invoices.activate" method="post" path="/recurring_invoices/{recurring_invoice}/activate" example="success" -->
```php
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `recurringInvoice`                                                                                                                                                                                                                                                                                                                                                                               | *string*                                                                                                                                                                                                                                                                                                                                                                                         | :heavy_check_mark:                                                                                                                                                                                                                                                                                                                                                                               | N/A                                                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                                                                                                                                                  |
...
<!-- UsageSnippet language="php" operationID="public-api.v1.recurring_invoices.bulk-delete" method="post" path="/recurring_invoices/bulk-delete" example="api_key_revoked" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.recurring_invoices.bulk-delete" method="post" path="/recurring_invoices/bulk-delete" example="invalid_api_key" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.recurring_invoices.bulk-delete" method="post" path="/recurring_invoices/bulk-delete" example="missing_api_key" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.recurring_invoices.bulk-delete" method="post" path="/recurring_invoices/bulk-delete" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.recurring_invoices.cancel" method="post" path="/recurring_invoices/{recurring_invoice}/cancel" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.recurring_invoices.create" method="post" path="/recurring_invoices" example="api_key_revoked" -->
```php
declare(strict_types=1);
...
$body = new Components\CreateRecurringInvoiceRequest(
    clientId: 'fde75c17-ddda-405e-907b-451493319737',
    frequency: Components\CreateRecurringInvoiceRequestFrequency::Weekly,
    startOn: LocalDate::parse('2024-11-11'),
    metadata: [
        'erp_code' => 'IVA-GEN',
...
<!-- UsageSnippet language="php" operationID="public-api.v1.recurring_invoices.create" method="post" path="/recurring_invoices" example="invalid_api_key" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.recurring_invoices.create" method="post" path="/recurring_invoices" example="missing_api_key" -->
```php
declare(strict_types=1);
...
$body = new Components\CreateRecurringInvoiceRequest(
    clientId: '51493319-7376-4241-9b8a-c13e605d7d5a',
    frequency: Components\CreateRecurringInvoiceRequestFrequency::Monthly,
    startOn: LocalDate::parse('2025-04-18'),
    metadata: [
        'erp_code' => 'IVA-GEN',
        'ledger_account' => '477000',
    ],
...
<!-- UsageSnippet language="php" operationID="public-api.v1.recurring_invoices.create" method="post" path="/recurring_invoices" example="recurring_invoice_monthly" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.recurring_invoices.create" method="post" path="/recurring_invoices" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.recurring_invoices.list" method="get" path="/recurring_invoices" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.recurring_invoices.delete" method="delete" path="/recurring_invoices/{recurring_invoice}" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.recurring_invoices.show" method="get" path="/recurring_invoices/{recurring_invoice}" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.recurring_invoices.update" method="put" path="/recurring_invoices/{recurring_invoice}" example="api_key_revoked" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.recurring_invoices.update" method="put" path="/recurring_invoices/{recurring_invoice}" example="invalid_api_key" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.recurring_invoices.update" method="put" path="/recurring_invoices/{recurring_invoice}" example="missing_api_key" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.recurring_invoices.update" method="put" path="/recurring_invoices/{recurring_invoice}" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.recurring_invoices.find_by_external_id" method="post" path="/recurring_invoices/find-by-external-id" example="api_key_revoked" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.recurring_invoices.find_by_external_id" method="post" path="/recurring_invoices/find-by-external-id" example="invalid_api_key" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.recurring_invoices.find_by_external_id" method="post" path="/recurring_invoices/find-by-external-id" example="missing_api_key" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.recurring_invoices.find_by_external_id" method="post" path="/recurring_invoices/find-by-external-id" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.recurring_invoices.generate" method="post" path="/recurring_invoices/{recurring_invoice}/generate" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.recurring_invoices.stats" method="get" path="/recurring_invoices/stats" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.recurring_invoices.activities" method="get" path="/recurring_invoices/{recurring_invoice}/activities" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.recurring_invoices.logs" method="get" path="/recurring_invoices/{recurring_invoice}/logs" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.recurring_invoices.pause" method="post" path="/recurring_invoices/{recurring_invoice}/pause" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.recurring_invoices.preview" method="get" path="/recurring_invoices/{recurring_invoice}/preview" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.recurring_invoices.resume" method="post" path="/recurring_invoices/{recurring_invoice}/resume" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.recurring_invoices.skip" method="post" path="/recurring_invoices/{recurring_invoice}/skip" example="success" -->
```php
declare(strict_types=1);
