...
<!-- UsageSnippet language="php" operationID="public-api.v1.products.presentations.create" method="post" path="/products/{product}/presentations" example="api_key_revoked" -->
```php
...
<!-- UsageSnippet language="php" operationID="public-api.v1.products.presentations.create" method="post" path="/products/{product}/presentations" example="invalid_api_key" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.products.presentations.list" method="get" path="/products/{product}/presentations" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.products.presentations.update" method="put" path="/products/{product}/presentations/{presentation}" example="api_key_revoked" -->
```php
declare(strict_types=1);
...
$request = new Operations\PublicApiV1ProductsPresentationsUpdateRequest(
    product: 'Electronic Frozen Fish',
    presentation: '<value>',
    factuareaVersion: LocalDate::parse('2026-06-01'),
    xActiveProfile: '01931b3e-7c4a-7f2e-9a8b-3c5d6e7f8a0c',
...
<!-- UsageSnippet language="php" operationID="public-api.v1.products.presentations.update" method="put" path="/products/{product}/presentations/{presentation}" example="invalid_api_key" -->
```php
declare(strict_types=1);
