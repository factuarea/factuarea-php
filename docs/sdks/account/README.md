...
<!-- UsageSnippet language="php" operationID="public-api.v1.account.show" method="get" path="/account" example="success" -->
```php
...
<!-- UsageSnippet language="php" operationID="public-api.v1.account.billing" method="get" path="/account/billing" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.account.verify_census" method="post" path="/account/census-verification" example="success" -->
```php
declare(strict_types=1);
