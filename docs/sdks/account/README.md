...
<!-- UsageSnippet language="php" operationID="public-api.v1.account.billing" method="get" path="/account/billing" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.account.verify_census" method="post" path="/account/census-verification" -->
```php
declare(strict_types=1);
