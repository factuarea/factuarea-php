...
<!-- UsageSnippet language="php" operationID="public-api.v1.automations.catalog.show" method="get" path="/automations/catalog" -->
```php
...
<!-- UsageSnippet language="php" operationID="public-api.v1.automations.catalog.trigger_fields" method="get" path="/automations/catalog/triggers/{trigger}/fields" -->
```php
declare(strict_types=1);
