...
<!-- UsageSnippet language="php" operationID="public-api.v1.employee-invitations.list" method="get" path="/employee-invitations" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.employee-invitations.resend" method="post" path="/employee-invitations/{invitation}/resend" -->
```php
declare(strict_types=1);
