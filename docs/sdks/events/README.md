...
<!-- UsageSnippet language="php" operationID="public-api.v1.events.list" method="get" path="/companies/{company}/events" example="success" -->
```php
...
$request = new Operations\PublicApiV1EventsListRequest(
    company: 'Cormier, Cole and Hudson',
...
<!-- UsageSnippet language="php" operationID="public-api.v1.events.show" method="get" path="/companies/{company}/events/{event}" example="success" -->
```php
declare(strict_types=1);
...
| `event`                                                                                                                                                                                                                                                                                                                                                                      | *string*                                                                                                                                                                                                                                                                                                                                                                     | :heavy_check_mark:                                                                                                                                                                                                                                                                                                                                                           | Public identifier (UUID v7) of the event, as returned in `id` by its list and detail responses.                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                                                                                                                              |
