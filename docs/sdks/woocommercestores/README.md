...
<!-- UsageSnippet language="php" operationID="public-api.v1.woocommerce.stores.connection_test" method="post" path="/woocommerce/stores/{store}/connection-test" example="credentials_rejected" -->
```php
...
<!-- UsageSnippet language="php" operationID="public-api.v1.woocommerce.stores.connection_test" method="post" path="/woocommerce/stores/{store}/connection-test" example="rest_route_missing" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.woocommerce.stores.connection_test" method="post" path="/woocommerce/stores/{store}/connection-test" example="store_unreachable" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.woocommerce.stores.connection_test" method="post" path="/woocommerce/stores/{store}/connection-test" example="success" -->
```php
declare(strict_types=1);
