...
* [publicApiV1WoocommerceStoresConnectionTest](#publicapiv1woocommercestoresconnectiontest) - Test a WooCommerce store connection

## publicApiV1WoocommerceStoresConnectionTest
...
### Example Usage: credentials_rejected

<!-- UsageSnippet language="php" operationID="public-api.v1.woocommerce.stores.connection_test" method="post" path="/companies/{company}/woocommerce/stores/{store}/connection-test" example="credentials_rejected" -->
```php
...
$response = $sdk->woocommerce->stores->publicApiV1WoocommerceStoresConnectionTest(
    company: 'Tromp - Lowe',
    store: '<value>',
...
```
### Example Usage: rest_route_missing

<!-- UsageSnippet language="php" operationID="public-api.v1.woocommerce.stores.connection_test" method="post" path="/companies/{company}/woocommerce/stores/{store}/connection-test" example="rest_route_missing" -->
```php
declare(strict_types=1);
...
```
### Example Usage: store_unreachable

<!-- UsageSnippet language="php" operationID="public-api.v1.woocommerce.stores.connection_test" method="post" path="/companies/{company}/woocommerce/stores/{store}/connection-test" example="store_unreachable" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.woocommerce.stores.connection_test" method="post" path="/companies/{company}/woocommerce/stores/{store}/connection-test" example="success" -->
```php
declare(strict_types=1);
...
**[?Operations\PublicApiV1WoocommerceStoresConnectionTestResponse](../../Models/Operations/PublicApiV1WoocommerceStoresConnectionTestResponse.md)**
