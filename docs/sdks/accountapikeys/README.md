...
<!-- UsageSnippet language="php" operationID="public-api.v1.account.api_keys.list" method="get" path="/account/api-keys" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.account.api_keys.revoke" method="post" path="/account/api-keys/{api_key}/revoke" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.account.api_keys.rotate_secret" method="post" path="/account/api-keys/{api_key}/rotate_secret" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.account.api_keys.show" method="get" path="/account/api-keys/{api_key}" -->
```php
declare(strict_types=1);
