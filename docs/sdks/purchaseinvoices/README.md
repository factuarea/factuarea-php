...
<!-- UsageSnippet language="php" operationID="public-api.v1.purchase_invoices.attach_file" method="post" path="/companies/{company}/purchase-invoices/{purchase_invoice}/attach-file" example="missing_api_key" -->
```php
...
<!-- UsageSnippet language="php" operationID="public-api.v1.purchase_invoices.attach_file" method="post" path="/companies/{company}/purchase-invoices/{purchase_invoice}/attach-file" example="success" -->
```php
declare(strict_types=1);
...
| ---------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| `$request`                                                                                                                         | [Operations\PublicApiV1PurchaseInvoicesAttachFileRequest](../../Models/Operations/PublicApiV1PurchaseInvoicesAttachFileRequest.md) | :heavy_check_mark:                                                                                                                 | The request object to use for the request.                                                                                         |
...
<!-- UsageSnippet language="php" operationID="public-api.v1.purchase_invoices.bulk_delete" method="post" path="/companies/{company}/purchase-invoices/bulk-delete" example="missing_api_key" -->
```php
declare(strict_types=1);
...
$response = $sdk->purchaseInvoices->publicApiV1PurchaseInvoicesBulkDelete(
    company: 'Mueller, Haley and Ebert',
    idempotencyKey: '01928f10-7c0e-7c4a-9b7d-2f8a6e3c1d4b',
    body: $body,
    factuareaVersion: LocalDate::parse('2026-06-01')
...
<!-- UsageSnippet language="php" operationID="public-api.v1.purchase_invoices.bulk_delete" method="post" path="/companies/{company}/purchase-invoices/bulk-delete" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.purchase_invoices.bulk_status" method="post" path="/companies/{company}/purchase-invoices/bulk-status" example="missing_api_key" -->
```php
declare(strict_types=1);
...
$body = new Components\BulkStatusPurchaseInvoicesV1Request(
    ids: [
        '3746f645-dae0-41c6-b214-ac406b3cc6a6',
    ],
    newStatus: Components\BulkStatusPurchaseInvoicesV1RequestNewStatus::Paid,
);

$response = $sdk->purchaseInvoices->publicApiV1PurchaseInvoicesBulkStatus(
    company: 'Hamill, Padberg and Rutherford',
    idempotencyKey: '01928f10-7c0e-7c4a-9b7d-2f8a6e3c1d4b',
    body: $body,
    factuareaVersion: LocalDate::parse('2026-06-01')
...
<!-- UsageSnippet language="php" operationID="public-api.v1.purchase_invoices.bulk_status" method="post" path="/companies/{company}/purchase-invoices/bulk-status" example="success" -->
```php
declare(strict_types=1);
...
| `company`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | *string*                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | :heavy_check_mark:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Public identifier (UUID) of the company the request acts on. It must be in your credential's scope; read it from `GET /v1/me` (`data.scope[].id`). Never the tax ID.                                                                                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `idempotencyKey`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | *string*                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | :heavy_check_mark:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Client-generated opaque key (up to 255 characters; UUID v7 recommended) that makes retries safe: the first response is cached and replayed for repeats without re-executing the mutation. Reusing a key with a different body returns `422 idempotency_key_reused`. See the [Idempotency guide](/guides/idempotency). **Required on this operation**: repeating it delivers an effect that cannot be taken back (an email sent, a file generated, a third-party call, a charge), so a request without this header is rejected with `422 idempotency_key_required` before any business logic runs. | 01928f10-7c0e-7c4a-9b7d-2f8a6e3c1d4b                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `body`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | [Components\BulkStatusPurchaseInvoicesV1Request](../../Models/Components/BulkStatusPurchaseInvoicesV1Request.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | :heavy_check_mark:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | N/A                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `factuareaVersion`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | [\DateTime](https://www.php.net/manual/en/class.datetime.php)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | :heavy_minus_sign:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Pin the API version (`YYYY-MM-DD`, Stripe-style date versioning) for this request; omit to use the key's pinned version, or the latest if none. Unsupported version → `400 unsupported_api_version`; malformed → `400 parameter_invalid_format`. The effective version is echoed in the `Factuarea-Version` response header. See the [Versioning guide](/guides/versioning).                                                                                                                                                                                                                      | 2026-06-01                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |

### Response

**[?Operations\PublicApiV1PurchaseInvoicesBulkStatusResponse](../../Models/Operations/PublicApiV1PurchaseInvoicesBulkStatusResponse.md)**
...
<!-- UsageSnippet language="php" operationID="public-api.v1.purchase_invoices.create" method="post" path="/companies/{company}/purchase-invoices" example="missing_api_key" -->
```php
declare(strict_types=1);
...
$body = new Components\CreatePurchaseInvoiceRequest(
    ...
    issuedOn: LocalDate::parse('2025-10-19'),
    metadata: [
        'erp_code' => 'IVA-GEN',
...
<!-- UsageSnippet language="php" operationID="public-api.v1.purchase_invoices.create" method="post" path="/companies/{company}/purchase-invoices" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.purchase_invoices.list" method="get" path="/companies/{company}/purchase-invoices" example="success" -->
```php
declare(strict_types=1);
...
$request = new Operations\PublicApiV1PurchaseInvoicesListRequest(
    company: 'Trantow - Reichert',
    sort: Operations\PublicApiV1PurchaseInvoicesListSort::MinusCreated,
    factuareaVersion: LocalDate::parse('2026-06-01'),
);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.purchase_invoices.delete" method="delete" path="/companies/{company}/purchase-invoices/{purchase_invoice}" -->
```php
declare(strict_types=1);
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `company`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | *string*                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | :heavy_check_mark:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Public identifier (UUID) of the company the request acts on. It must be in your credential's scope; read it from `GET /v1/me` (`data.scope[].id`). Never the tax ID.                                                                                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `purchaseInvoice`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | *string*                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | :heavy_check_mark:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Public identifier (UUID v7) of the purchase invoice, as returned in `id` by its list and detail responses.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `idempotencyKey`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | *string*                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | :heavy_check_mark:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Client-generated opaque key (up to 255 characters; UUID v7 recommended) that makes retries safe: the first response is cached and replayed for repeats without re-executing the mutation. Reusing a key with a different body returns `422 idempotency_key_reused`. See the [Idempotency guide](/guides/idempotency). **Required on this operation**: repeating it delivers an effect that cannot be taken back (an email sent, a file generated, a third-party call, a charge), so a request without this header is rejected with `422 idempotency_key_required` before any business logic runs. | 01928f10-7c0e-7c4a-9b7d-2f8a6e3c1d4b                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `factuareaVersion`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | [\DateTime](https://www.php.net/manual/en/class.datetime.php)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | :heavy_minus_sign:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Pin the API version (`YYYY-MM-DD`, Stripe-style date versioning) for this request; omit to use the key's pinned version, or the latest if none. Unsupported version → `400 unsupported_api_version`; malformed → `400 parameter_invalid_format`. The effective version is echoed in the `Factuarea-Version` response header. See the [Versioning guide](/guides/versioning).                                                                                                                                                                                                                      | 2026-06-01                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
<!-- UsageSnippet language="php" operationID="public-api.v1.purchase_invoices.show" method="get" path="/companies/{company}/purchase-invoices/{purchase_invoice}" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.purchase_invoices.update" method="patch" path="/companies/{company}/purchase-invoices/{purchase_invoice}" example="missing_api_key" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.purchase_invoices.update" method="patch" path="/companies/{company}/purchase-invoices/{purchase_invoice}" example="success" -->
```php
declare(strict_types=1);
...
$request = new Operations\PublicApiV1PurchaseInvoicesUpdateRequest(
    company: 'Klein, Skiles and Kassulke',
    purchaseInvoice: '<value>',
    idempotencyKey: '01928f10-7c0e-7c4a-9b7d-2f8a6e3c1d4b',
    factuareaVersion: LocalDate::parse('2026-06-01'),
    body: new Components\UpdatePurchaseInvoiceRequest(
...
| Parameter                                                                                                                  | Type                                                                                                                       | Required                                                                                                                   | Description                                                                                                                |
| -------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| `$request`                                                                                                                 | [Operations\PublicApiV1PurchaseInvoicesUpdateRequest](../../Models/Operations/PublicApiV1PurchaseInvoicesUpdateRequest.md) | :heavy_check_mark:                                                                                                         | The request object to use for the request.                                                                                 |
...
<!-- UsageSnippet language="php" operationID="public-api.v1.purchase_invoices.delete_file" method="delete" path="/companies/{company}/purchase-invoices/{purchase_invoice}/file" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.purchase_invoices.file" method="get" path="/companies/{company}/purchase-invoices/{purchase_invoice}/file" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.purchase_invoices.payment_receipt" method="get" path="/companies/{company}/purchase-invoices/{purchase_invoice}/payment-receipt" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.purchase_invoices.find_by_external_id" method="post" path="/companies/{company}/purchase-invoices/find-by-external-id" example="missing_api_key" -->
```php
declare(strict_types=1);
...
$body = new Components\FindPurchaseInvoiceByExternalIdRequest(
    externalId: '<id>',
);

$response = $sdk->purchaseInvoices->publicApiV1PurchaseInvoicesFindByExternalId(
...
<!-- UsageSnippet language="php" operationID="public-api.v1.purchase_invoices.find_by_external_id" method="post" path="/companies/{company}/purchase-invoices/find-by-external-id" example="success" -->
```php
declare(strict_types=1);
...
$response = $sdk->purchaseInvoices->publicApiV1PurchaseInvoicesFindByExternalId(
    company: 'Fadel, Wiza and MacGyver',
    body: $body,
    factuareaVersion: LocalDate::parse('2026-06-01')
...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `company`                                                                                                                                                                                                                                                                                                                                                                    | *string*                                                                                                                                                                                                                                                                                                                                                                     | :heavy_check_mark:                                                                                                                                                                                                                                                                                                                                                           | Public identifier (UUID) of the company the request acts on. It must be in your credential's scope; read it from `GET /v1/me` (`data.scope[].id`). Never the tax ID.                                                                                                                                                                                                         |                                                                                                                                                                                                                                                                                                                                                                              |
| `body`                                                                                                                                                                                                                                                                                                                                                                       | [Components\FindPurchaseInvoiceByExternalIdRequest](../../Models/Components/FindPurchaseInvoiceByExternalIdRequest.md)                                                                                                                                                                                                                                                       | :heavy_check_mark:                                                                                                                                                                                                                                                                                                                                                           | N/A                                                                                                                                                                                                                                                                                                                                                                          |                                                                                                                                                                                                                                                                                                                                                                              |
| `factuareaVersion`                                                                                                                                                                                                                                                                                                                                                           | [\DateTime](https://www.php.net/manual/en/class.datetime.php)                                                                                                                                                                                                                                                                                                                | :heavy_minus_sign:                                                                                                                                                                                                                                                                                                                                                           | Pin the API version (`YYYY-MM-DD`, Stripe-style date versioning) for this request; omit to use the key's pinned version, or the latest if none. Unsupported version → `400 unsupported_api_version`; malformed → `400 parameter_invalid_format`. The effective version is echoed in the `Factuarea-Version` response header. See the [Versioning guide](/guides/versioning). | 2026-06-01                                                                                                                                                                                                                                                                                                                                                                   |

### Response

**[?Operations\PublicApiV1PurchaseInvoicesFindByExternalIdResponse](../../Models/Operations/PublicApiV1PurchaseInvoicesFindByExternalIdResponse.md)**
...
<!-- UsageSnippet language="php" operationID="public-api.v1.purchase_invoices.stats" method="get" path="/companies/{company}/purchase-invoices/stats" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.purchase_invoices.overdue" method="get" path="/companies/{company}/purchase-invoices/overdue" example="success" -->
```php
declare(strict_types=1);
...
| Parameter                                                                                                                    | Type                                                                                                                         | Required                                                                                                                     | Description                                                                                                                  |
| ---------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| `$request`                                                                                                                   | [Operations\PublicApiV1PurchaseInvoicesOverdueRequest](../../Models/Operations/PublicApiV1PurchaseInvoicesOverdueRequest.md) | :heavy_check_mark:                                                                                                           | The request object to use for the request.                                                                                   |
...
<!-- UsageSnippet language="php" operationID="public-api.v1.purchase_invoices.pending" method="get" path="/companies/{company}/purchase-invoices/pending" example="success" -->
```php
declare(strict_types=1);
...
| Parameter                                                                                                                    | Type                                                                                                                         | Required                                                                                                                     | Description                                                                                                                  |
| ---------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| `$request`                                                                                                                   | [Operations\PublicApiV1PurchaseInvoicesPendingRequest](../../Models/Operations/PublicApiV1PurchaseInvoicesPendingRequest.md) | :heavy_check_mark:                                                                                                           | The request object to use for the request.                                                                                   |
...
<!-- UsageSnippet language="php" operationID="public-api.v1.purchase_invoices.list_payments" method="get" path="/companies/{company}/purchase-invoices/{purchase_invoice}/payments" example="success" -->
```php
declare(strict_types=1);
...
$response = $sdk->purchaseInvoices->publicApiV1PurchaseInvoicesListPayments(
...
**[?Operations\PublicApiV1PurchaseInvoicesListPaymentsResponse](../../Models/Operations/PublicApiV1PurchaseInvoicesListPaymentsResponse.md)**
...
<!-- UsageSnippet language="php" operationID="public-api.v1.purchase_invoices.register_payment" method="post" path="/companies/{company}/purchase-invoices/{purchase_invoice}/payments" example="missing_api_key" -->
```php
declare(strict_types=1);
...
$request = new Operations\PublicApiV1PurchaseInvoicesRegisterPaymentRequest(
    company: 'Weissnat, Considine and Ward',
    purchaseInvoice: '<value>',
    idempotencyKey: '01928f10-7c0e-7c4a-9b7d-2f8a6e3c1d4b',
    factuareaVersion: LocalDate::parse('2026-06-01'),
    body: new Components\RegisterPurchaseInvoicePaymentRequest(
        amount: 6207.65,
        paidOn: LocalDate::parse('2024-10-31'),
        paymentMethod: '<value>',
    ),
);

$response = $sdk->purchaseInvoices->publicApiV1PurchaseInvoicesRegisterPayment(
    request: $request
);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.purchase_invoices.register_payment" method="post" path="/companies/{company}/purchase-invoices/{purchase_invoice}/payments" example="success" -->
```php
declare(strict_types=1);
...
| Parameter                                                                                                                                    | Type                                                                                                                                         | Required                                                                                                                                     | Description                                                                                                                                  |
| -------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| `$request`                                                                                                                                   | [Operations\PublicApiV1PurchaseInvoicesRegisterPaymentRequest](../../Models/Operations/PublicApiV1PurchaseInvoicesRegisterPaymentRequest.md) | :heavy_check_mark:                                                                                                                           | The request object to use for the request.                                                                                                   |

### Response

**[?Operations\PublicApiV1PurchaseInvoicesRegisterPaymentResponse](../../Models/Operations/PublicApiV1PurchaseInvoicesRegisterPaymentResponse.md)**
...
<!-- UsageSnippet language="php" operationID="public-api.v1.purchase_invoices.mark_paid" method="post" path="/companies/{company}/purchase-invoices/{purchase_invoice}/mark-paid" example="success" -->
```php
declare(strict_types=1);
...
| Parameter                                                                                                                      | Type                                                                                                                           | Required                                                                                                                       | Description                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------ |
| `$request`                                                                                                                     | [Operations\PublicApiV1PurchaseInvoicesMarkPaidRequest](../../Models/Operations/PublicApiV1PurchaseInvoicesMarkPaidRequest.md) | :heavy_check_mark:                                                                                                             | The request object to use for the request.                                                                                     |
