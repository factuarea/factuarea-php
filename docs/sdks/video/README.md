...
<!-- UsageSnippet language="php" operationID="public-api.v1.products.video.delete" method="delete" path="/companies/{company}/products/{product}/video" -->
```php
...
$response = $sdk->products->video->publicApiV1ProductsVideoDelete(
    ...
    product: 'Incredible Plastic Chair',
...
<!-- UsageSnippet language="php" operationID="public-api.v1.products.video.upload" method="post" path="/companies/{company}/products/{product}/video" example="missing_api_key" -->
```php
declare(strict_types=1);
...
$request = new Operations\PublicApiV1ProductsVideoUploadRequest(
    ...
    product: 'Electronic Steel Salad',
    idempotencyKey: '01928f10-7c0e-7c4a-9b7d-2f8a6e3c1d4b',
    factuareaVersion: LocalDate::parse('2026-06-01'),
...
<!-- UsageSnippet language="php" operationID="public-api.v1.products.video.upload" method="post" path="/companies/{company}/products/{product}/video" example="success" -->
```php
declare(strict_types=1);
...
| -------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| `$request`                                                                                                           | [Operations\PublicApiV1ProductsVideoUploadRequest](../../Models/Operations/PublicApiV1ProductsVideoUploadRequest.md) | :heavy_check_mark:                                                                                                   | The request object to use for the request.                                                                           |
...
<!-- UsageSnippet language="php" operationID="public-api.v1.products.video.download" method="get" path="/companies/{company}/products/{product}/video/download" -->
```php
declare(strict_types=1);
...
$response = $sdk->products->video->publicApiV1ProductsVideoDownload(
    company: 'Keeling LLC',
    product: 'Ergonomic Steel Cheese',
    factuareaVersion: LocalDate::parse('2026-06-01')
