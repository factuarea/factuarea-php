...
* [publicApiV1SeriesBootstrap](#publicapiv1seriesbootstrap) - Bootstrap the default series of a company
...
<!-- UsageSnippet language="php" operationID="public-api.v1.series.archive" method="post" path="/companies/{company}/series/{series}/archive" -->
```php
...
$response = $sdk->series->publicApiV1SeriesArchive(
    company: 'Larson, Schaden and Keeling',
    series: '<value>',
...
| `series`                                                                                                                                                                                                                                                                                                                                                                     | *string*                                                                                                                                                                                                                                                                                                                                                                     | :heavy_check_mark:                                                                                                                                                                                                                                                                                                                                                           | Public identifier (UUID v7) of the document series.                                                                                                                                                                                                                                                                                                                          |                                                                                                                                                                                                                                                                                                                                                                              |
...
<!-- UsageSnippet language="php" operationID="public-api.v1.series.bootstrap" method="post" path="/companies/{company}/series/bootstrap" example="success" -->
```php
declare(strict_types=1);
...
$response = $sdk->series->publicApiV1SeriesBootstrap(
    company: 'Hand, Koss and Jacobs',
    idempotencyKey: '01928f10-7c0e-7c4a-9b7d-2f8a6e3c1d4b',
    factuareaVersion: LocalDate::parse('2026-06-01')
...
**[?Operations\PublicApiV1SeriesBootstrapResponse](../../Models/Operations/PublicApiV1SeriesBootstrapResponse.md)**
...
<!-- UsageSnippet language="php" operationID="public-api.v1.series.create" method="post" path="/companies/{company}/series" example="missing_api_key" -->
```php
declare(strict_types=1);
...
$response = $sdk->series->publicApiV1SeriesCreate(
    company: 'Heaney, Bernhard and Dare',
    body: $body,
    idempotencyKey: '01928f10-7c0e-7c4a-9b7d-2f8a6e3c1d4b',
    factuareaVersion: LocalDate::parse('2026-06-01')
...
<!-- UsageSnippet language="php" operationID="public-api.v1.series.create" method="post" path="/companies/{company}/series" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.series.list" method="get" path="/companies/{company}/series" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.series.find_by_code" method="post" path="/companies/{company}/series/find-by-code" example="missing_api_key" -->
```php
declare(strict_types=1);
...
$response = $sdk->series->publicApiV1SeriesFindByCode(
    company: 'Strosin, Huel and Parisian',
    body: $body,
    factuareaVersion: LocalDate::parse('2026-06-01')
...
<!-- UsageSnippet language="php" operationID="public-api.v1.series.find_by_code" method="post" path="/companies/{company}/series/find-by-code" example="success" -->
```php
declare(strict_types=1);
...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `company`                                                                                                                                                                                                                                                                                                                                                                    | *string*                                                                                                                                                                                                                                                                                                                                                                     | :heavy_check_mark:                                                                                                                                                                                                                                                                                                                                                           | Public identifier (UUID v7) of the company. Get it from `GET /v1/me` (`data.scope[].id`).                                                                                                                                                                                                                                                                                    |                                                                                                                                                                                                                                                                                                                                                                              |
| `body`                                                                                                                                                                                                                                                                                                                                                                       | [Components\FindSeriesByCodeRequest](../../Models/Components/FindSeriesByCodeRequest.md)                                                                                                                                                                                                                                                                                     | :heavy_check_mark:                                                                                                                                                                                                                                                                                                                                                           | N/A                                                                                                                                                                                                                                                                                                                                                                          |                                                                                                                                                                                                                                                                                                                                                                              |
| `factuareaVersion`                                                                                                                                                                                                                                                                                                                                                           | [\DateTime](https://www.php.net/manual/en/class.datetime.php)                                                                                                                                                                                                                                                                                                                | :heavy_minus_sign:                                                                                                                                                                                                                                                                                                                                                           | Pin the API version (`YYYY-MM-DD`, Stripe-style date versioning) for this request; omit to use the key's pinned version, or the latest if none. Unsupported version → `400 unsupported_api_version`; malformed → `400 parameter_invalid_format`. The effective version is echoed in the `Factuarea-Version` response header. See the [Versioning guide](/guides/versioning). | 2026-06-01                                                                                                                                                                                                                                                                                                                                                                   |
...
<!-- UsageSnippet language="php" operationID="public-api.v1.series.default" method="get" path="/companies/{company}/series/default" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.series.activities" method="get" path="/companies/{company}/series/{series}/activities" example="success" -->
```php
declare(strict_types=1);
...
$request = new Operations\PublicApiV1SeriesActivitiesRequest(
    company: 'Aufderhar, Bergstrom and Franey',
    series: '<value>',
    startingAfter: '2',
    endingBefore: '2',
    factuareaVersion: LocalDate::parse('2026-06-01'),
...
<!-- UsageSnippet language="php" operationID="public-api.v1.series.stats" method="get" path="/companies/{company}/series/stats" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.series.active" method="get" path="/companies/{company}/series/active" example="success" -->
```php
declare(strict_types=1);
...
$response = $sdk->series->publicApiV1SeriesActive(
    company: 'Lueilwitz, Smitham and Bruen',
    factuareaVersion: LocalDate::parse('2026-06-01')
...
<!-- UsageSnippet language="php" operationID="public-api.v1.series.set_default" method="post" path="/companies/{company}/series/{series}/default" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.series.show" method="get" path="/companies/{company}/series/{series}" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.series.unarchive" method="post" path="/companies/{company}/series/{series}/unarchive" -->
```php
declare(strict_types=1);
...
$response = $sdk->series->publicApiV1SeriesUnarchive(
    company: 'Legros, Ratke and Mayert',
    series: '<value>',
    idempotencyKey: '01928f10-7c0e-7c4a-9b7d-2f8a6e3c1d4b',
    factuareaVersion: LocalDate::parse('2026-06-01')
