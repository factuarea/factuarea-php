...
<!-- UsageSnippet language="php" operationID="public-api.v1.shopify.stores.connection_test" method="post" path="/shopify/stores/{store}/connection-test" example="api_version_expired" -->
```php
...
<!-- UsageSnippet language="php" operationID="public-api.v1.shopify.stores.connection_test" method="post" path="/shopify/stores/{store}/connection-test" example="credentials_rejected" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.shopify.stores.connection_test" method="post" path="/shopify/stores/{store}/connection-test" example="store_unreachable" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.shopify.stores.connection_test" method="post" path="/shopify/stores/{store}/connection-test" example="success" -->
```php
declare(strict_types=1);
