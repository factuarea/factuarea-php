...
* [publicApiV1ShopifyStoresConnectionTest](#publicapiv1shopifystoresconnectiontest) - Test a Shopify store connection

## publicApiV1ShopifyStoresConnectionTest
...
### Example Usage: api_version_expired

<!-- UsageSnippet language="php" operationID="public-api.v1.shopify.stores.connection_test" method="post" path="/companies/{company}/shopify/stores/{store}/connection-test" example="api_version_expired" -->
```php
...
$response = $sdk->shopify->stores->publicApiV1ShopifyStoresConnectionTest(
    company: 'Dickens, Labadie and Kovacek',
    store: '<value>',
...
<!-- UsageSnippet language="php" operationID="public-api.v1.shopify.stores.connection_test" method="post" path="/companies/{company}/shopify/stores/{store}/connection-test" example="credentials_rejected" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.shopify.stores.connection_test" method="post" path="/companies/{company}/shopify/stores/{store}/connection-test" example="store_unreachable" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.shopify.stores.connection_test" method="post" path="/companies/{company}/shopify/stores/{store}/connection-test" example="success" -->
```php
declare(strict_types=1);
...
$response = $sdk->shopify->stores->publicApiV1ShopifyStoresConnectionTest(
    company: 'Wiza, Tromp and Schowalter',
    store: '<value>',
    idempotencyKey: '01928f10-7c0e-7c4a-9b7d-2f8a6e3c1d4b',
    factuareaVersion: LocalDate::parse('2026-06-01')
...
**[?Operations\PublicApiV1ShopifyStoresConnectionTestResponse](../../Models/Operations/PublicApiV1ShopifyStoresConnectionTestResponse.md)**
