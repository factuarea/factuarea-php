...
<!-- UsageSnippet language="php" operationID="public-api.v1.verifactu.events.summary" method="get" path="/companies/{company}/verifactu/events/summary" example="success" -->
```php
...
<!-- UsageSnippet language="php" operationID="public-api.v1.verifactu.events.list" method="get" path="/companies/{company}/verifactu/events" example="success" -->
```php
declare(strict_types=1);
...
$request = new Operations\PublicApiV1VerifactuEventsListRequest(
    company: 'Friesen, Swift and Bauch',
...
| -------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| `$request`                                                                                                           | [Operations\PublicApiV1VerifactuEventsListRequest](../../Models/Operations/PublicApiV1VerifactuEventsListRequest.md) | :heavy_check_mark:                                                                                                   | The request object to use for the request.                                                                           |
...
<!-- UsageSnippet language="php" operationID="public-api.v1.verifactu.events.retry" method="post" path="/companies/{company}/verifactu/events/{event}/retry" example="success" -->
```php
declare(strict_types=1);
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `company`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | *string*                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | :heavy_check_mark:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Public identifier (UUID) of the company the request acts on. It must be in your credential's scope; read it from `GET /v1/me` (`data.scope[].id`). Never the tax ID.                                                                                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `event`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | *string*                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | :heavy_check_mark:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Public identifier (UUID v7) of the VeriFactu event, as returned in `id` by its list and detail responses.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
<!-- UsageSnippet language="php" operationID="public-api.v1.verifactu.events.show" method="get" path="/companies/{company}/verifactu/events/{event}" example="success" -->
```php
declare(strict_types=1);
