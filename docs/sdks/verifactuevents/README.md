...
<!-- UsageSnippet language="php" operationID="public-api.v1.verifactu.events.summary" method="get" path="/verifactu/events/summary" example="success" -->
```php
...
<!-- UsageSnippet language="php" operationID="public-api.v1.verifactu.events.list" method="get" path="/verifactu/events" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.verifactu.events.retry" method="post" path="/verifactu/events/{event}/retry" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.verifactu.events.show" method="get" path="/verifactu/events/{event}" example="success" -->
```php
declare(strict_types=1);
