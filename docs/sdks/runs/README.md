...
* [publicApiV1AutomationsRunsList](#publicapiv1automationsrunslist) - List automation runs
* [publicApiV1AutomationsRunsReplay](#publicapiv1automationsrunsreplay) - Replay the parked steps of an automation run
* [publicApiV1AutomationsRunsShow](#publicapiv1automationsrunsshow) - Retrieve an automation run

## publicApiV1AutomationsRunsList
...
<!-- UsageSnippet language="php" operationID="public-api.v1.automations.runs.list" method="get" path="/companies/{company}/automations/runs" -->
```php
...
$request = new Operations\PublicApiV1AutomationsRunsListRequest(
    company: 'Bernhard Group',
    factuareaVersion: LocalDate::parse('2026-06-01'),
);

$response = $sdk->automations->runs->publicApiV1AutomationsRunsList(
    request: $request
);
...
| -------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| `$request`                                                                                                           | [Operations\PublicApiV1AutomationsRunsListRequest](../../Models/Operations/PublicApiV1AutomationsRunsListRequest.md) | :heavy_check_mark:                                                                                                   | The request object to use for the request.                                                                           |

### Response

**[?Operations\PublicApiV1AutomationsRunsListResponse](../../Models/Operations/PublicApiV1AutomationsRunsListResponse.md)**
...
## publicApiV1AutomationsRunsReplay
...
<!-- UsageSnippet language="php" operationID="public-api.v1.automations.runs.replay" method="post" path="/companies/{company}/automations/runs/{run}/replay" -->
```php
declare(strict_types=1);
...
$response = $sdk->automations->runs->publicApiV1AutomationsRunsReplay(
    company: 'Bartell, Leannon and Pfeffer',
    run: '<value>',
...
| `run`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | *string*                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | :heavy_check_mark:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Public identifier (UUID v7) of the automation run, as returned in `id` by its list and detail responses.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
**[?Operations\PublicApiV1AutomationsRunsReplayResponse](../../Models/Operations/PublicApiV1AutomationsRunsReplayResponse.md)**
...
## publicApiV1AutomationsRunsShow
...
<!-- UsageSnippet language="php" operationID="public-api.v1.automations.runs.show" method="get" path="/companies/{company}/automations/runs/{run}" -->
```php
declare(strict_types=1);
...
$response = $sdk->automations->runs->publicApiV1AutomationsRunsShow(
    company: 'Witting - Rowe',
    run: '<value>',
    factuareaVersion: LocalDate::parse('2026-06-01')
...
**[?Operations\PublicApiV1AutomationsRunsShowResponse](../../Models/Operations/PublicApiV1AutomationsRunsShowResponse.md)**
