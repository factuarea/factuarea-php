...
<!-- UsageSnippet language="php" operationID="public-api.v1.automations.runs.list" method="get" path="/automations/runs" -->
```php
...
<!-- UsageSnippet language="php" operationID="public-api.v1.automations.runs.replay" method="post" path="/automations/runs/{run}/replay" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.automations.runs.show" method="get" path="/automations/runs/{run}" -->
```php
declare(strict_types=1);
