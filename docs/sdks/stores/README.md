...
<!-- UsageSnippet language="php" operationID="public-api.v1.stores.create" method="post" path="/stores" example="missing_api_key" -->
```php
...
<!-- UsageSnippet language="php" operationID="public-api.v1.stores.create" method="post" path="/stores" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.stores.index" method="get" path="/stores" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.stores.disconnect" method="delete" path="/stores/{store}" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.stores.show" method="get" path="/stores/{store}" example="success" -->
```php
declare(strict_types=1);
...
<!-- UsageSnippet language="php" operationID="public-api.v1.stores.update" method="put" path="/stores/{store}" example="success" -->
```php
declare(strict_types=1);
