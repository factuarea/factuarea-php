...
<!-- UsageSnippet language="php" operationID="public-api.v1.verifactu.declaracion.history" method="get" path="/companies/{company}/verifactu/declaracion-responsable/history" example="success" -->
```php
...
<!-- UsageSnippet language="php" operationID="public-api.v1.verifactu.declaracion.current" method="get" path="/companies/{company}/verifactu/declaracion-responsable" example="success" -->
```php
declare(strict_types=1);
