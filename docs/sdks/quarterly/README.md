...
<!-- UsageSnippet language="php" operationID="public-api.v1.invoices.quarterly.available" method="get" path="/invoices/quarterly/available-quarters" example="success" -->
```php
...
<!-- UsageSnippet language="php" operationID="public-api.v1.invoices.quarterly.send_email" method="post" path="/invoices/quarterly/send-email" example="success" -->
```php
declare(strict_types=1);
